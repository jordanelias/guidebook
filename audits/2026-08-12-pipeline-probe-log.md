...
Generated 2026-08-12 07:59:50Z. Subject: atomic snapshot `probe.db` of `data/guidebook.db` at repo HEAD `df64417` (the repo received two data commits MID-SESSION — 7a7bebe evidence-stage clear, 6dd0cd3 source_locators recovery — so every sweep reads this one snapshot; the canonical file was only ever opened read-only, for copying).
...
### [0001] A1 — all tables   `2026-08-12 07:59:50Z`
...
### [0002] A2 — canonical DB   `2026-08-12 07:59:50Z`
**Action:** PRAGMA foreign_key_check (whole DB)
**Expected:** 0 violations
**Actual:** 0 violations
**Verdict:** `OK`

### [0003] A2 — scripts/migrate_db.py:161   `2026-08-12 07:59:50Z`
...
### [0004] A2 — access_need_axis_map.axis_code → axes   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0005] A2 — access_need_axis_map.need_code → access_needs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0006] A2 — access_need_icf.need_code → access_needs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0007] A2 — bpc_metadata.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0008] A2 — case_studies.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0009] A2 — case_study_outcomes.case_study_id → case_studies   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0010] A2 — case_study_populations.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0011] A2 — case_study_populations.case_study_id → case_studies   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0012] A2 — case_study_specs.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0013] A2 — case_study_specs.case_study_id → case_studies   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0014] A2 — case_study_strategies.case_study_id → case_studies   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0015] A2 — citation_mining.global_ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0016] A2 — citation_mining.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0017] A2 — citation_population_links.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0018] A2 — citation_population_links.citation_id → reasoning_doc_citations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0019] A2 — conflicts.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0020] A2 — connection_targets.con_id → connections   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0021] A2 — economics_entries.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0022] A2 — economics_entry_populations.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0023] A2 — economics_entry_populations.entry_id → economics_entries   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0024] A2 — economics_entry_specs.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0025] A2 — economics_entry_specs.entry_id → economics_entries   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0026] A2 — evidence_population_match.gap_id → gaps   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0027] A2 — evidence_population_match.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0028] A2 — evidence_source_authors.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0029] A2 — extraction_population_links.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0030] A2 — extraction_population_links.extraction_id → source_value_extractions   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0031] A2 — gap_mining.gap_id → gaps   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0032] A2 — item_audit_runs.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0033] A2 — item_axis_links.axis_code → axes   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0034] A2 — item_axis_links.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0035] A2 — item_bpc_links.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0036] A2 — item_bpc_links.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0037] A2 — item_population_elaborations.evidence_ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0038] A2 — item_population_elaborations.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0039] A2 — item_population_elaborations.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0040] A2 — item_population_links.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0041] A2 — item_population_links.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0042] A2 — items.bpc_source_slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0043] A2 — jurisdictional_values.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0044] A2 — population_axis_map.axis_code → axes   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0045] A2 — population_axis_map.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0046] A2 — populations.parent_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0047] A2 — probe_population_links.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0048] A2 — probe_population_links.probe_id → spec_value_probes   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0049] A2 — reasoning_doc_citations.source_ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0050] A2 — reasoning_doc_citations.reasoning_doc_slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0051] A2 — room_items.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0052] A2 — room_items.room_code → rooms   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0053] A2 — search_admissions.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0054] A2 — search_admissions.exec_id → search_executions   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0055] A2 — search_candidates.suggested_slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0056] A2 — search_candidates.found_under_slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0057] A2 — search_candidates.exec_id → search_executions   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0058] A2 — search_coverage.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0059] A2 — search_executions.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0060] A2 — search_languages.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0061] A2 — slugs.merged_into → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0062] A2 — source_slug_links.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0063] A2 — source_slug_links.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0064] A2 — source_value_extractions.promoted_to_rdc_id → reasoning_doc_citations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0065] A2 — source_value_extractions.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0066] A2 — source_value_extractions.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0067] A2 — source_value_extractions.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0068] A2 — source_value_extractions.root_ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0069] A2 — source_value_extractions.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0070] A2 — spec_value_probes.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0071] A2 — spec_value_probes.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0072] A2 — spec_value_probes.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0073] A2 — specification_source_links.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0074] A2 — specification_source_links.specification_id → specifications   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0075] A2 — specifications.gap_register_id → gaps   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0076] A2 — specifications.convergence_id → convergence_assessment   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0077] A2 — specifications.population_code → populations   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0078] A2 — specifications.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0079] A2 — supersession_check.ref_id → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0080] A2 — supersession_check.slug → slugs   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0081] A2 — term_aliases.term_id → terms   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0082] A2 — term_item_links.item_code → items   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0083] A2 — term_item_links.term_id → terms   `2026-08-12 07:59:50Z`
**Action:** LEFT JOIN orphan query
**Expected:** 0 orphans
**Actual:** 0 orphans
**Verdict:** `OK`

### [0084] A2 — canonical DB — mid-session change of subject   `2026-08-12 07:59:50Z`
...
### [0085] A2 — item_population_elaborations.evidence_ref_id (live NULL-bypass)   `2026-08-12 07:59:50Z`
...
### [0086] A2 — evidence_population_match.source_ref →(undeclared) evidence_sources   `2026-08-12 07:59:50Z`
...
### [0087] A2 — evidence_population_match.target_population →(undeclared) populations   `2026-08-12 07:59:50Z`
**Action:** orphan query on a reference column that has NO declared FK
**SQL:**
```sql
...
### [0088] A2 — source_value_extractions.echo_of →(undeclared) source_value_extractions   `2026-08-12 07:59:50Z`
**Action:** orphan query on a reference column that has NO declared FK
**SQL:**
```sql
...
### [0089] A2 — specifications.governing_refs (JSON) → evidence_sources   `2026-08-12 07:59:50Z`
...
### [0090] A2 — search_executions.admitted_ref_ids (JSON) → evidence_sources   `2026-08-12 07:59:50Z`
**Action:** every ref named in the JSON array must exist in evidence_sources (no FK can enforce a JSON payload)
**SQL:**
```sql
...
### [0091] A3 — access_need_axis_map.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
...
### [0092] A3 — access_need_axis_map.need_code → access_needs.need_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0093] A3 — access_need_icf.need_code → access_needs.need_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0094] A3 — bpc_metadata.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0095] A3 — case_studies.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0096] A3 — case_study_outcomes.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0097] A3 — case_study_populations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0098] A3 — case_study_populations.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0099] A3 — case_study_specs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0100] A3 — case_study_specs.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0101] A3 — case_study_strategies.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0102] A3 — citation_mining.global_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0103] A3 — citation_mining.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0104] A3 — citation_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0105] A3 — citation_population_links.citation_id → reasoning_doc_citations.citation_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0106] A3 — conflicts.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0107] A3 — connection_targets.con_id → connections.con_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0108] A3 — economics_entries.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0109] A3 — economics_entry_populations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0110] A3 — economics_entry_populations.entry_id → economics_entries.entry_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0111] A3 — economics_entry_specs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0112] A3 — economics_entry_specs.entry_id → economics_entries.entry_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0113] A3 — evidence_population_match.gap_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0114] A3 — evidence_population_match.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0115] A3 — evidence_source_authors.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0116] A3 — extraction_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0117] A3 — extraction_population_links.extraction_id → source_value_extractions.extraction_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0118] A3 — gap_mining.gap_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0119] A3 — item_audit_runs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0120] A3 — item_axis_links.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0121] A3 — item_axis_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0122] A3 — item_bpc_links.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0123] A3 — item_bpc_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0124] A3 — item_population_elaborations.evidence_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0125] A3 — item_population_elaborations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0126] A3 — item_population_elaborations.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0127] A3 — item_population_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0128] A3 — item_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0129] A3 — items.bpc_source_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0130] A3 — jurisdictional_values.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0131] A3 — population_axis_map.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0132] A3 — population_axis_map.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0133] A3 — populations.parent_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0134] A3 — probe_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0135] A3 — probe_population_links.probe_id → spec_value_probes.probe_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0136] A3 — reasoning_doc_citations.source_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0137] A3 — reasoning_doc_citations.reasoning_doc_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0138] A3 — room_items.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0139] A3 — room_items.room_code → rooms.room_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0140] A3 — search_admissions.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0141] A3 — search_admissions.exec_id → search_executions.exec_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0142] A3 — search_candidates.suggested_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0143] A3 — search_candidates.found_under_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0144] A3 — search_candidates.exec_id → search_executions.exec_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0145] A3 — search_coverage.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0146] A3 — search_executions.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0147] A3 — search_languages.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0148] A3 — slugs.merged_into → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0149] A3 — source_slug_links.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0150] A3 — source_slug_links.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0151] A3 — source_value_extractions.promoted_to_rdc_id → reasoning_doc_citations.citation_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0152] A3 — source_value_extractions.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0153] A3 — source_value_extractions.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0154] A3 — source_value_extractions.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0155] A3 — source_value_extractions.root_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0156] A3 — source_value_extractions.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0157] A3 — spec_value_probes.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0158] A3 — spec_value_probes.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0159] A3 — spec_value_probes.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0160] A3 — specification_source_links.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0161] A3 — specification_source_links.specification_id → specifications.specification_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0162] A3 — specifications.gap_register_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0163] A3 — specifications.convergence_id → convergence_assessment.convergence_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0164] A3 — specifications.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0165] A3 — specifications.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0166] A3 — supersession_check.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0167] A3 — supersession_check.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0168] A3 — term_aliases.term_id → terms.term_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0169] A3 — term_item_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0170] A3 — term_item_links.term_id → terms.term_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=ON)
**SQL:**
```sql
...
### [0171] A3b — citation_mining.global_ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
...
### [0172] A3b — conflicts.item_code → items (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0173] A3b — economics_entries.ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0174] A3b — evidence_population_match.gap_id → gaps (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0175] A3b — evidence_population_match.ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0176] A3b — item_population_elaborations.evidence_ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0177] A3b — items.bpc_source_slug → slugs (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0178] A3b — populations.parent_code → populations (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0179] A3b — search_candidates.suggested_slug → slugs (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0180] A3b — search_candidates.exec_id → search_executions (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0181] A3b — slugs.merged_into → slugs (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0182] A3b — source_value_extractions.promoted_to_rdc_id → reasoning_doc_citations (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0183] A3b — source_value_extractions.population_code → populations (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0184] A3b — source_value_extractions.item_code → items (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0185] A3b — source_value_extractions.root_ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0186] A3b — spec_value_probes.ref_id → evidence_sources (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
...
### [0187] A3b — specifications.gap_register_id → gaps (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "gap_register_id") VALUES (?, ?, ?, ?)  -- {"item_code": "E-13", "population_code": "PAIN", "state": "stated", "gap_register_id": null}
```
**Expected:** if the reference is semantically required, some constraint should reject it
**Actual:** row ACCEPTED with no parent linkage — SQL NULL-bypass: the FK exists but is never evaluated. Any writer can skip provenance on this edge
**Verdict:** **`SILENT-PASS`**

### [0188] A3b — specifications.convergence_id → convergence_assessment (NULL path)   `2026-08-12 07:59:50Z`
**Action:** insert child row with the FK column explicitly NULL (FK=ON)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "convergence_id") VALUES (?, ?, ?, ?)  -- {"item_code": "F-07", "population_code": "ALL", "state": "stated", "convergence_id": null}
```
**Expected:** if the reference is semantically required, some constraint should reject it
**Actual:** row ACCEPTED with no parent linkage — SQL NULL-bypass: the FK exists but is never evaluated. Any writer can skip provenance on this edge
**Verdict:** **`SILENT-PASS`**

### [0189] A3c — evidence_population_match.source_ref vs ref_id (dual identity columns)   `2026-08-12 07:59:50Z`
...
### [0190] A4 — access_need_axis_map.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
...
### [0191] A4 — access_need_axis_map.need_code → access_needs.need_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0192] A4 — access_need_icf.need_code → access_needs.need_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0193] A4 — bpc_metadata.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0194] A4 — case_studies.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0195] A4 — case_study_outcomes.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0196] A4 — case_study_populations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0197] A4 — case_study_populations.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0198] A4 — case_study_specs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0199] A4 — case_study_specs.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0200] A4 — case_study_strategies.case_study_id → case_studies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0201] A4 — citation_mining.global_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0202] A4 — citation_mining.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0203] A4 — citation_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0204] A4 — citation_population_links.citation_id → reasoning_doc_citations.citation_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0205] A4 — conflicts.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0206] A4 — connection_targets.con_id → connections.con_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0207] A4 — economics_entries.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0208] A4 — economics_entry_populations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0209] A4 — economics_entry_populations.entry_id → economics_entries.entry_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0210] A4 — economics_entry_specs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0211] A4 — economics_entry_specs.entry_id → economics_entries.entry_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0212] A4 — evidence_population_match.gap_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0213] A4 — evidence_population_match.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0214] A4 — evidence_source_authors.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0215] A4 — extraction_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0216] A4 — extraction_population_links.extraction_id → source_value_extractions.extraction_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0217] A4 — gap_mining.gap_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0218] A4 — item_audit_runs.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0219] A4 — item_axis_links.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0220] A4 — item_axis_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0221] A4 — item_bpc_links.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0222] A4 — item_bpc_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0223] A4 — item_population_elaborations.evidence_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0224] A4 — item_population_elaborations.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0225] A4 — item_population_elaborations.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0226] A4 — item_population_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0227] A4 — item_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0228] A4 — items.bpc_source_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0229] A4 — jurisdictional_values.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0230] A4 — population_axis_map.axis_code → axes.axis_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0231] A4 — population_axis_map.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0232] A4 — populations.parent_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0233] A4 — probe_population_links.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0234] A4 — probe_population_links.probe_id → spec_value_probes.probe_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0235] A4 — reasoning_doc_citations.source_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0236] A4 — reasoning_doc_citations.reasoning_doc_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0237] A4 — room_items.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0238] A4 — room_items.room_code → rooms.room_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0239] A4 — search_admissions.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0240] A4 — search_admissions.exec_id → search_executions.exec_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0241] A4 — search_candidates.suggested_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0242] A4 — search_candidates.found_under_slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0243] A4 — search_candidates.exec_id → search_executions.exec_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0244] A4 — search_coverage.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0245] A4 — search_executions.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0246] A4 — search_languages.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0247] A4 — slugs.merged_into → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0248] A4 — source_slug_links.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0249] A4 — source_slug_links.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0250] A4 — source_value_extractions.promoted_to_rdc_id → reasoning_doc_citations.citation_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0251] A4 — source_value_extractions.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0252] A4 — source_value_extractions.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0253] A4 — source_value_extractions.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0254] A4 — source_value_extractions.root_ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0255] A4 — source_value_extractions.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0256] A4 — spec_value_probes.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0257] A4 — spec_value_probes.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0258] A4 — spec_value_probes.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0259] A4 — specification_source_links.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0260] A4 — specification_source_links.specification_id → specifications.specification_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0261] A4 — specifications.gap_register_id → gaps.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
INSERT INTO "specifications" ("gap_register_id", "item_code", "population_code", "state") VALUES (?, ?, ?, ?)  -- {"gap_register_id": "PROBE-NO-SUCH-PARENT-284", "item_code": "A-05", "population_code": "MOB", "state": "stated"}
```
**Expected:** would be rejected under FK=ON
**Actual:** insert COMMITTED — violation persists in the file
**Verdict:** **`SILENT-PASS`**

### [0262] A4 — specifications.convergence_id → convergence_assessment.convergence_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
INSERT INTO "specifications" ("convergence_id", "item_code", "population_code", "state") VALUES (?, ?, ?, ?)  -- {"convergence_id": 1000000185, "item_code": "G-06", "population_code": "MOVE", "state": "stated"}
```
**Expected:** would be rejected under FK=ON
**Actual:** insert COMMITTED — violation persists in the file
**Verdict:** **`SILENT-PASS`**

### [0263] A4 — specifications.population_code → populations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0264] A4 — specifications.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0265] A4 — supersession_check.ref_id → evidence_sources.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0266] A4 — supersession_check.slug → slugs.slug   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0267] A4 — term_aliases.term_id → terms.term_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0268] A4 — term_item_links.item_code → items.item_code   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0269] A4 — term_item_links.term_id → terms.term_id   `2026-08-12 07:59:50Z`
**Action:** insert child with nonexistent parent value (FK=OFF, migrate_db.py apply mode)
**SQL:**
```sql
...
### [0270] A4 — probe-a-off.db   `2026-08-12 07:59:50Z`
...
### [0271] A5 — all tables   `2026-08-12 07:59:50Z`
...
### [0272] A6/ON — access_duration CHECK(code IN ('permanent','temporary','situational'))   `2026-08-12 07:59:50Z`
...
### [0273] A6/ON — access_need_axis_map CHECK(relationship IN ('primary','partial','spans'))   `2026-08-12 07:59:50Z`
...
### [0274] A6/ON — access_need_icf CHECK(icf_type IN ('b','d','e','s'))   `2026-08-12 07:59:50Z`
...
### [0275] A6/ON — access_need_icf CHECK(confidence IN ('confirmed','proposed'))   `2026-08-12 07:59:50Z`
...
### [0276] A6/ON — access_needs CHECK(family IN ('perceiving','communicating','operating','pacing','environment_safety'))   `2026-08-12 07:59:50Z`
...
### [0277] A6/ON — access_needs CHECK(typical_stakes IN ('safety-critical','exclusion','friction'))   `2026-08-12 07:59:50Z`
...
### [0278] A6/ON — access_stakes CHECK(code IN ('safety-critical','exclusion','friction'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (code outside enum; FK=ON)
**SQL:**
```sql
...
### [0279] A6/ON — axes CHECK(coverage_status IN ('ESTABLISHED','PARTIAL','STUB'))   `2026-08-12 07:59:50Z`
...
### [0280] A6/ON — bpc_metadata CHECK(pico_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0281] A6/ON — bpc_metadata CHECK(search_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0282] A6/ON — bpc_metadata CHECK(bpc_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0283] A6/ON — bpc_metadata CHECK(citation_mining_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0284] A6/ON — bpc_metadata CHECK(supersession_check_complete IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0285] A6/ON — bpc_metadata CHECK(closure_definition_version IS NULL OR closure_definition_version IN ('v1', 'v2'))   `2026-08-12 07:59:50Z`
...
### [0286] A6/ON — case_studies CHECK(evidence_quality_tier IS NULL OR evidence_quality_tier BETWEEN 1 AND 3)   `2026-08-12 07:59:50Z`
...
### [0287] A6/ON — case_studies CHECK(cost_data_quality IS NULL OR cost_data_quality IN ('VERIFIED','PROVISIONAL','GREY'))   `2026-08-12 07:59:50Z`
...
### [0288] A6/ON — case_studies CHECK(harm_finding IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0289] A6/ON — case_study_outcomes CHECK(tier IS NULL OR tier BETWEEN 1 AND 3)   `2026-08-12 07:59:50Z`
...
### [0290] A6/ON — citation_mining CHECK(backward IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0291] A6/ON — citation_mining CHECK(forward IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0292] A6/ON — conflicts CHECK(status IN ( 'RESOLVED-EVIDENCE', 'RESOLVED-CONSENSUS', 'RESOLUTION-PROPOSED', 'UNRESOLVED', 'MODE-S-ONLY' ))   `2026-08-12 07:59:50Z`
...
### [0293] A6/ON — connections CHECK(status IN ( 'PENDING','CONSUMED','CONSUMED-DEFERRED','CLOSED' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0294] A6/ON — connections CHECK(confidence IN ('HIGH','MODERATE','SPECULATIVE'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (confidence outside enum; FK=ON)
**SQL:**
```sql
...
### [0295] A6/ON — connections CHECK(connection_type IN ( 'CROSS-POPULATION','CROSS-ITEM', 'COMPOUND-INTERACTION','METHODOLOGY' ))   `2026-08-12 07:59:50Z`
...
### [0296] A6/ON — connections CHECK(opus_reviewed IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0297] A6/ON — convergence_assessment CHECK(status IN ('convergent', 'divergent', 'single_axis', 'pending_assessment'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0298] A6/ON — decisions CHECK(category IN ( 'D-DOCT','D-METH','D-SCHEMA','D-OP','D-PRES' ))   `2026-08-12 07:59:50Z`
...
### [0299] A6/ON — decisions CHECK(delegation IN ('DG-NON','DG-REVIEW','DG-AUTO'))   `2026-08-12 07:59:50Z`
...
### [0300] A6/ON — decisions CHECK(status IN ( 'ACTIVE','SUPERSEDED','WITHDRAWN','PROPOSED','PROVISIONAL' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0301] A6/ON — economics_entries CHECK(pillar IN ('health','inaction','construction','market'))   `2026-08-12 07:59:50Z`
...
### [0302] A6/ON — economics_entries CHECK(entry_type IN ('cost_premium','retrofit_multiplier','grant_programme','health_outcome', 'market_value','housin)   `2026-08-12 07:59:50Z`
...
### [0303] A6/ON — economics_entries CHECK(evidence_tier IS NULL OR evidence_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0304] A6/ON — economics_entries CHECK(confidence IS NULL OR confidence IN ('HIGH','MODERATE','LOW'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (confidence outside enum; FK=ON)
**SQL:**
```sql
...
### [0305] A6/ON — economics_entries CHECK(quant_status IS NULL OR quant_status IN ('VERIFIED-QUANT','UNVERIFIED-QUANT'))   `2026-08-12 07:59:50Z`
...
### [0306] A6/ON — evidence_population_match CHECK(match_grade IN ('EXACT','PARTIAL','PROXY','MISMATCH'))   `2026-08-12 07:59:50Z`
...
### [0307] A6/ON — evidence_sources CHECK(scope IS NULL OR scope IN ( 'high_control', 'lower_control', 'national', 'international', 'intrinsic' ))   `2026-08-12 07:59:50Z`
...
### [0308] A6/ON — evidence_sources CHECK(data_capture_status IN ('pending','captured','none-extractable','deferred'))   `2026-08-12 07:59:50Z`
...
### [0309] A6/ON — evidence_sources CHECK(citation_mining_status IN ('pending','mined','deferred','not-applicable'))   `2026-08-12 07:59:50Z`
...
### [0310] A6/ON — evidence_sources CHECK(processing_blocked_reason IS NULL OR processing_blocked_reason IN ( 'no-full-text', 'paywalled', 'no-doi', 'no)   `2026-08-12 07:59:50Z`
...
### [0311] A6/ON — evidence_sources CHECK(verification_disposition IS NULL OR verification_disposition IN ('OPEN','CLOSED'))   `2026-08-12 07:59:50Z`
...
### [0312] A6/ON — evidence_sources CHECK(verification_method IS NULL OR verification_method IN ( 'direct-render', 'co1-attestation', 'corroborated-not-)   `2026-08-12 07:59:50Z`
...
### [0313] A6/ON — evidence_sources CHECK(verification_closure_reason IS NULL OR verification_closure_reason IN ( 'paywalled', 'print-only', 'access-den)   `2026-08-12 07:59:50Z`
...
### [0314] A6/ON — external_root_registry CHECK(root_type IN ( 'measurement_primary', 'participatory_finding', 'committee_assertion', 'derived_calculation', ')   `2026-08-12 07:59:50Z`
...
### [0315] A6/ON — gap_mining CHECK(outcome IN ( 'closure_evidence_found', 'partial_evidence_found', 'null_result', 'gap_recategorized', 'deferred)   `2026-08-12 07:59:50Z`
...
### [0316] A6/ON — gap_mining CHECK(check_method IN ( 'pubmed_cluster', 'scholar_gateway_lived_experience', 'cochrane_direct', 'standards_body_dir)   `2026-08-12 07:59:50Z`
...
### [0317] A6/ON — gap_mining CHECK( outcome != 'closure_evidence_found' OR (discoveries_logged IS NOT NULL AND discoveries_logged != '[]') )   `2026-08-12 07:59:50Z`
...
### [0318] A6/ON — gap_mining CHECK( outcome != 'gap_recategorized' OR (notes IS NOT NULL AND length(notes) >= 20) )   `2026-08-12 07:59:50Z`
...
### [0319] A6/ON — gap_mining CHECK( outcome != 'deferred' OR (notes IS NOT NULL AND length(notes) >= 10) )   `2026-08-12 07:59:50Z`
...
### [0320] A6/ON — gaps CHECK(category IN ( 'RP','SW','CR','ST','MX','CD','EC','EG', 'CI','DEC','CONF','AUDT' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=ON)
**SQL:**
```sql
...
### [0321] A6/ON — gaps CHECK(priority IN ('P1','P2','P3'))   `2026-08-12 07:59:50Z`
...
### [0322] A6/ON — gaps CHECK(status LIKE 'OPEN%' OR status LIKE 'CLOSED%')   `2026-08-12 07:59:50Z`
...
### [0323] A6/ON — gaps CHECK(mining_addressability IS NULL OR mining_addressability IN ( 'ADDRESSABLE', 'NOT-ADDRESSABLE', 'TRIAGE-NEEDED' )   `2026-08-12 07:59:50Z`
...
### [0324] A6/ON — item_audit_runs CHECK(status IN ('IN-PROGRESS','COMPLETE','HANDED-OFF'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0325] A6/ON — item_axis_links CHECK(strength_band IN ('full','partial','weak'))   `2026-08-12 07:59:50Z`
...
### [0326] A6/ON — item_axis_links CHECK(use_mode IN ('independent','assisted','collective') OR use_mode IS NULL)   `2026-08-12 07:59:50Z`
...
### [0327] A6/ON — item_bpc_links CHECK(link_type IN ( 'primary','parameter','context','secondary' ))   `2026-08-12 07:59:50Z`
...
### [0328] A6/ON — item_population_links CHECK(applicability IN ( 'applies', 'applies_strictly', 'applies_loosely', 'context_dependent', 'does_not_apply' ))   `2026-08-12 07:59:50Z`
...
### [0329] A6/ON — items CHECK(category IN ( 'A','B','C','D','E','F','G','H','I','J','K' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=ON)
**SQL:**
```sql
...
### [0330] A6/ON — items CHECK(status IN ('draft','active','merged','retired'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0331] A6/ON — jurisdictional_values CHECK(is_code_minimum IS NULL OR is_code_minimum IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0332] A6/ON — lang_jur_map CHECK(role IN ('PRIMARY', 'SECONDARY'))   `2026-08-12 07:59:50Z`
...
### [0333] A6/ON — life_stage_modifiers CHECK(code IN ('SEN','CHD'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (code outside enum; FK=ON)
**SQL:**
```sql
...
### [0334] A6/ON — population_axis_map CHECK(role IN ('ALIAS','PRIMARY','SECONDARY','SITUATIONAL'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (role outside enum; FK=ON)
**SQL:**
```sql
...
### [0335] A6/ON — population_reclass CHECK(row_kind IN ('EXISTING-POP','NEW-PROFILE'))   `2026-08-12 07:59:50Z`
...
### [0336] A6/ON — population_reclass CHECK(layer IN ('AXIS-ALIAS','PROFILE','QUALIFIER','SPLIT'))   `2026-08-12 07:59:50Z`
...
### [0337] A6/ON — population_reclass CHECK(profile_kind IN ('diagnostic','identity-cultural','demographic','anthropometric','compound','umbrella'))   `2026-08-12 07:59:50Z`
...
### [0338] A6/ON — population_reclass CHECK(mapping_confidence IN ('high','moderate','low','minimal','TO-ASSESS') OR mapping_confidence IS NULL)   `2026-08-12 07:59:50Z`
...
### [0339] A6/ON — population_reclass CHECK(fluctuating IN ('yes','no') OR fluctuating IS NULL)   `2026-08-12 07:59:50Z`
...
### [0340] A6/ON — populations CHECK(category IN ( 'mobility', 'sensory', 'cognitive', 'mental_health', 'pain_fatigue', 'neurological', 'developmen)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=ON)
**SQL:**
```sql
...
### [0341] A6/ON — populations CHECK(is_compound IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0342] A6/ON — populations CHECK(status IN ('active', 'deprecated'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0343] A6/ON — reasoning_doc_citations CHECK(claim_type IN ( 'numerical_spec','jurisdiction_value','qualitative','definitional' ))   `2026-08-12 07:59:50Z`
...
### [0344] A6/ON — reasoning_doc_citations CHECK(value_match IN ( 'EXACT','WITHIN-TOLERANCE','DIFFERENT','NOT-FOUND','PAYWALL','SUPERSEDED' ))   `2026-08-12 07:59:50Z`
...
### [0345] A6/ON — reasoning_doc_citations CHECK(claim_match IN ( 'SUPPORTED','PARTIAL','NOT-FOUND','PAYWALL','CONTRADICTED' ))   `2026-08-12 07:59:50Z`
...
### [0346] A6/ON — reasoning_doc_citations CHECK(paywall_purchase_candidate IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0347] A6/ON — reasoning_doc_citations CHECK( (claim_type IN ('numerical_spec','jurisdiction_value') AND claimed_value IS NOT NULL AND value_match IS NOT N)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=ON)
**SQL:**
```sql
...
### [0348] A6/ON — room_items CHECK(applicability IN ('applies','conditional','not-applicable'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (applicability outside enum; FK=ON)
**SQL:**
```sql
...
### [0349] A6/ON — rooms CHECK(status IN ('active','draft','retired'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0350] A6/ON — search_candidates CHECK(disposition IN ('REHOME','MISCELLANEOUS','PENDING-VERIFICATION','OUT-OF-SCOPE','ADMITTED'))   `2026-08-12 07:59:50Z`
...
### [0351] A6/ON — search_candidates CHECK(locator_status IS NULL OR locator_status IN ('UNVERIFIED','RESOLVED','DEAD'))   `2026-08-12 07:59:50Z`
...
### [0352] A6/ON — search_candidates CHECK(tier_guess IS NULL OR tier_guess BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0353] A6/ON — search_candidates CHECK(harm_finding IN (0,1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (harm_finding outside enum; FK=ON)
**SQL:**
```sql
...
### [0354] A6/ON — search_coverage CHECK(status IN ('SEARCHED','THIN','NO-DATA','NOT-RUN'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0355] A6/ON — search_coverage CHECK(co1_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0356] A6/ON — search_coverage CHECK(tier5_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0357] A6/ON — search_coverage CHECK(tier6_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0358] A6/ON — search_executions CHECK(target_tier IS NULL OR target_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0359] A6/ON — search_executions CHECK(target_evidence_type IS NULL OR target_evidence_type IN ('clinical','sr_meta','standard_eb','national_fw','cod)   `2026-08-12 07:59:50Z`
...
### [0360] A6/ON — search_executions CHECK(target_scope IS NULL OR target_scope IN ('intrinsic','lower_control','high_control','national','international')   `2026-08-12 07:59:50Z`
...
### [0361] A6/ON — search_executions CHECK(depth_method IN ('scoping','systematic'))   `2026-08-12 07:59:50Z`
...
### [0362] A6/ON — search_executions CHECK(mining_direction IS NULL OR mining_direction IN ('none','backward','forward','both'))   `2026-08-12 07:59:50Z`
...
### [0363] A6/ON — search_executions CHECK(saturation_signal IS NULL OR saturation_signal IN ('none','partial','saturated'))   `2026-08-12 07:59:50Z`
...
### [0364] A6/ON — search_executions CHECK(backfill IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0365] A6/ON — search_executions CHECK(terms_used IS NULL OR json_valid(terms_used))   `2026-08-12 07:59:50Z`
...
### [0366] A6/ON — search_executions CHECK(admitted_ref_ids IS NULL OR json_valid(admitted_ref_ids))   `2026-08-12 07:59:50Z`
...
### [0367] A6/ON — search_languages CHECK(status IN ('SEARCHED','PARTIAL','NOT-RUN'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0368] A6/ON — situations CHECK(operational_access IN ('yes','no') OR operational_access IS NULL)   `2026-08-12 07:59:50Z`
...
### [0369] A6/ON — slugs CHECK(status IN ( 'ACTIVE','MERGED','STUB','PROVISIONAL' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=ON)
**SQL:**
```sql
...
### [0370] A6/ON — source_locators CHECK(doi IS NOT NULL OR url IS NOT NULL OR pmid IS NOT NULL OR pmcid IS NOT NULL OR isbn IS NOT NULL OR issn IS NOT)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (all of ['doi', 'url', 'pmid', 'pmcid', 'isbn', 'issn', 'standard_number'] NULL; FK=ON)
**SQL:**
```sql
INSERT INTO "source_locators" ("ref_id", "isbn", "standard_number", "doi", "pmcid", "issn", "url", "pmid") VALUES (?, ?, ?, ?, ?, ?, ?, ?)  -- {"ref_id": "PROBE-717", "isbn": null, "standard_number": null, "doi": null, "pmcid": null, "issn": null, "url": null, "pmid": null}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
...
### [0371] A6/ON — source_value_extractions CHECK(claim_type IN ('numerical','range','qualitative','framework','absent'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=ON)
**SQL:**
```sql
...
### [0372] A6/ON — source_value_extractions CHECK(extraction_method IN ('skim','full-read','re-read','auto-mined'))   `2026-08-12 07:59:50Z`
...
### [0373] A6/ON — source_value_extractions CHECK(extraction_status IN ('preliminary','reviewed','verified','contradicted','absent-confirmed'))   `2026-08-12 07:59:50Z`
...
### [0374] A6/ON — source_value_extractions CHECK(root_type IN ( 'measurement_primary', 'participatory_finding', 'committee_assertion', 'derived_calculation', ')   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (root_type outside enum; FK=ON)
**SQL:**
```sql
...
### [0375] A6/ON — source_value_extractions CHECK(measurement_paradigm IN ( 'swept_path_dynamic', 'static_turning_circle', 'static_clearance', 'anthropometric_p)   `2026-08-12 07:59:50Z`
...
### [0376] A6/ON — source_value_extractions CHECK(device_class IN ( 'manual_self_propelled', 'manual_attendant', 'power_chair', 'scooter', 'bariatric_manual', ')   `2026-08-12 07:59:50Z`
...
### [0377] A6/ON — source_value_extractions CHECK(contested IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0378] A6/ON — source_value_extractions CHECK( (claim_type = 'absent' AND claimed_value IS NULL) OR (claim_type <> 'absent' AND claimed_value IS NOT NULL) )   `2026-08-12 07:59:50Z`
...
### [0379] A6/ON — spec_value_probes CHECK(direction IN ('up','down'))   `2026-08-12 07:59:50Z`
...
### [0380] A6/ON — spec_value_probes CHECK(claim_type IN ( 'minimum','maximum','target','range_low','range_high' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=ON)
**SQL:**
```sql
...
### [0381] A6/ON — spec_value_probes CHECK(phase IN ( 'outer-pass-1st','outer-pass-2nd','outer-stop', 'refinement-pass-1st','refinement-pass-2nd','refine)   `2026-08-12 07:59:50Z`
...
### [0382] A6/ON — spec_value_probes CHECK(passes_strict IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0383] A6/ON — specification_source_links CHECK(role IN ('governing'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (role outside enum; FK=ON)
**SQL:**
```sql
...
### [0384] A6/ON — specifications CHECK(state IN ('stated', 'provisional', 'pending', 'not_applicable'))   `2026-08-12 07:59:50Z`
...
### [0385] A6/ON — specifications CHECK(design_scale IN ('universal', 'population', 'person'))   `2026-08-12 07:59:50Z`
...
### [0386] A6/ON — specifications CHECK(governing_refs IS NULL OR json_valid(governing_refs))   `2026-08-12 07:59:50Z`
...
### [0387] A6/ON — specifications CHECK(code_floor_only IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0388] A6/ON — specifications CHECK(has_unverified_sources IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0389] A6/ON — specifications CHECK(all_sources_disqualified IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0390] A6/ON — specifications CHECK(regulatory_stratum_only IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0391] A6/ON — supersession_check CHECK(anchor_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0392] A6/ON — supersession_check CHECK(outcome IN ( 'current_best', 'superseded_by', 'refined_by', 'divergent_no_supersession', 'co1_addition_logged')   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (outcome outside enum; FK=ON)
**SQL:**
```sql
...
### [0393] A6/ON — supersession_check CHECK(check_method IN ( 'pubmed_search', 'scholar_gateway', 'cochrane_direct', 'standards_body_direct', 'multilingua)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (check_method outside enum; FK=ON)
**SQL:**
```sql
...
### [0394] A6/ON — supersession_check CHECK( (outcome IN ('superseded_by','refined_by','divergent_no_supersession') AND (superseding_ref_ids IS NOT NULL O)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (outcome outside enum; FK=ON)
**SQL:**
```sql
...
### [0395] A6/ON — supersession_check CHECK( outcome != 'refined_by' OR refinement_dimension IS NOT NULL )   `2026-08-12 07:59:50Z`
...
### [0396] A6/ON — supersession_check CHECK( outcome != 'divergent_no_supersession' OR divergence_notes IS NOT NULL )   `2026-08-12 07:59:50Z`
...
### [0397] A6/ON — supersession_check CHECK( outcome != 'co1_addition_logged' OR anchor_evidence_type = 'co1' )   `2026-08-12 07:59:50Z`
...
### [0398] A6/ON — term_aliases CHECK(alias_type IN ( 'SYNONYM','TRANSLATION','NARROWER', 'BROADER','DEPRECATED','DOMAIN' ))   `2026-08-12 07:59:50Z`
...
### [0399] A6/ON — weighting_profile CHECK(json_valid(tier_weights))   `2026-08-12 07:59:50Z`
...
### [0400] A6/OFF — access_duration CHECK(code IN ('permanent','temporary','situational'))   `2026-08-12 07:59:50Z`
...
### [0401] A6/OFF — access_need_axis_map CHECK(relationship IN ('primary','partial','spans'))   `2026-08-12 07:59:50Z`
...
### [0402] A6/OFF — access_need_icf CHECK(icf_type IN ('b','d','e','s'))   `2026-08-12 07:59:50Z`
...
### [0403] A6/OFF — access_need_icf CHECK(confidence IN ('confirmed','proposed'))   `2026-08-12 07:59:50Z`
...
### [0404] A6/OFF — access_needs CHECK(family IN ('perceiving','communicating','operating','pacing','environment_safety'))   `2026-08-12 07:59:50Z`
...
### [0405] A6/OFF — access_needs CHECK(typical_stakes IN ('safety-critical','exclusion','friction'))   `2026-08-12 07:59:50Z`
...
### [0406] A6/OFF — access_stakes CHECK(code IN ('safety-critical','exclusion','friction'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (code outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "access_stakes" ("code", "definition") VALUES (?, ?)  -- {"code": "PROBE-INVALID-ENUM", "definition": "PROBE-DEFINITION"}
...
### [0407] A6/OFF — axes CHECK(coverage_status IN ('ESTABLISHED','PARTIAL','STUB'))   `2026-08-12 07:59:50Z`
...
### [0408] A6/OFF — bpc_metadata CHECK(pico_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0409] A6/OFF — bpc_metadata CHECK(search_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0410] A6/OFF — bpc_metadata CHECK(bpc_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0411] A6/OFF — bpc_metadata CHECK(citation_mining_complete IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0412] A6/OFF — bpc_metadata CHECK(supersession_check_complete IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0413] A6/OFF — bpc_metadata CHECK(closure_definition_version IS NULL OR closure_definition_version IN ('v1', 'v2'))   `2026-08-12 07:59:50Z`
...
### [0414] A6/OFF — case_studies CHECK(evidence_quality_tier IS NULL OR evidence_quality_tier BETWEEN 1 AND 3)   `2026-08-12 07:59:50Z`
...
### [0415] A6/OFF — case_studies CHECK(cost_data_quality IS NULL OR cost_data_quality IN ('VERIFIED','PROVISIONAL','GREY'))   `2026-08-12 07:59:50Z`
...
### [0416] A6/OFF — case_studies CHECK(harm_finding IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0417] A6/OFF — case_study_outcomes CHECK(tier IS NULL OR tier BETWEEN 1 AND 3)   `2026-08-12 07:59:50Z`
...
### [0418] A6/OFF — citation_mining CHECK(backward IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0419] A6/OFF — citation_mining CHECK(forward IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0420] A6/OFF — conflicts CHECK(status IN ( 'RESOLVED-EVIDENCE', 'RESOLVED-CONSENSUS', 'RESOLUTION-PROPOSED', 'UNRESOLVED', 'MODE-S-ONLY' ))   `2026-08-12 07:59:50Z`
...
### [0421] A6/OFF — connections CHECK(status IN ( 'PENDING','CONSUMED','CONSUMED-DEFERRED','CLOSED' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0422] A6/OFF — connections CHECK(confidence IN ('HIGH','MODERATE','SPECULATIVE'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (confidence outside enum; FK=OFF)
**SQL:**
```sql
...
### [0423] A6/OFF — connections CHECK(connection_type IN ( 'CROSS-POPULATION','CROSS-ITEM', 'COMPOUND-INTERACTION','METHODOLOGY' ))   `2026-08-12 07:59:50Z`
...
### [0424] A6/OFF — connections CHECK(opus_reviewed IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0425] A6/OFF — convergence_assessment CHECK(status IN ('convergent', 'divergent', 'single_axis', 'pending_assessment'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "convergence_assessment" ("status") VALUES (?)  -- {"status": "PROBE-INVALID-ENUM"}
...
### [0426] A6/OFF — decisions CHECK(category IN ( 'D-DOCT','D-METH','D-SCHEMA','D-OP','D-PRES' ))   `2026-08-12 07:59:50Z`
...
### [0427] A6/OFF — decisions CHECK(delegation IN ('DG-NON','DG-REVIEW','DG-AUTO'))   `2026-08-12 07:59:50Z`
...
### [0428] A6/OFF — decisions CHECK(status IN ( 'ACTIVE','SUPERSEDED','WITHDRAWN','PROPOSED','PROVISIONAL' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0429] A6/OFF — economics_entries CHECK(pillar IN ('health','inaction','construction','market'))   `2026-08-12 07:59:50Z`
...
### [0430] A6/OFF — economics_entries CHECK(entry_type IN ('cost_premium','retrofit_multiplier','grant_programme','health_outcome', 'market_value','housin)   `2026-08-12 07:59:50Z`
...
### [0431] A6/OFF — economics_entries CHECK(evidence_tier IS NULL OR evidence_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0432] A6/OFF — economics_entries CHECK(confidence IS NULL OR confidence IN ('HIGH','MODERATE','LOW'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (confidence outside enum; FK=OFF)
**SQL:**
```sql
...
### [0433] A6/OFF — economics_entries CHECK(quant_status IS NULL OR quant_status IN ('VERIFIED-QUANT','UNVERIFIED-QUANT'))   `2026-08-12 07:59:50Z`
...
### [0434] A6/OFF — evidence_population_match CHECK(match_grade IN ('EXACT','PARTIAL','PROXY','MISMATCH'))   `2026-08-12 07:59:50Z`
...
### [0435] A6/OFF — evidence_sources CHECK(scope IS NULL OR scope IN ( 'high_control', 'lower_control', 'national', 'international', 'intrinsic' ))   `2026-08-12 07:59:50Z`
...
### [0436] A6/OFF — evidence_sources CHECK(data_capture_status IN ('pending','captured','none-extractable','deferred'))   `2026-08-12 07:59:50Z`
...
### [0437] A6/OFF — evidence_sources CHECK(citation_mining_status IN ('pending','mined','deferred','not-applicable'))   `2026-08-12 07:59:50Z`
...
### [0438] A6/OFF — evidence_sources CHECK(processing_blocked_reason IS NULL OR processing_blocked_reason IN ( 'no-full-text', 'paywalled', 'no-doi', 'no)   `2026-08-12 07:59:50Z`
...
### [0439] A6/OFF — evidence_sources CHECK(verification_disposition IS NULL OR verification_disposition IN ('OPEN','CLOSED'))   `2026-08-12 07:59:50Z`
...
### [0440] A6/OFF — evidence_sources CHECK(verification_method IS NULL OR verification_method IN ( 'direct-render', 'co1-attestation', 'corroborated-not-)   `2026-08-12 07:59:50Z`
...
### [0441] A6/OFF — evidence_sources CHECK(verification_closure_reason IS NULL OR verification_closure_reason IN ( 'paywalled', 'print-only', 'access-den)   `2026-08-12 07:59:50Z`
...
### [0442] A6/OFF — external_root_registry CHECK(root_type IN ( 'measurement_primary', 'participatory_finding', 'committee_assertion', 'derived_calculation', ')   `2026-08-12 07:59:50Z`
...
### [0443] A6/OFF — gap_mining CHECK(outcome IN ( 'closure_evidence_found', 'partial_evidence_found', 'null_result', 'gap_recategorized', 'deferred)   `2026-08-12 07:59:50Z`
...
### [0444] A6/OFF — gap_mining CHECK(check_method IN ( 'pubmed_cluster', 'scholar_gateway_lived_experience', 'cochrane_direct', 'standards_body_dir)   `2026-08-12 07:59:50Z`
...
### [0445] A6/OFF — gap_mining CHECK( outcome != 'closure_evidence_found' OR (discoveries_logged IS NOT NULL AND discoveries_logged != '[]') )   `2026-08-12 07:59:50Z`
...
### [0446] A6/OFF — gap_mining CHECK( outcome != 'gap_recategorized' OR (notes IS NOT NULL AND length(notes) >= 20) )   `2026-08-12 07:59:50Z`
...
### [0447] A6/OFF — gap_mining CHECK( outcome != 'deferred' OR (notes IS NOT NULL AND length(notes) >= 10) )   `2026-08-12 07:59:50Z`
...
### [0448] A6/OFF — gaps CHECK(category IN ( 'RP','SW','CR','ST','MX','CD','EC','EG', 'CI','DEC','CONF','AUDT' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=OFF)
**SQL:**
```sql
...
### [0449] A6/OFF — gaps CHECK(priority IN ('P1','P2','P3'))   `2026-08-12 07:59:50Z`
...
### [0450] A6/OFF — gaps CHECK(status LIKE 'OPEN%' OR status LIKE 'CLOSED%')   `2026-08-12 07:59:50Z`
...
### [0451] A6/OFF — gaps CHECK(mining_addressability IS NULL OR mining_addressability IN ( 'ADDRESSABLE', 'NOT-ADDRESSABLE', 'TRIAGE-NEEDED' )   `2026-08-12 07:59:50Z`
...
### [0452] A6/OFF — item_audit_runs CHECK(status IN ('IN-PROGRESS','COMPLETE','HANDED-OFF'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0453] A6/OFF — item_axis_links CHECK(strength_band IN ('full','partial','weak'))   `2026-08-12 07:59:50Z`
...
### [0454] A6/OFF — item_axis_links CHECK(use_mode IN ('independent','assisted','collective') OR use_mode IS NULL)   `2026-08-12 07:59:50Z`
...
### [0455] A6/OFF — item_bpc_links CHECK(link_type IN ( 'primary','parameter','context','secondary' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (link_type outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "item_bpc_links" ("item_code", "slug", "link_type", "created_at", "created_by_session") VALUES (?, ?, ?, ?, ?)  -- {"item_code": "B-02", "slug": "PROBE-PK-267", "link_type": "PROBE-INVALID-ENUM", "created_at": "PROBE-1075", "created_by_session": "PROBE-1076"}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: link_type IN (
...
### [0456] A6/OFF — item_population_links CHECK(applicability IN ( 'applies', 'applies_strictly', 'applies_loosely', 'context_dependent', 'does_not_apply' ))   `2026-08-12 07:59:50Z`
...
### [0457] A6/OFF — items CHECK(category IN ( 'A','B','C','D','E','F','G','H','I','J','K' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=OFF)
**SQL:**
```sql
...
### [0458] A6/OFF — items CHECK(status IN ('draft','active','merged','retired'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0459] A6/OFF — jurisdictional_values CHECK(is_code_minimum IS NULL OR is_code_minimum IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0460] A6/OFF — lang_jur_map CHECK(role IN ('PRIMARY', 'SECONDARY'))   `2026-08-12 07:59:50Z`
...
### [0461] A6/OFF — life_stage_modifiers CHECK(code IN ('SEN','CHD'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (code outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "life_stage_modifiers" ("code", "label", "definition") VALUES (?, ?, ?)  -- {"code": "PROBE-INVALID-ENUM", "label": "PROBE-LABEL", "definition": "PROBE-DEFINITION"}
...
### [0462] A6/OFF — population_axis_map CHECK(role IN ('ALIAS','PRIMARY','SECONDARY','SITUATIONAL'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (role outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "population_axis_map" ("population_code", "axis_code", "role") VALUES (?, ?, ?)  -- {"population_code": "ADHD", "axis_code": "AX-AMB", "role": "PROBE-INVALID-ENUM"}
...
### [0463] A6/OFF — population_reclass CHECK(row_kind IN ('EXISTING-POP','NEW-PROFILE'))   `2026-08-12 07:59:50Z`
...
### [0464] A6/OFF — population_reclass CHECK(layer IN ('AXIS-ALIAS','PROFILE','QUALIFIER','SPLIT'))   `2026-08-12 07:59:50Z`
...
### [0465] A6/OFF — population_reclass CHECK(profile_kind IN ('diagnostic','identity-cultural','demographic','anthropometric','compound','umbrella'))   `2026-08-12 07:59:50Z`
...
### [0466] A6/OFF — population_reclass CHECK(mapping_confidence IN ('high','moderate','low','minimal','TO-ASSESS') OR mapping_confidence IS NULL)   `2026-08-12 07:59:50Z`
...
### [0467] A6/OFF — population_reclass CHECK(fluctuating IN ('yes','no') OR fluctuating IS NULL)   `2026-08-12 07:59:50Z`
...
### [0468] A6/OFF — populations CHECK(category IN ( 'mobility', 'sensory', 'cognitive', 'mental_health', 'pain_fatigue', 'neurological', 'developmen)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (category outside enum; FK=OFF)
**SQL:**
```sql
...
### [0469] A6/OFF — populations CHECK(is_compound IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0470] A6/OFF — populations CHECK(status IN ('active', 'deprecated'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0471] A6/OFF — reasoning_doc_citations CHECK(claim_type IN ( 'numerical_spec','jurisdiction_value','qualitative','definitional' ))   `2026-08-12 07:59:50Z`
...
### [0472] A6/OFF — reasoning_doc_citations CHECK(value_match IN ( 'EXACT','WITHIN-TOLERANCE','DIFFERENT','NOT-FOUND','PAYWALL','SUPERSEDED' ))   `2026-08-12 07:59:50Z`
...
### [0473] A6/OFF — reasoning_doc_citations CHECK(claim_match IN ( 'SUPPORTED','PARTIAL','NOT-FOUND','PAYWALL','CONTRADICTED' ))   `2026-08-12 07:59:50Z`
...
### [0474] A6/OFF — reasoning_doc_citations CHECK(paywall_purchase_candidate IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0475] A6/OFF — reasoning_doc_citations CHECK( (claim_type IN ('numerical_spec','jurisdiction_value') AND claimed_value IS NOT NULL AND value_match IS NOT N)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=OFF)
**SQL:**
```sql
...
### [0476] A6/OFF — room_items CHECK(applicability IN ('applies','conditional','not-applicable'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (applicability outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "room_items" ("room_code", "item_code", "applicability") VALUES (?, ?, ?)  -- {"room_code": "R-ASM", "item_code": "A-01", "applicability": "PROBE-INVALID-ENUM"}
...
### [0477] A6/OFF — rooms CHECK(status IN ('active','draft','retired'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0478] A6/OFF — search_candidates CHECK(disposition IN ('REHOME','MISCELLANEOUS','PENDING-VERIFICATION','OUT-OF-SCOPE','ADMITTED'))   `2026-08-12 07:59:50Z`
...
### [0479] A6/OFF — search_candidates CHECK(locator_status IS NULL OR locator_status IN ('UNVERIFIED','RESOLVED','DEAD'))   `2026-08-12 07:59:50Z`
...
### [0480] A6/OFF — search_candidates CHECK(tier_guess IS NULL OR tier_guess BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0481] A6/OFF — search_candidates CHECK(harm_finding IN (0,1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (harm_finding outside enum; FK=OFF)
**SQL:**
```sql
...
### [0482] A6/OFF — search_coverage CHECK(status IN ('SEARCHED','THIN','NO-DATA','NOT-RUN'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0483] A6/OFF — search_coverage CHECK(co1_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0484] A6/OFF — search_coverage CHECK(tier5_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0485] A6/OFF — search_coverage CHECK(tier6_attempted IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0486] A6/OFF — search_executions CHECK(target_tier IS NULL OR target_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0487] A6/OFF — search_executions CHECK(target_evidence_type IS NULL OR target_evidence_type IN ('clinical','sr_meta','standard_eb','national_fw','cod)   `2026-08-12 07:59:50Z`
...
### [0488] A6/OFF — search_executions CHECK(target_scope IS NULL OR target_scope IN ('intrinsic','lower_control','high_control','national','international')   `2026-08-12 07:59:50Z`
...
### [0489] A6/OFF — search_executions CHECK(depth_method IN ('scoping','systematic'))   `2026-08-12 07:59:50Z`
...
### [0490] A6/OFF — search_executions CHECK(mining_direction IS NULL OR mining_direction IN ('none','backward','forward','both'))   `2026-08-12 07:59:50Z`
...
### [0491] A6/OFF — search_executions CHECK(saturation_signal IS NULL OR saturation_signal IN ('none','partial','saturated'))   `2026-08-12 07:59:50Z`
...
### [0492] A6/OFF — search_executions CHECK(backfill IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0493] A6/OFF — search_executions CHECK(terms_used IS NULL OR json_valid(terms_used))   `2026-08-12 07:59:50Z`
...
### [0494] A6/OFF — search_executions CHECK(admitted_ref_ids IS NULL OR json_valid(admitted_ref_ids))   `2026-08-12 07:59:50Z`
...
### [0495] A6/OFF — search_languages CHECK(status IN ('SEARCHED','PARTIAL','NOT-RUN'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0496] A6/OFF — situations CHECK(operational_access IN ('yes','no') OR operational_access IS NULL)   `2026-08-12 07:59:50Z`
...
### [0497] A6/OFF — slugs CHECK(status IN ( 'ACTIVE','MERGED','STUB','PROVISIONAL' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (status outside enum; FK=OFF)
**SQL:**
```sql
...
### [0498] A6/OFF — source_locators CHECK(doi IS NOT NULL OR url IS NOT NULL OR pmid IS NOT NULL OR pmcid IS NOT NULL OR isbn IS NOT NULL OR issn IS NOT)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (all of ['doi', 'url', 'pmid', 'pmcid', 'isbn', 'issn', 'standard_number'] NULL; FK=OFF)
**SQL:**
```sql
INSERT INTO "source_locators" ("ref_id", "isbn", "standard_number", "doi", "pmcid", "issn", "url", "pmid") VALUES (?, ?, ?, ?, ?, ?, ?, ?)  -- {"ref_id": "PROBE-1251", "isbn": null, "standard_number": null, "doi": null, "pmcid": null, "issn": null, "url": null, "pmid": null}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: doi IS NOT NULL OR url IS NOT NULL OR pmid IS NOT NULL
...
### [0499] A6/OFF — source_value_extractions CHECK(claim_type IN ('numerical','range','qualitative','framework','absent'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=OFF)
**SQL:**
```sql
...
### [0500] A6/OFF — source_value_extractions CHECK(extraction_method IN ('skim','full-read','re-read','auto-mined'))   `2026-08-12 07:59:50Z`
...
### [0501] A6/OFF — source_value_extractions CHECK(extraction_status IN ('preliminary','reviewed','verified','contradicted','absent-confirmed'))   `2026-08-12 07:59:50Z`
...
### [0502] A6/OFF — source_value_extractions CHECK(root_type IN ( 'measurement_primary', 'participatory_finding', 'committee_assertion', 'derived_calculation', ')   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (root_type outside enum; FK=OFF)
**SQL:**
```sql
...
### [0503] A6/OFF — source_value_extractions CHECK(measurement_paradigm IN ( 'swept_path_dynamic', 'static_turning_circle', 'static_clearance', 'anthropometric_p)   `2026-08-12 07:59:50Z`
...
### [0504] A6/OFF — source_value_extractions CHECK(device_class IN ( 'manual_self_propelled', 'manual_attendant', 'power_chair', 'scooter', 'bariatric_manual', ')   `2026-08-12 07:59:50Z`
...
### [0505] A6/OFF — source_value_extractions CHECK(contested IN (0, 1))   `2026-08-12 07:59:50Z`
...
### [0506] A6/OFF — source_value_extractions CHECK( (claim_type = 'absent' AND claimed_value IS NULL) OR (claim_type <> 'absent' AND claimed_value IS NOT NULL) )   `2026-08-12 07:59:50Z`
...
### [0507] A6/OFF — spec_value_probes CHECK(direction IN ('up','down'))   `2026-08-12 07:59:50Z`
...
### [0508] A6/OFF — spec_value_probes CHECK(claim_type IN ( 'minimum','maximum','target','range_low','range_high' ))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (claim_type outside enum; FK=OFF)
**SQL:**
```sql
...
### [0509] A6/OFF — spec_value_probes CHECK(phase IN ( 'outer-pass-1st','outer-pass-2nd','outer-stop', 'refinement-pass-1st','refinement-pass-2nd','refine)   `2026-08-12 07:59:50Z`
...
### [0510] A6/OFF — spec_value_probes CHECK(passes_strict IN (0,1))   `2026-08-12 07:59:50Z`
...
### [0511] A6/OFF — specification_source_links CHECK(role IN ('governing'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (role outside enum; FK=OFF)
**SQL:**
```sql
...
### [0512] A6/OFF — specifications CHECK(state IN ('stated', 'provisional', 'pending', 'not_applicable'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (state outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state") VALUES (?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "PROBE-INVALID-ENUM"}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: state IN ('stated', 'provisional',
...
### [0513] A6/OFF — specifications CHECK(design_scale IN ('universal', 'population', 'person'))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (design_scale outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "design_scale") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "design_scale": "PROBE-INVALID-ENUM"}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: design_scale IN ('universal', 'population', 'person')`
...
### [0514] A6/OFF — specifications CHECK(governing_refs IS NULL OR json_valid(governing_refs))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (invalid JSON in governing_refs; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "governing_refs") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "governing_refs": "{not-json"}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: governing_refs IS NULL OR json_valid(governing_refs)`
...
### [0515] A6/OFF — specifications CHECK(code_floor_only IN (0, 1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (code_floor_only outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "code_floor_only") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "code_floor_only": 987654321}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: code_floor_only IN (0, 1)`
...
### [0516] A6/OFF — specifications CHECK(has_unverified_sources IN (0, 1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (has_unverified_sources outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "has_unverified_sources") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "has_unverified_sources": 987654321}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: has_unverified_sources IN (0, 1)`
...
### [0517] A6/OFF — specifications CHECK(all_sources_disqualified IN (0, 1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (all_sources_disqualified outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "all_sources_disqualified") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "all_sources_disqualified": 987654321}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: all_sources_disqualified IN (0, 1)`
...
### [0518] A6/OFF — specifications CHECK(regulatory_stratum_only IN (0, 1))   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (regulatory_stratum_only outside enum; FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "regulatory_stratum_only") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "regulatory_stratum_only": 987654321}
```
**Expected:** CHECK constraint failed
**Actual:** rejected by CHECK
**Exception:** `IntegrityError: CHECK constraint failed: regulatory_stratum_only IN (0, 1)`
...
### [0519] A6/OFF — supersession_check CHECK(anchor_tier BETWEEN 1 AND 6)   `2026-08-12 07:59:50Z`
...
### [0520] A6/OFF — supersession_check CHECK(outcome IN ( 'current_best', 'superseded_by', 'refined_by', 'divergent_no_supersession', 'co1_addition_logged')   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (outcome outside enum; FK=OFF)
**SQL:**
```sql
...
### [0521] A6/OFF — supersession_check CHECK(check_method IN ( 'pubmed_search', 'scholar_gateway', 'cochrane_direct', 'standards_body_direct', 'multilingua)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (check_method outside enum; FK=OFF)
**SQL:**
```sql
...
### [0522] A6/OFF — supersession_check CHECK( (outcome IN ('superseded_by','refined_by','divergent_no_supersession') AND (superseding_ref_ids IS NOT NULL O)   `2026-08-12 07:59:50Z`
**Action:** insert row violating the CHECK (outcome outside enum; FK=OFF)
**SQL:**
```sql
...
### [0523] A6/OFF — supersession_check CHECK( outcome != 'refined_by' OR refinement_dimension IS NOT NULL )   `2026-08-12 07:59:50Z`
...
### [0524] A6/OFF — supersession_check CHECK( outcome != 'divergent_no_supersession' OR divergence_notes IS NOT NULL )   `2026-08-12 07:59:50Z`
...
### [0525] A6/OFF — supersession_check CHECK( outcome != 'co1_addition_logged' OR anchor_evidence_type = 'co1' )   `2026-08-12 07:59:50Z`
**Action:** construct a violating row (FK=OFF)
**Expected:** CHECK fires
**Actual:** no mechanical violation constructible for this expression (cross-column/complex predicate)
**Verdict:** `BLOCKED`

### [0526] A6/OFF — term_aliases CHECK(alias_type IN ( 'SYNONYM','TRANSLATION','NARROWER', 'BROADER','DEPRECATED','DOMAIN' ))   `2026-08-12 07:59:50Z`
...
### [0527] A6/OFF — weighting_profile CHECK(json_valid(tier_weights))   `2026-08-12 07:59:50Z`
...
### [0528] A7/ON — access_duration.definition   `2026-08-12 07:59:50Z`
...
### [0529] A7/ON — access_need_axis_map.relationship   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0530] A7/ON — access_need_icf.icf_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0531] A7/ON — access_need_icf.confidence   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0532] A7/ON — access_needs.family   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0533] A7/ON — access_needs.design_obligation   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0534] A7/ON — access_needs.source_version   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0535] A7/ON — access_stakes.definition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0536] A7/ON — axes.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0537] A7/ON — axes.mechanism   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0538] A7/ON — axes.coverage_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0539] A7/ON — axes.falsification_condition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0540] A7/ON — bpc_metadata.population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0541] A7/ON — bpc_metadata.pico_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0542] A7/ON — bpc_metadata.search_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0543] A7/ON — bpc_metadata.bpc_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0544] A7/ON — bpc_metadata.citation_mining_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0545] A7/ON — bpc_metadata.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0546] A7/ON — bpc_metadata.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0547] A7/ON — bpc_metadata.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0548] A7/ON — bpc_metadata.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0549] A7/ON — bpc_metadata.supersession_check_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0550] A7/ON — case_studies.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0551] A7/ON — case_studies.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0552] A7/ON — case_studies.building_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0553] A7/ON — case_studies.location   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0554] A7/ON — case_studies.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0555] A7/ON — case_studies.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0556] A7/ON — case_studies.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0557] A7/ON — case_studies.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0558] A7/ON — case_study_outcomes.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0559] A7/ON — case_study_outcomes.metric   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0560] A7/ON — case_study_strategies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0561] A7/ON — case_study_strategies.strategy   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0562] A7/ON — citation_mining.backward   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0563] A7/ON — citation_mining.forward   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0564] A7/ON — citation_mining.connections_produced   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0565] A7/ON — citation_mining.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0566] A7/ON — citation_mining.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0567] A7/ON — citation_mining.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0568] A7/ON — citation_mining.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0569] A7/ON — conflicts.domain   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0570] A7/ON — conflicts.pop_a   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0571] A7/ON — conflicts.pop_b   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0572] A7/ON — conflicts.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0573] A7/ON — conflicts.source_skill   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0574] A7/ON — conflicts.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0575] A7/ON — conflicts.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0576] A7/ON — conflicts.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0577] A7/ON — conflicts.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0578] A7/ON — connections.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0579] A7/ON — connections.confidence   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0580] A7/ON — connections.filed_in   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0581] A7/ON — connections.opus_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0582] A7/ON — connections.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0583] A7/ON — connections.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0584] A7/ON — connections.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0585] A7/ON — connections.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0586] A7/ON — convergence_assessment.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0587] A7/ON — data_migrations.applied_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0588] A7/ON — data_migrations.content_sha   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0589] A7/ON — db_meta.value   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0590] A7/ON — decisions.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0591] A7/ON — decisions.delegation   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0592] A7/ON — decisions.summary   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0593] A7/ON — decisions.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0594] A7/ON — decisions.rationale   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0595] A7/ON — decisions.decision_date   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0596] A7/ON — decisions.decided_by   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0597] A7/ON — decisions.model_routing   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0598] A7/ON — decisions.effort_level   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0599] A7/ON — decisions.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0600] A7/ON — decisions.review_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0601] A7/ON — decisions.supersedes   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0602] A7/ON — decisions.predecessors   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0603] A7/ON — decisions.decision_artifacts   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0604] A7/ON — decisions.alternatives_considered   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0605] A7/ON — decisions.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0606] A7/ON — decisions.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0607] A7/ON — decisions.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0608] A7/ON — decisions.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0609] A7/ON — economics_entries.pillar   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0610] A7/ON — economics_entries.entry_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0611] A7/ON — economics_entries.source   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0612] A7/ON — economics_entries.finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0613] A7/ON — economics_entries.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0614] A7/ON — economics_entries.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0615] A7/ON — economics_entries.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0616] A7/ON — evidence_population_match.source_ref   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0617] A7/ON — evidence_population_match.target_population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0618] A7/ON — evidence_population_match.match_grade   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0619] A7/ON — evidence_population_match.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0620] A7/ON — evidence_population_match.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0621] A7/ON — evidence_source_authors.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0622] A7/ON — evidence_source_authors.position   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0623] A7/ON — evidence_source_authors.is_corporate   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0624] A7/ON — evidence_source_authors.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0625] A7/ON — evidence_sources.data_capture_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0626] A7/ON — evidence_sources.citation_mining_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0627] A7/ON — external_root_registry.description   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0628] A7/ON — gap_mining.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0629] A7/ON — gap_mining.attempt_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0630] A7/ON — gap_mining.attempted_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0631] A7/ON — gap_mining.search_strategy_record   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0632] A7/ON — gap_mining.candidates_returned   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0633] A7/ON — gap_mining.candidates_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0634] A7/ON — gap_mining.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0635] A7/ON — gap_mining.check_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0636] A7/ON — gaps.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0637] A7/ON — gaps.priority   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0638] A7/ON — gaps.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0639] A7/ON — gaps.description   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0640] A7/ON — gaps.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0641] A7/ON — gaps.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0642] A7/ON — gaps.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0643] A7/ON — gaps.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0644] A7/ON — item_audit_runs.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0645] A7/ON — item_audit_runs.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0646] A7/ON — item_audit_runs.steps_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0647] A7/ON — item_audit_runs.steps_started   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0648] A7/ON — item_audit_runs.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0649] A7/ON — item_audit_runs.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0650] A7/ON — item_audit_runs.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0651] A7/ON — item_audit_runs.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0652] A7/ON — item_audit_runs.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0653] A7/ON — item_bpc_links.link_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0654] A7/ON — item_bpc_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0655] A7/ON — item_bpc_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0656] A7/ON — item_population_elaborations.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0657] A7/ON — item_population_elaborations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0658] A7/ON — item_population_links.applicability   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0659] A7/ON — items.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0660] A7/ON — items.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0661] A7/ON — items.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0662] A7/ON — items.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0663] A7/ON — items.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0664] A7/ON — items.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0665] A7/ON — items.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0666] A7/ON — jurisdictional_values.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0667] A7/ON — jurisdictional_values.jurisdiction   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0668] A7/ON — jurisdictional_values.evidence_tier   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0669] A7/ON — lang_jur_map.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0670] A7/ON — life_stage_modifiers.label   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0671] A7/ON — life_stage_modifiers.definition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0672] A7/ON — pipeline_runs.started_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0673] A7/ON — population_axis_map.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0674] A7/ON — population_reclass.row_kind   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0675] A7/ON — population_reclass.layer   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0676] A7/ON — population_reclass.rationale   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0677] A7/ON — populations.display_name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0678] A7/ON — reasoning_doc_citations.reasoning_doc_slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0679] A7/ON — reasoning_doc_citations.parameter   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0680] A7/ON — reasoning_doc_citations.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0681] A7/ON — reasoning_doc_citations.source_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0682] A7/ON — reasoning_doc_citations.verified_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0683] A7/ON — reasoning_doc_citations.verified_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0684] A7/ON — reasoning_doc_citations.paywall_purchase_candidate   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0685] A7/ON — room_items.applicability   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0686] A7/ON — rooms.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0687] A7/ON — rooms.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0688] A7/ON — search_candidates.found_under_slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0689] A7/ON — search_candidates.disposition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0690] A7/ON — search_candidates.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0691] A7/ON — search_candidates.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0692] A7/ON — search_candidates.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0693] A7/ON — search_candidates.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0694] A7/ON — search_coverage.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0695] A7/ON — search_coverage.co1_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0696] A7/ON — search_coverage.tier5_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0697] A7/ON — search_coverage.tier6_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0698] A7/ON — search_coverage.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0699] A7/ON — search_coverage.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0700] A7/ON — search_coverage.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0701] A7/ON — search_coverage.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0702] A7/ON — search_executions.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0703] A7/ON — search_executions.language   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0704] A7/ON — search_executions.query_text   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0705] A7/ON — search_executions.engine   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0706] A7/ON — search_executions.depth_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0707] A7/ON — search_executions.results_found   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0708] A7/ON — search_executions.results_screened   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0709] A7/ON — search_executions.results_admitted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0710] A7/ON — search_executions.backfill   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0711] A7/ON — search_executions.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0712] A7/ON — search_executions.executed_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0713] A7/ON — search_executions.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0714] A7/ON — search_languages.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0715] A7/ON — search_languages.results_count   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0716] A7/ON — search_languages.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0717] A7/ON — search_languages.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0718] A7/ON — search_languages.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0719] A7/ON — search_languages.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0720] A7/ON — situations.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0721] A7/ON — situations.account_language   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0722] A7/ON — situations.account_text_ref   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0723] A7/ON — slugs.topic_directory   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0724] A7/ON — slugs.sl_path   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0725] A7/ON — slugs.bpc_path   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0726] A7/ON — slugs.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0727] A7/ON — slugs.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0728] A7/ON — slugs.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0729] A7/ON — slugs.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0730] A7/ON — slugs.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0731] A7/ON — source_locators.recovered_from   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
INSERT INTO "source_locators" ("ref_id", "isbn", "standard_number", "doi", "pmcid", "issn", "url", "pmid", "recovered_from") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)  -- {"ref_id": "PROBE-2305", "isbn": "PROBE-2306", "standard_number": "PROBE-2307", "doi": "PROBE-2308", "pmcid": "PROBE-2309", "issn": "PROBE-2310", "url": "PROBE-2311", "pmid": "PROBE-2312", "recovered_from": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
...
### [0732] A7/ON — source_slug_links.local_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0733] A7/ON — source_slug_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0734] A7/ON — source_slug_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0735] A7/ON — source_slug_links.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0736] A7/ON — source_slug_links.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0737] A7/ON — source_value_extractions.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0738] A7/ON — source_value_extractions.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0739] A7/ON — source_value_extractions.parameter   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0740] A7/ON — source_value_extractions.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0741] A7/ON — source_value_extractions.extraction_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0742] A7/ON — source_value_extractions.extraction_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0743] A7/ON — source_value_extractions.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0744] A7/ON — source_value_extractions.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0745] A7/ON — source_value_extractions.contested   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0746] A7/ON — spec_value_probes.walk_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0747] A7/ON — spec_value_probes.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0748] A7/ON — spec_value_probes.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0749] A7/ON — spec_value_probes.spec_value_origin   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0750] A7/ON — spec_value_probes.spec_unit   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0751] A7/ON — spec_value_probes.direction   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0752] A7/ON — spec_value_probes.population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0753] A7/ON — spec_value_probes.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0754] A7/ON — spec_value_probes.step_index   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0755] A7/ON — spec_value_probes.phase   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0756] A7/ON — spec_value_probes.step_value   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0757] A7/ON — spec_value_probes.step_value_unit   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0758] A7/ON — spec_value_probes.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0759] A7/ON — spec_value_probes.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0760] A7/ON — specification_source_links.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0761] A7/ON — specifications.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0762] A7/ON — specifications.population_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0763] A7/ON — specifications.state   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0764] A7/ON — specifications.code_floor_only   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0765] A7/ON — specifications.has_unverified_sources   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0766] A7/ON — specifications.all_sources_disqualified   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0767] A7/ON — specifications.regulatory_stratum_only   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0768] A7/ON — supersession_check.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0769] A7/ON — supersession_check.local_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0770] A7/ON — supersession_check.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0771] A7/ON — supersession_check.anchor_tier   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0772] A7/ON — supersession_check.anchor_evidence_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0773] A7/ON — supersession_check.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0774] A7/ON — supersession_check.search_strategy_record   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0775] A7/ON — supersession_check.candidates_returned   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0776] A7/ON — supersession_check.candidates_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0777] A7/ON — supersession_check.checked_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0778] A7/ON — supersession_check.checked_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0779] A7/ON — supersession_check.check_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0780] A7/ON — term_aliases.alias_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0781] A7/ON — term_aliases.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0782] A7/ON — term_aliases.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0783] A7/ON — term_aliases.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0784] A7/ON — term_aliases.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0785] A7/ON — term_item_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0786] A7/ON — term_item_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0787] A7/ON — term_item_links.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0788] A7/ON — term_item_links.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0789] A7/ON — terms.canonical_en   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0790] A7/ON — terms.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0791] A7/ON — terms.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0792] A7/ON — terms.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0793] A7/ON — terms.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0794] A7/ON — url_verification_runs.started_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0795] A7/ON — weighting_profile.tier_weights   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=ON)
**SQL:**
```sql
...
### [0796] A7/OFF — access_duration.definition   `2026-08-12 07:59:50Z`
...
### [0797] A7/OFF — access_need_axis_map.relationship   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "access_need_axis_map" ("need_code", "axis_code", "relationship") VALUES (?, ?, ?)  -- {"need_code": "A-AT", "axis_code": "AX-AMB", "relationship": null}
...
### [0798] A7/OFF — access_need_icf.icf_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0799] A7/OFF — access_need_icf.confidence   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0800] A7/OFF — access_needs.family   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0801] A7/OFF — access_needs.design_obligation   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0802] A7/OFF — access_needs.source_version   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0803] A7/OFF — access_stakes.definition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0804] A7/OFF — axes.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0805] A7/OFF — axes.mechanism   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0806] A7/OFF — axes.coverage_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0807] A7/OFF — axes.falsification_condition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0808] A7/OFF — bpc_metadata.population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0809] A7/OFF — bpc_metadata.pico_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0810] A7/OFF — bpc_metadata.search_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0811] A7/OFF — bpc_metadata.bpc_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0812] A7/OFF — bpc_metadata.citation_mining_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0813] A7/OFF — bpc_metadata.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0814] A7/OFF — bpc_metadata.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0815] A7/OFF — bpc_metadata.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0816] A7/OFF — bpc_metadata.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0817] A7/OFF — bpc_metadata.supersession_check_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0818] A7/OFF — case_studies.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0819] A7/OFF — case_studies.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0820] A7/OFF — case_studies.building_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0821] A7/OFF — case_studies.location   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0822] A7/OFF — case_studies.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0823] A7/OFF — case_studies.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0824] A7/OFF — case_studies.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0825] A7/OFF — case_studies.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0826] A7/OFF — case_study_outcomes.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0827] A7/OFF — case_study_outcomes.metric   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "case_study_outcomes" ("case_study_id", "metric") VALUES (?, ?)  -- {"case_study_id": "PROBE-CASE_STUDY_ID", "metric": null}
...
### [0828] A7/OFF — case_study_strategies.case_study_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0829] A7/OFF — case_study_strategies.strategy   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "case_study_strategies" ("case_study_id", "strategy") VALUES (?, ?)  -- {"case_study_id": "PROBE-CASE_STUDY_ID", "strategy": null}
...
### [0830] A7/OFF — citation_mining.backward   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0831] A7/OFF — citation_mining.forward   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0832] A7/OFF — citation_mining.connections_produced   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0833] A7/OFF — citation_mining.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0834] A7/OFF — citation_mining.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0835] A7/OFF — citation_mining.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0836] A7/OFF — citation_mining.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0837] A7/OFF — conflicts.domain   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0838] A7/OFF — conflicts.pop_a   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0839] A7/OFF — conflicts.pop_b   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0840] A7/OFF — conflicts.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0841] A7/OFF — conflicts.source_skill   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0842] A7/OFF — conflicts.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0843] A7/OFF — conflicts.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0844] A7/OFF — conflicts.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0845] A7/OFF — conflicts.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0846] A7/OFF — connections.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0847] A7/OFF — connections.confidence   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0848] A7/OFF — connections.filed_in   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0849] A7/OFF — connections.opus_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0850] A7/OFF — connections.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0851] A7/OFF — connections.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0852] A7/OFF — connections.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0853] A7/OFF — connections.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0854] A7/OFF — convergence_assessment.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "convergence_assessment" ("status") VALUES (?)  -- {"status": null}
...
### [0855] A7/OFF — data_migrations.applied_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0856] A7/OFF — data_migrations.content_sha   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0857] A7/OFF — db_meta.value   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0858] A7/OFF — decisions.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0859] A7/OFF — decisions.delegation   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0860] A7/OFF — decisions.summary   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0861] A7/OFF — decisions.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0862] A7/OFF — decisions.rationale   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0863] A7/OFF — decisions.decision_date   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0864] A7/OFF — decisions.decided_by   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0865] A7/OFF — decisions.model_routing   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0866] A7/OFF — decisions.effort_level   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0867] A7/OFF — decisions.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0868] A7/OFF — decisions.review_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0869] A7/OFF — decisions.supersedes   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0870] A7/OFF — decisions.predecessors   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0871] A7/OFF — decisions.decision_artifacts   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0872] A7/OFF — decisions.alternatives_considered   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0873] A7/OFF — decisions.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0874] A7/OFF — decisions.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0875] A7/OFF — decisions.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0876] A7/OFF — decisions.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0877] A7/OFF — economics_entries.pillar   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0878] A7/OFF — economics_entries.entry_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0879] A7/OFF — economics_entries.source   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0880] A7/OFF — economics_entries.finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0881] A7/OFF — economics_entries.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0882] A7/OFF — economics_entries.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0883] A7/OFF — economics_entries.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0884] A7/OFF — evidence_population_match.source_ref   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0885] A7/OFF — evidence_population_match.target_population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0886] A7/OFF — evidence_population_match.match_grade   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0887] A7/OFF — evidence_population_match.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0888] A7/OFF — evidence_population_match.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0889] A7/OFF — evidence_source_authors.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "evidence_source_authors" ("ref_id", "position") VALUES (?, ?)  -- {"ref_id": null, "position": 1}
...
### [0890] A7/OFF — evidence_source_authors.position   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0891] A7/OFF — evidence_source_authors.is_corporate   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0892] A7/OFF — evidence_source_authors.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0893] A7/OFF — evidence_sources.data_capture_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0894] A7/OFF — evidence_sources.citation_mining_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0895] A7/OFF — external_root_registry.description   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0896] A7/OFF — gap_mining.gap_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0897] A7/OFF — gap_mining.attempt_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0898] A7/OFF — gap_mining.attempted_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0899] A7/OFF — gap_mining.search_strategy_record   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0900] A7/OFF — gap_mining.candidates_returned   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0901] A7/OFF — gap_mining.candidates_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0902] A7/OFF — gap_mining.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0903] A7/OFF — gap_mining.check_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0904] A7/OFF — gaps.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0905] A7/OFF — gaps.priority   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0906] A7/OFF — gaps.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0907] A7/OFF — gaps.description   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0908] A7/OFF — gaps.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0909] A7/OFF — gaps.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0910] A7/OFF — gaps.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0911] A7/OFF — gaps.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0912] A7/OFF — item_audit_runs.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0913] A7/OFF — item_audit_runs.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0914] A7/OFF — item_audit_runs.steps_complete   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0915] A7/OFF — item_audit_runs.steps_started   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0916] A7/OFF — item_audit_runs.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0917] A7/OFF — item_audit_runs.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0918] A7/OFF — item_audit_runs.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0919] A7/OFF — item_audit_runs.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0920] A7/OFF — item_audit_runs.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0921] A7/OFF — item_bpc_links.link_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "item_bpc_links" ("item_code", "slug", "link_type", "created_at", "created_by_session") VALUES (?, ?, ?, ?, ?)  -- {"item_code": "B-02", "slug": "PROBE-PK-267", "link_type": null, "created_at": "PROBE-3244", "created_by_session": "PROBE-3245"}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: item_bpc_links.link_type`
...
### [0922] A7/OFF — item_bpc_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "item_bpc_links" ("item_code", "slug", "link_type", "created_at", "created_by_session") VALUES (?, ?, ?, ?, ?)  -- {"item_code": "B-02", "slug": "PROBE-PK-267", "link_type": "primary", "created_at": null, "created_by_session": "PROBE-3246"}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: item_bpc_links.created_at`
...
### [0923] A7/OFF — item_bpc_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "item_bpc_links" ("item_code", "slug", "link_type", "created_at", "created_by_session") VALUES (?, ?, ?, ?, ?)  -- {"item_code": "B-02", "slug": "PROBE-PK-267", "link_type": "primary", "created_at": "PROBE-3247", "created_by_session": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: item_bpc_links.created_by_session`
...
### [0924] A7/OFF — item_population_elaborations.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "item_population_elaborations" ("item_code", "population_code") VALUES (?, ?)  -- {"item_code": null, "population_code": "ADHD"}
...
### [0925] A7/OFF — item_population_elaborations.population_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "item_population_elaborations" ("item_code", "population_code") VALUES (?, ?)  -- {"item_code": "A-01", "population_code": null}
...
### [0926] A7/OFF — item_population_links.applicability   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0927] A7/OFF — items.category   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0928] A7/OFF — items.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0929] A7/OFF — items.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0930] A7/OFF — items.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0931] A7/OFF — items.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0932] A7/OFF — items.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0933] A7/OFF — items.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0934] A7/OFF — jurisdictional_values.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0935] A7/OFF — jurisdictional_values.jurisdiction   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "jurisdictional_values" ("item_code", "jurisdiction") VALUES (?, ?)  -- {"item_code": "A-01", "jurisdiction": null}
...
### [0936] A7/OFF — jurisdictional_values.evidence_tier   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0937] A7/OFF — lang_jur_map.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0938] A7/OFF — life_stage_modifiers.label   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0939] A7/OFF — life_stage_modifiers.definition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0940] A7/OFF — pipeline_runs.started_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0941] A7/OFF — population_axis_map.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "population_axis_map" ("population_code", "axis_code", "role") VALUES (?, ?, ?)  -- {"population_code": "ADHD", "axis_code": "AX-AMB", "role": null}
...
### [0942] A7/OFF — population_reclass.row_kind   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0943] A7/OFF — population_reclass.layer   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0944] A7/OFF — population_reclass.rationale   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0945] A7/OFF — populations.display_name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0946] A7/OFF — reasoning_doc_citations.reasoning_doc_slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0947] A7/OFF — reasoning_doc_citations.parameter   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0948] A7/OFF — reasoning_doc_citations.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0949] A7/OFF — reasoning_doc_citations.source_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0950] A7/OFF — reasoning_doc_citations.verified_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0951] A7/OFF — reasoning_doc_citations.verified_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0952] A7/OFF — reasoning_doc_citations.paywall_purchase_candidate   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0953] A7/OFF — room_items.applicability   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "room_items" ("room_code", "item_code", "applicability") VALUES (?, ?, ?)  -- {"room_code": "R-ASM", "item_code": "A-01", "applicability": null}
...
### [0954] A7/OFF — rooms.name   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0955] A7/OFF — rooms.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0956] A7/OFF — search_candidates.found_under_slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0957] A7/OFF — search_candidates.disposition   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0958] A7/OFF — search_candidates.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0959] A7/OFF — search_candidates.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0960] A7/OFF — search_candidates.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0961] A7/OFF — search_candidates.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0962] A7/OFF — search_coverage.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0963] A7/OFF — search_coverage.co1_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0964] A7/OFF — search_coverage.tier5_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0965] A7/OFF — search_coverage.tier6_attempted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0966] A7/OFF — search_coverage.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0967] A7/OFF — search_coverage.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0968] A7/OFF — search_coverage.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0969] A7/OFF — search_coverage.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0970] A7/OFF — search_executions.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0971] A7/OFF — search_executions.language   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0972] A7/OFF — search_executions.query_text   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0973] A7/OFF — search_executions.engine   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0974] A7/OFF — search_executions.depth_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0975] A7/OFF — search_executions.results_found   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0976] A7/OFF — search_executions.results_screened   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0977] A7/OFF — search_executions.results_admitted   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0978] A7/OFF — search_executions.backfill   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0979] A7/OFF — search_executions.session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0980] A7/OFF — search_executions.executed_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0981] A7/OFF — search_executions.harm_finding   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0982] A7/OFF — search_languages.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0983] A7/OFF — search_languages.results_count   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0984] A7/OFF — search_languages.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0985] A7/OFF — search_languages.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0986] A7/OFF — search_languages.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0987] A7/OFF — search_languages.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0988] A7/OFF — situations.title   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0989] A7/OFF — situations.account_language   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0990] A7/OFF — situations.account_text_ref   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0991] A7/OFF — slugs.topic_directory   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0992] A7/OFF — slugs.sl_path   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0993] A7/OFF — slugs.bpc_path   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0994] A7/OFF — slugs.status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0995] A7/OFF — slugs.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0996] A7/OFF — slugs.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0997] A7/OFF — slugs.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0998] A7/OFF — slugs.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [0999] A7/OFF — source_locators.recovered_from   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "source_locators" ("ref_id", "isbn", "standard_number", "doi", "pmcid", "issn", "url", "pmid", "recovered_from") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)  -- {"ref_id": "PROBE-3540", "isbn": "PROBE-3541", "standard_number": "PROBE-3542", "doi": "PROBE-3543", "pmcid": "PROBE-3544", "issn": "PROBE-3545", "url": "PROBE-3546", "pmid": "PROBE-3547", "recovered_from": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: source_locators.recovered_from`
...
### [1000] A7/OFF — source_slug_links.local_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1001] A7/OFF — source_slug_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1002] A7/OFF — source_slug_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1003] A7/OFF — source_slug_links.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1004] A7/OFF — source_slug_links.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1005] A7/OFF — source_value_extractions.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1006] A7/OFF — source_value_extractions.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1007] A7/OFF — source_value_extractions.parameter   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1008] A7/OFF — source_value_extractions.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1009] A7/OFF — source_value_extractions.extraction_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1010] A7/OFF — source_value_extractions.extraction_status   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1011] A7/OFF — source_value_extractions.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1012] A7/OFF — source_value_extractions.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1013] A7/OFF — source_value_extractions.contested   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1014] A7/OFF — spec_value_probes.walk_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1015] A7/OFF — spec_value_probes.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1016] A7/OFF — spec_value_probes.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1017] A7/OFF — spec_value_probes.spec_value_origin   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1018] A7/OFF — spec_value_probes.spec_unit   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1019] A7/OFF — spec_value_probes.direction   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1020] A7/OFF — spec_value_probes.population   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1021] A7/OFF — spec_value_probes.claim_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1022] A7/OFF — spec_value_probes.step_index   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1023] A7/OFF — spec_value_probes.phase   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1024] A7/OFF — spec_value_probes.step_value   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1025] A7/OFF — spec_value_probes.step_value_unit   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1026] A7/OFF — spec_value_probes.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1027] A7/OFF — spec_value_probes.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1028] A7/OFF — specification_source_links.role   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1029] A7/OFF — specifications.item_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state") VALUES (?, ?, ?)  -- {"item_code": null, "population_code": "LPA", "state": "stated"}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.item_code`
...
### [1030] A7/OFF — specifications.population_code   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state") VALUES (?, ?, ?)  -- {"item_code": "H-02", "population_code": null, "state": "stated"}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.population_code`
...
### [1031] A7/OFF — specifications.state   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state") VALUES (?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.state`
...
### [1032] A7/OFF — specifications.code_floor_only   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "code_floor_only") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "code_floor_only": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.code_floor_only`
...
### [1033] A7/OFF — specifications.has_unverified_sources   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "has_unverified_sources") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "has_unverified_sources": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.has_unverified_sources`
...
### [1034] A7/OFF — specifications.all_sources_disqualified   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "all_sources_disqualified") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "all_sources_disqualified": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.all_sources_disqualified`
...
### [1035] A7/OFF — specifications.regulatory_stratum_only   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state", "regulatory_stratum_only") VALUES (?, ?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated", "regulatory_stratum_only": null}
```
**Expected:** NOT NULL constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: NOT NULL constraint failed: specifications.regulatory_stratum_only`
...
### [1036] A7/OFF — supersession_check.slug   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1037] A7/OFF — supersession_check.local_ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1038] A7/OFF — supersession_check.ref_id   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1039] A7/OFF — supersession_check.anchor_tier   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1040] A7/OFF — supersession_check.anchor_evidence_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1041] A7/OFF — supersession_check.outcome   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1042] A7/OFF — supersession_check.search_strategy_record   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1043] A7/OFF — supersession_check.candidates_returned   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1044] A7/OFF — supersession_check.candidates_reviewed   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1045] A7/OFF — supersession_check.checked_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1046] A7/OFF — supersession_check.checked_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1047] A7/OFF — supersession_check.check_method   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1048] A7/OFF — term_aliases.alias_type   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1049] A7/OFF — term_aliases.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1050] A7/OFF — term_aliases.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1051] A7/OFF — term_aliases.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1052] A7/OFF — term_aliases.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1053] A7/OFF — term_item_links.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1054] A7/OFF — term_item_links.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1055] A7/OFF — term_item_links.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1056] A7/OFF — term_item_links.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1057] A7/OFF — terms.canonical_en   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1058] A7/OFF — terms.created_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1059] A7/OFF — terms.created_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1060] A7/OFF — terms.updated_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1061] A7/OFF — terms.updated_by_session   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1062] A7/OFF — url_verification_runs.started_at   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1063] A7/OFF — weighting_profile.tier_weights   `2026-08-12 07:59:50Z`
**Action:** insert explicit NULL into NOT NULL column (FK=OFF)
**SQL:**
```sql
...
### [1064] A8/ON — evidence_source_authors UNIQUE(ref_id, position, role)   `2026-08-12 07:59:50Z`
...
### [1065] A8/ON — item_population_elaborations UNIQUE(item_code, population_code, variant_distinction)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=ON)
**SQL:**
```sql
...
### [1066] A8/ON — items UNIQUE(item_id)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=ON)
**SQL:**
```sql
...
### [1067] A8/ON — jurisdictional_values UNIQUE(item_code, jurisdiction, standard_name)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=ON)
**SQL:**
```sql
...
### [1068] A8/ON — specifications UNIQUE(item_code, population_code)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=ON)
**SQL:**
```sql
...
### [1069] A8/OFF — evidence_source_authors UNIQUE(ref_id, position, role)   `2026-08-12 07:59:50Z`
...
### [1070] A8/OFF — item_population_elaborations UNIQUE(item_code, population_code, variant_distinction)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=OFF)
**SQL:**
```sql
...
### [1071] A8/OFF — items UNIQUE(item_id)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=OFF)
**SQL:**
```sql
...
### [1072] A8/OFF — jurisdictional_values UNIQUE(item_code, jurisdiction, standard_name)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=OFF)
**SQL:**
```sql
...
### [1073] A8/OFF — specifications UNIQUE(item_code, population_code)   `2026-08-12 07:59:50Z`
**Action:** insert second row duplicating the unique key (FK=OFF)
**SQL:**
```sql
INSERT INTO "specifications" ("item_code", "population_code", "state") VALUES (?, ?, ?)  -- {"item_code": "H-02", "population_code": "LPA", "state": "stated"}
```
**Expected:** UNIQUE constraint failed
**Actual:** rejected
**Exception:** `IntegrityError: UNIQUE constraint failed: specifications.item_code, specifications.population_code`
...
### [1074] B — search_executions (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1075] B — slugs   `2026-08-12 07:59:50Z`
...
### [1076] B — search_executions   `2026-08-12 07:59:50Z`
...
### [1077] B — search_executions.admitted_ref_ids   `2026-08-12 07:59:50Z`
...
### [1078] B — search_admissions (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1079] B — search_admissions (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1080] B — evidence_sources   `2026-08-12 07:59:50Z`
...
### [1081] B — evidence_sources   `2026-08-12 07:59:50Z`
...
### [1082] B — search_admissions   `2026-08-12 07:59:50Z`
...
### [1083] B — search_executions ↔ search_admissions dual store   `2026-08-12 07:59:50Z`
...
### [1084] B — source_slug_links (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1085] B — source_slug_links   `2026-08-12 07:59:50Z`
...
### [1086] B — source_value_extractions   `2026-08-12 07:59:50Z`
...
### [1087] B — evidence_population_match   `2026-08-12 07:59:50Z`
...
### [1088] B — specifications (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1089] B — items   `2026-08-12 07:59:50Z`
...
### [1090] B — populations   `2026-08-12 07:59:50Z`
...
### [1091] B — specifications   `2026-08-12 07:59:50Z`
...
### [1092] B — specifications.governing_refs   `2026-08-12 07:59:50Z`
...
### [1093] B — specification_source_links (OUT OF ORDER)   `2026-08-12 07:59:50Z`
...
### [1094] B — specification_source_links   `2026-08-12 07:59:50Z`
...
### [1095] B — specification_source_links vs governing_refs   `2026-08-12 07:59:50Z`
...
### [1096] B — render/build_site.py --only K-99   `2026-08-12 07:59:51Z`
...
**Actual:** rc=0; output (trunc): Built 1 page(s) at DB fingerprint e77968be34e7.
Pages citing at least one governing source: 1 of 1.
**Verdict:** `OK`

### [1097] B — render/build_site.py (full)   `2026-08-12 07:59:51Z`
**Action:** RENDER stage: python3 scripts/generate/build_site.py
**Expected:** renders all spec pages incl. the PROBE cell
**Actual:** rc=0; output (trunc): Built 94 page(s) at DB fingerprint e77968be34e7.
Pages citing at least one governing source: 1 of 94.
**Verdict:** `OK`

### [1098] B — render/room_page.py R-BA   `2026-08-12 07:59:51Z`
...
**Actual:** rc=1; output (trunc): Traceback (most recent call last):
  File "/tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/scripts/generate/room_page.py", line 282, in <module>
    main()
  File "/tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/scripts/generate/room_page.py", line 278, in main
    generate(room_id, output_path)
  File "/tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/scripts/generate/room_page.py", line 254, in generate
    room = query_room(conn, room_id)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/scripts/generate/room_page.py", line 26, in query_room
    room = conn.execute("SELECT * FROM room WHERE room_id = ?", (room_id,)).fetchone()
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
sqlite3.OperationalError: no such table: room
**Exception:** `ee/scripts/generate/room_page.py", line 254, in generate
    room = query_room(conn, room_id)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/scripts/generate/room_page.py", line 26, in query_room
    room = conn.execute("SELECT * FROM room WHERE room_id = ?", (room_id,)).fetchone()
...
### [1099] B — render/population_page.py ALL   `2026-08-12 07:59:51Z`
**Action:** RENDER stage: python3 scripts/generate/population_page.py ALL
**Expected:** population page for code ALL from scratch DB
**Actual:** rc=0; output (trunc): Generated: /tmp/claude-0/-home-user-guidebook/1020731d-bba2-594c-9ca2-0d2b78825e52/scratchpad/probe-run/tree/site/populations/all.html (4753 bytes)
**Verdict:** `OK`
...
### [1100] V — v_best_practice   `2026-08-12 07:59:51Z`
...
### [1101] V — v_code_floor_only   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
...
### [1106] V — v_divergence   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1107] V — v_item_extractions   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1108] V — v_item_provenance   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
...
### [1109] V — v_pending   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1110] V — v_pmp_latest_walk   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1111] V — v_registry_duplicate_descriptions   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1112] V — v_root_id_conflicts   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1113] V — v_source_admission   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
...
### [1114] V — v_source_reach   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
...
### [1115] V — v_source_reach_all   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
...
### [1116] V — v_unregistered_roots   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`

### [1117] V — v_value_independence   `2026-08-12 07:59:51Z`
**Action:** execute view on canonical and on the PROBE-populated spine copy
**Expected:** executes and returns rows
**Actual:** EXECUTES-EMPTY on both — proves schema validity only; the view's semantics remain unverified (its base tables are empty even after the PROBE spine)
**Verdict:** `BLOCKED`
...
### [1118] C — cell → specification_source_links   `2026-08-12 07:59:51Z`
**Action:** resolve links for PROBE cell 1
**Expected:** ≥1 governing ref
**Actual:** refs via csl: ['PROBE-REF-99901']
**Verdict:** `OK`

### [1119] C — specification_source_links → evidence_sources   `2026-08-12 07:59:51Z`
**Action:** resolve refs to sources
**Expected:** all resolve
**Actual:** [('PROBE-REF-99901', None, None)]
**Verdict:** `OK`

### [1120] C — evidence_sources → source_value_extractions (structured join on ref_id+item_code)   `2026-08-12 07:59:51Z`
...
### [1121] C — … fallback join on ref_id alone   `2026-08-12 07:59:51Z`
**Action:** extractions for the ref regardless of item
**Expected:** ≥1
**Actual:** [(1, '5', '5.7', '§5.7')] — reachable only by dropping the item join entirely
**Verdict:** `OK`

### [1122] C — source_value_extractions → loc_* → clause   `2026-08-12 07:59:51Z`
...
### [1123] C — cell → governing_refs (JSON dual store)   `2026-08-12 07:59:51Z`
...
### [1124] C — canonical: determined cells, dual-store agreement   `2026-08-12 07:59:51Z`
...
### [1125] C — canonical: backward funnel cell→ref→extraction→locator   `2026-08-12 07:59:51Z`
...
### [1126] C — canonical: jurisdictional_values locator decomposition   `2026-08-12 07:59:51Z`
...
### [1127] C — renderers: which representation is read   `2026-08-12 07:59:51Z`
...
### [1128] D — scan   `2026-08-12 07:59:54Z`
**Action:** AST-parsed 168/167 .py files under scripts/, tools/, schemas/ (+ 350 migration .sql files scanned for writers); 0 unparseable
**Expected:** all files parse
**Actual:** all parsed
**Verdict:** `OK`

### [1129] D — PREPARE verification   `2026-08-12 07:59:54Z`
...
### [1130] D — method blind spots (stated explicitly)   `2026-08-12 07:59:54Z`
...
| `data_migrations` | 317 | scripts/migrate_db.py<br>scripts/tests/test_db_integrity.py<br>tools/pipeline_completeness.py | scripts/migrate_db.py (INSERT) | 13 stmt-kind(s) |
...
### [1133] D — phantom tables   `2026-08-12 07:59:54Z`
...
### [1134] D — separate-DB tables (graph audit module)   `2026-08-12 07:59:54Z`
...
### [1135] D — phantom columns (static)   `2026-08-12 07:59:54Z`
...
### [1136] D — legacy scripts   `2026-08-12 07:59:54Z`
...
**SWEEP D EXAMINED: 168/167 scripts AST-parsed · 1424 SQL statements PREPARE-checked (772 prepared, 216 dynamic, 210 fragments) · 67 tables in matrix · 25 phantom tables · 6 phantom column refs**
