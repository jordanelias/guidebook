...
| A.3 | Build language↔jurisdiction mapping table. Schema: `lang_jur_map(language, jurisdiction, role)` where role ∈ {PRIMARY, SECONDARY}. E.g., (EN, US, PRIMARY), (EN, UK, PRIMARY), (EN, IE, PRIMARY), (EN, CA, PRIMARY), (EN, AU, PRIMARY), (EN, NZ, PRIMARY), (EN, IN, SECONDARY), (EN, ZA, SECONDARY). | 4–6 hours | Mapping table covers all 19 langs × all 46 juris with role assigned |
