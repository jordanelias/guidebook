...
Distinct jurisdiction strings across the corpus: **50** — but **0 are language codes mis-filed in the jurisdiction column** ( = 0 instances; a data-integrity defect, see the note below), leaving **~50 true jurisdictions**. Top: INT (193), US (142), UK (90), DE (50), AU (45), CA (33), JP (30), NL (27), NO (26), IT (19).

**3 non-empty slices draw on ≤1 jurisdiction** — monojurisdictional bases whose values may not transfer across code regimes. Separately, **76 source-instances carry no jurisdiction at all** (NULL) — mostly clinical/synthesis sources with no single national home; these are excluded from every jurisdiction-share denominator.
...
| 2 | **A** | 83.4 | `cognitive-wayfinding-design` | wayfinding-and-signage | 25 | 7 | 17 | T1×1,T2×6,T3×10,T5×7,T6×1 | 13 | 9 | 64.0 | 8.0 | 20·18.8·20·15·9.6 |
...
| 5 | **A** | 82.2 | `residential-kitchen-and-task-surfaces` | kitchens-and-workspaces | 30 | 16 | 20 | T1×5,T2×11,T3×4,T4×2,T5×3,T6×5 | 10 | 7 | 80.0 | 46.2 | 20·21.7·20·15·5.5 |
...
| 14 | **B** | 76.2 | `assistive-listening-systems` | communication-and-alerts | 8 | 4 | 4 | T2×4,T4×1,T5×1,T6×2 | 5 | 5 | 50.0 | 0.0 | 16·20.0·17·12·11.2 |
| 15 | **B** | 75.7 | `multilingual-evidence-convergence-non-english` | frameworks-and-methodology | 8 | 3 | 5 | T1×2,T2×1,T3×3,T5×2 | 7 | 4 | 50.0 | 0.0 | 16·19.5·17·12·11.2 |
| 16 | **B** | 75.4 | `residential-entry-and-threshold` | entrances-and-circulation | 20 | 4 | 4 | T1×1,T2×3,T4×1,T5×6,T6×9 | 13 | 7 | 65.0 | 50.0 | 20·14.0·20·15·6.4 |
| 17 | **B** | 75.2 | `visual-impairment-built-environment` | population-general | 8 | 2 | 2 | T2×2,T4×2,T5×1,T6×3 | 7 | 6 | 25.0 | 12.5 | 16·15.0·17·15·12.2 |
| 18 | **B** | 75.0 | `threshold-door-hardware` | entrances-and-circulation | 32 | 1 | 2 | T1×1,T3×1,T4×1,T5×9,T6×20 | 26 | 13 | 46.9 | 31.2 | 20·10.9·20·15·9.1 |
...
| 26 | **B** | 67.8 | `post-occupancy-evaluation-global` | frameworks-and-methodology | 10 | 3 | 10 | T2×3,T3×7 | 8 | 2 | 90.0 | 40.0 | 16·21.6·20·5·5.2 |
...
| 28 | **C** | 64.0 | `deaf-acoustic-built-environment` | communication-and-alerts | 10 | 5 | 5 | T1×2,T2×3,T4×3,T5×2 | 5 | 2 | 90.0 | 30.0 | 16·20.0·17·5·6.0 |
...
| 32 | **C** | 59.0 | `school-environment-autism` | sensory-environment | 17 | 5 | 17 | T1×2,T2×3,T3×12 | 4 | 1 | 100.0 | 40.0 | 20·21.5·13·0·4.5 |
| 33 | **C** | 58.3 | `neurodivergent-built-environment` | population-general | 9 | 6 | 8 | T1×2,T2×4,T3×2,T4×1 | 4 | 1 | 100.0 | 44.4 | 16·25.1·13·0·4.2 |
| 34 | **C** | 58.3 | `upper-limb-impairment-built-environment` | population-general | 17 | 5 | 17 | T1×3,T2×2,T3×12 | 4 | 1 | 100.0 | 50.0 | 20·21.5·13·0·3.8 |
| 35 | **C** | 57.1 | `residential-accessible-home-case-studies` | frameworks-and-methodology | 8 | 6 | 8 | T1×4,T2×2,T3×2 | 4 | 1 | 100.0 | 85.7 | 16·27.0·13·0·1.1 |
| 36 | **C** | 56.8 | `thermal-comfort-older-adults-care-settings` | health-and-symptom-management | 6 | 2 | 4 | T2×2,T3×3,T5×1 | 4 | 2 | 83.3 | 16.7 | 12·19.3·13·5·7.5 |
| 37 | **C** | 56.5 | `air-quality-voc-chemical-sensitivity-built-environment` | sensory-environment | 12 | 1 | 7 | T2×1,T3×6,T4×4,T5×1 | 7 | 1 | 100.0 | 50.0 | 20·15.7·17·0·3.8 |
| 38 | **C** | 56.3 | `ot-cpg-built-environment` | population-general | 6 | 6 | 6 | T2×6 | 4 | 1 | 100.0 | 83.3 | 12·30·13·0·1.3 |
| 39 | **C** | 56.0 | `biophilic-design-healthcare-workplace` | sensory-environment | 6 | 4 | 6 | T1×1,T2×3,T3×2 | 3 | 1 | 100.0 | 33.3 | 12·26.0·13·0·5.0 |
| 40 | **C** | 55.7 | `sensory-relief-space-design` | sensory-environment | 10 | 4 | 8 | T1×1,T2×3,T3×4,T4×1,T6×1 | 6 | 1 | 100.0 | 80.0 | 16·21.2·17·0·1.5 |
| 41 | **C** | 55.3 | `fold-down-grab-bar-specification` | bathrooms-and-wet-areas | 8 | 1 | 2 | T1×1,T3×1,T4×2,T5×2,T6×2 | 5 | 2 | 87.5 | 62.5 | 16·13.5·17·5·3.8 |
| 42 | **C** | 55.2 | `visitability-residential-accessibility-minimum-standards` | frameworks-and-methodology | 7 | 1 | 1 | T1×1,T5×1,T6×5 | 5 | 3 | 71.4 | 71.4 | 12·12.9·17·9·4.3 |
| 43 | **C** | 55.1 | `acoustics-speech-intelligibility-disability` | sensory-environment | 8 | 3 | 5 | T1×1,T2×2,T3×2,T4×3 | 4 | 1 | 100.0 | 12.5 | 16·19.5·13·0·6.6 |
| 44 | **C** | 53.0 | `ms-thermal-temperature-conflict-resolution` | health-and-symptom-management | 10 | 2 | 7 | T1×1,T2×1,T3×5,T4×2,T5×1 | 4 | 1 | 100.0 | 20.0 | 16·18.0·13·0·6.0 |
| 45 | **C** | 53.0 | `ot-built-environment-interface` | frameworks-and-methodology | 16 | 2 | 14 | T1×1,T2×1,T3×14 | 3 | 1 | 100.0 | 80.0 | 20·18.5·13·0·1.5 |
| 46 | **C** | 52.9 | `ot-frameworks-built-environment` | frameworks-and-methodology | 4 | 4 | 4 | T1×4 | 3 | 1 | 100.0 | 75.0 | 8·30·13·0·1.9 |
...
| 50 | **D** | 49.3 | `detectable-gradient-protocol-sensory-zones` | wayfinding-and-signage | 6 | 2 | 4 | T1×1,T2×1,T3×2,T4×2 | 4 | 1 | 100.0 | 33.3 | 12·19.3·13·0·5.0 |
...
| 52 | **D** | 47.7 | `floor-vibration-wheelchair-disability` | entrances-and-circulation | 7 | 1 | 4 | T2×1,T3×3,T4×3 | 3 | 1 | 100.0 | 14.3 | 12·16.3·13·0·6.4 |
