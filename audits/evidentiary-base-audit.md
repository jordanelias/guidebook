...
- **Tier profile is code-and-clinical heavy, synthesis-light.** Of linked instances: T1=95, T2=114, T3=347, T4=86, T5=155, T6=151. Only **114 Tier-2 (systematic-review / evidence-based-standard) instances** exist across the whole corpus — the synthesis tier that best anchors best-practice claims is the thinnest.
- **Anchoring strength, banded.** Under the weighted-strength model (§8) every tier can anchor a best-practice claim, weighted by tier: **485/948 (51%)** of instances anchor at ● full strength (T1/Co-1/T2/Co-2/T3-clinical, adjudicated), 241 at ◐ partial (T4/T5 standards practice), 212 at ○ weak (T3-grey/T6/grey floor). **10 DISPUTED instances anchor at no band** (§4). By slice: **67 full · 12 partial · 0 weak-only** (of 79 evidenced). Every evidenced slice anchors at ● full or ◐ partial strength — none rests on a weak-only base.
- **Anglophone concentration is the dominant quality risk.** **716/948 (76%) of linked sources are English-language**; only 232 are non-English. By jurisdiction, 351 instances are native-Anglophone (US/UK/AU/CA/NZ/IE), 212 supranational (INT/EU/ISO), 309 other, 76 unrecorded.
...
**Slice = slug.** The 79 ACTIVE slugs are the unit of audit. Evidence is attributed through `source_slug_links`; each linked `evidence_sources` row is one *source-instance* (a source shared by two slices counts once in each). The 948 instances collapse to **754 unique sources** (reuse factor 1.26×; 136 sources span >1 slice, one — `REF-00050` — spans 6). Instance-weighting is deliberate — it measures per-slice coverage — but shared sources are re-counted, so corpus tier/language totals read ~26% above unique-source counts. (50 of the 804 rows in `evidence_sources` are linked to no active slug.)
...
**Strength-band split of instances:** **485/948 (51%)** anchor at ● full (T1/Co-1/T2/Co-2/T3-clinical), 241 (25%) at ◐ partial (T4/T5 standards), and 212 (22%) at ○ weak (T3-grey/T6/grey floor); a further 10 DISPUTED instances anchor at no band (§4). No evidenced slice rests on a ○ weak-only base — every slice anchors at ● full or ◐ partial strength (see the band breakdown in §4).

### (3) Jurisdictions sourced
Distinct jurisdiction strings across the corpus: **50**, none mis-filed as language codes in the `jurisdiction` column. Top: INT (199), US (148), UK (98), DE (50), AU (46), CA (34), JP (30), NL (27), NO (27), SE (20).
...
- **Jurisdiction axis (all 948 instances):** native-Anglophone (US/UK/AU/CA/NZ/IE) **351** · supranational/English-medium (INT/EU/ISO) **212** · English-official + other non-Anglophone **309** · **no jurisdiction recorded 76**. (These four sum to 948 = all instances.)
...
| 7 | **A** | 84.9 | `mobility-built-environment` | population-general | 24 | ● | 14 | 4 | 6 | 0 | T1×8,T2×2,T3×5,T5×4,T6×5 | 17 | 9 | 58.3 | 50.0 | 20·23.0·20·15·6.9 |
...
| 11 | **A** | 81.2 | `accessible-bathroom-and-grab-bar` | bathrooms-and-wet-areas | 22 | ● | 11 | 5 | 5 | 1 | T1×6,T2×4,T3×3,T4×1,T5×4,T6×4 | 12 | 7 | 72.7 | 68.4 | 20·21.8·20·15·4.4 |
...
| 38 | **B** | 65.8 | `air-quality-voc-chemical-sensitivity-built-environment` | sensory-environment | 12 | ● | 7 | 5 | 0 | 0 | T2×1,T3×6,T4×4,T5×1 | 7 | 1 | 100.0 | 50.0 | 20·25.0·17·0·3.8 |
| 39 | **B** | 65.5 | `upper-limb-impairment-built-environment` | population-general | 16 | ● | 15 | 0 | 1 | 0 | T1×1,T2×2,T3×13 | 4 | 1 | 100.0 | 50.0 | 20·28.8·13·0·3.8 |
...
| 41 | **C** | 62.2 | `ot-built-environment-interface` | frameworks-and-methodology | 15 | ● | 13 | 0 | 2 | 0 | T2×1,T3×14 | 3 | 1 | 100.0 | 75.0 | 20·27.3·13·0·1.9 |
| 42 | **C** | 62.2 | `thermal-comfort-older-adults-care-settings` | health-and-symptom-management | 6 | ● | 4 | 1 | 1 | 0 | T2×1,T3×4,T5×1 | 4 | 2 | 83.3 | 16.7 | 12·24.7·13·5·7.5 |
...
| 59 | **C** | 55.1 | `residential-accessible-home-case-studies` | frameworks-and-methodology | 8 | ● | 6 | 0 | 1 | 1 | T1×3,T2×1,T3×4 | 4 | 1 | 100.0 | 85.7 | 16·25.0·13·0·1.1 |
...
- **Instance-weighted, not source-weighted.** The 948 instances are 754 unique sources, so corpus tier/language totals run ~26% above unique-source counts. Per-slice figures are unaffected.
