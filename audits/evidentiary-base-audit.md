...
- **756 source-instances** are linked across **69 of 82 slices**; **13 slices carry zero linked evidence**.
- **Grade distribution:** A=6 · B=17 · C=20 · D=15 · E=11 · F=13  (A≥80, B≥65, C≥50, D≥35, E>0, F=empty).
- **Tier profile is code-and-clinical heavy, synthesis-light.** Of linked instances: T1=100, T2=80, T3=217, T4=76, T5=147, T6=136. Only **80 Tier-2 (systematic-review / evidence-based-standard) instances** exist across the whole corpus — the synthesis tier that best anchors best-practice claims is the thinnest.
- **Best-practice anchoring is thin.** Only **180/756 (24%)** of instances can *anchor* a best-practice claim (T1/Co-1/T2/Co-2, §3); a further 186 are confirmed-but-supporting T3-clinical (● §5). **18 slices have no anchor at all** (11 code-floor, 7 T3-clinical-only).
- **Anglophone concentration is the dominant quality risk.** **554/756 (73%) of linked sources are English-language**; only 202 are non-English. By jurisdiction, 295 instances are native-Anglophone (US/UK/AU/CA/NZ/IE), 195 supranational (INT/EU/ISO), 248 other, 18 unrecorded.
...
**Slice = slug.** The 82 ACTIVE slugs are the unit of audit. Evidence is attributed through `source_slug_links`; each linked `evidence_sources` row is one *source-instance* (a source shared by two slices counts once in each). The 756 instances collapse to **653 unique sources** (reuse factor 1.16×; 71 sources span >1 slice, one — `REF-00050` — spans 6). Instance-weighting is deliberate — it measures per-slice coverage — but shared sources are re-counted, so corpus tier/language totals read ~16% above unique-source counts. (24 of the 677 rows in `evidence_sources` are linked to no active slug.)
...
Median linked sources among non-empty slices: **8**. Largest bases: `accessibility-feature-market-value-uplift-framing` (33), `room-acoustic-performance` (32), `threshold-door-hardware` (32), `stair-ramp-threshold-biomechanics-accessibility` (27), `mental-health-built-environment` (25).
...
**Best-practice-anchor share: 180/756 (24%)** (T1/Co-1/T2/Co-2, §3). Adding confirmed-but-supporting T3-clinical brings *confirmed* evidence to 366/756 (48%). The remaining 390 are T4–T6 code/standards + T3-grey that carry no confirmed evidence. Slices with zero anchors are the sharpest risk — see the no-anchor list in §4.

### (3) Jurisdictions sourced
Distinct jurisdiction strings across the corpus: **46** — but **0 are language codes mis-filed in the jurisdiction column** ( = 0 instances; a data-integrity defect, see the note below), leaving **~46 true jurisdictions**. Top: INT (184), US (126), UK (84), AU (38), DE (35), CA (28), NL (25), NO (22), JP (21), SE (18).
...
- **Jurisdiction axis (all 756 instances):** native-Anglophone (US/UK/AU/CA/NZ/IE) **295** · supranational/English-medium (INT/EU/ISO) **195** · English-official + other non-Anglophone **248** · **no jurisdiction recorded 18**. (These four sum to 756 = all instances.)
...
| 9 | **B** | 79.0 | `stair-ramp-threshold-biomechanics-accessibility` | entrances-and-circulation | 27 | 1 | 14 | T2×1,T3×14,T4×1,T5×1,T6×10 | 15 | 12 | 59.3 | 14.8 | 20·14.6·20·15·9.4 |
| 10 | **B** | 78.2 | `residential-kitchen-and-task-surfaces` | kitchens-and-workspaces | 13 | 3 | 3 | T1×3,T4×2,T5×3,T6×5 | 10 | 8 | 38.5 | 46.2 | 20·14.6·20·15·8.6 |
| 11 | **B** | 77.3 | `wayfinding-global-south` | wayfinding-and-signage | 15 | 1 | 1 | T1×1,T4×4,T6×10 | 13 | 7 | 53.3 | 0.0 | 20·11.3·20·15·11.0 |
| 12 | **B** | 75.5 | `mental-health-built-environment` | population-general | 25 | 5 | 16 | T1×3,T2×2,T3×17,T4×1,T5×2 | 8 | 4 | 84.0 | 36.0 | 20·17.5·20·12·6.0 |
...
| 17 | **B** | 74.4 | `assistive-listening-systems` | communication-and-alerts | 8 | 4 | 4 | T2×4,T4×1,T5×1,T6×2 | 7 | 5 | 50.0 | 25.0 | 16·20.0·17·12·9.4 |
| 18 | **B** | 74.3 | `deafblind-built-environment-design` | population-general | 9 | 7 | 7 | T1×3,T2×4,T3×1,T6×1 | 5 | 3 | 66.7 | 44.4 | 16·25.6·17·9·6.7 |
| 19 | **B** | 70.9 | `dementia-built-environment` | population-general | 8 | 1 | 5 | T1×1,T3×4,T5×3 | 5 | 4 | 62.5 | 12.5 | 16·16.5·17·12·9.4 |
| 20 | **B** | 69.8 | `construction-cost-data` | economics | 10 | 6 | 8 | T1×2,T2×4,T3×2,T6×2 | 8 | 2 | 80.0 | 50.0 | 16·23.6·20·5·5.2 |
| 21 | **B** | 69.1 | `accessible-design-economics-cost-premium` | economics | 11 | 3 | 9 | T1×1,T2×2,T3×6,T6×2 | 7 | 3 | 72.7 | 30.0 | 16·19.8·17·9·7.3 |
| 22 | **B** | 68.6 | `pain-ofs-built-environment-design` | health-and-symptom-management | 12 | 5 | 5 | T1×2,T2×3,T3×3,T5×3,T6×1 | 6 | 3 | 83.3 | 60.0 | 20·18.3·17·9·4.3 |
...
| 25 | **C** | 62.3 | `upper-limb-impairment-built-environment` | population-general | 14 | 3 | 13 | T1×2,T2×1,T3×11 | 3 | 2 | 92.9 | 50.0 | 20·20.0·13·5·4.3 |
| 26 | **C** | 61.6 | `circadian-lighting-melanopic-edi` | sensory-environment | 12 | 2 | 7 | T2×2,T3×5,T4×2,T5×3 | 4 | 2 | 91.7 | 16.7 | 20·16.7·13·5·6.9 |
| 27 | **C** | 60.9 | `school-environment-autism` | sensory-environment | 17 | 4 | 16 | T1×2,T2×2,T3×13 | 3 | 1 | 100.0 | 0.0 | 20·20.4·13·0·7.5 |
| 28 | **C** | 60.7 | `deaf-acoustic-built-environment` | communication-and-alerts | 10 | 5 | 5 | T1×2,T2×3,T4×3,T5×2 | 4 | 2 | 90.0 | 20.0 | 16·20.0·13·5·6.7 |
| 29 | **C** | 60.6 | `neurological-built-environment` | population-general | 8 | 2 | 8 | T1×2,T3×6 | 5 | 1 | 100.0 | 12.5 | 16·21.0·17·0·6.6 |
| 30 | **C** | 57.1 | `residential-accessible-home-case-studies` | frameworks-and-methodology | 8 | 6 | 8 | T1×4,T2×2,T3×2 | 4 | 1 | 100.0 | 85.7 | 16·27.0·13·0·1.1 |
| 31 | **C** | 56.5 | `air-quality-voc-chemical-sensitivity-built-environment` | sensory-environment | 12 | 1 | 7 | T2×1,T3×6,T4×4,T5×1 | 7 | 1 | 100.0 | 50.0 | 20·15.7·17·0·3.8 |
| 32 | **C** | 56.3 | `manoeuvring-footprint-vs-turning-radius-methodology` | frameworks-and-methodology | 8 | 5 | 7 | T1×5,T3×2,T4×1 | 3 | 1 | 100.0 | 62.5 | 16·24.5·13·0·2.8 |
| 33 | **C** | 56.3 | `ot-cpg-built-environment` | population-general | 6 | 6 | 6 | T2×6 | 4 | 1 | 100.0 | 83.3 | 12·30·13·0·1.3 |
| 34 | **C** | 55.7 | `sensory-relief-space-design` | sensory-environment | 10 | 4 | 8 | T1×1,T2×3,T3×4,T4×1,T6×1 | 6 | 1 | 100.0 | 80.0 | 16·21.2·17·0·1.5 |
| 35 | **C** | 55.2 | `visitability-residential-accessibility-minimum-standards` | frameworks-and-methodology | 7 | 1 | 1 | T1×1,T5×1,T6×5 | 5 | 3 | 71.4 | 71.4 | 12·12.9·17·9·4.3 |
| 36 | **C** | 54.8 | `ot-frameworks-built-environment` | frameworks-and-methodology | 4 | 4 | 4 | T1×4 | 3 | 1 | 100.0 | 50.0 | 8·30·13·0·3.8 |
| 37 | **C** | 54.8 | `thermal-comfort-older-adults-care-settings` | health-and-symptom-management | 6 | 1 | 4 | T2×1,T3×4,T5×1 | 4 | 2 | 83.3 | 16.7 | 12·17.3·13·5·7.5 |
| 38 | **C** | 53.6 | `acoustics-speech-intelligibility-disability` | sensory-environment | 8 | 2 | 5 | T1×1,T2×1,T3×3,T4×3 | 4 | 1 | 100.0 | 12.5 | 16·18.0·13·0·6.6 |
| 39 | **C** ‡ | 52.5 | `luminance-contrast-and-pattern` | wayfinding-and-signage | 13 | 0 | 0 | T5×4,T6×9 | 13 | 13 | 0.0 | 0.0 | 20·0.0·10.0·7.5·15.0 |
| 40 | **C** | 51.8 | `ms-thermal-temperature-conflict-resolution` | health-and-symptom-management | 10 | 1 | 7 | T1×1,T3×6,T4×2,T5×1 | 4 | 1 | 100.0 | 20.0 | 16·16.8·13·0·6.0 |
| 41 | **C** | 50.5 | `ndv-aut-built-environment-quantified-thresholds` | population-general | 6 | 2 | 4 | T2×2,T3×3,T4×1 | 3 | 1 | 100.0 | 16.7 | 12·19.3·13·0·6.2 |
| 42 | **C** | 50.1 | `sensory-processing-model-design-application` | sensory-environment | 6 | 3 | 4 | T1×2,T2×1,T3×1,T4×1,T5×1 | 4 | 1 | 100.0 | 50.0 | 12·21.3·13·0·3.8 |
| 43 | **C** | 50.0 | `biophilic-design-healthcare-workplace` | sensory-environment | 6 | 1 | 6 | T1×1,T3×5 | 3 | 1 | 100.0 | 33.3 | 12·20.0·13·0·5.0 |
| 44 | **D** | 49.3 | `detectable-gradient-protocol-sensory-zones` | wayfinding-and-signage | 6 | 2 | 4 | T1×1,T2×1,T3×2,T4×2 | 3 | 1 | 100.0 | 33.3 | 12·19.3·13·0·5.0 |
| 45 | **D** | 48.9 | `design-framework-evidence-audit` | frameworks-and-methodology | 9 | 1 | 4 | T2×1,T3×5,T4×2,T5×1 | 4 | 1 | 100.0 | 33.3 | 16·14.9·13·0·5.0 |
| 46 | **D** | 48.6 | `ot-built-environment-interface` | frameworks-and-methodology | 5 | 1 | 2 | T1×1,T3×4 | 3 | 2 | 80.0 | 80.0 | 12·15.6·13·5·3.0 |
| 47 | **D** ‡ | 46.0 | `threshold-and-level-access` | entrances-and-circulation | 15 | 0 | 0 | T4×1,T5×4,T6×10 | 12 | 8 | 46.7 | 40.0 | 20·0.0·10.0·7.5·8.5 |
| 48 | **D** | 45.8 | `ofs-built-environment` | health-and-symptom-management | 7 | 3 | 4 | T1×3,T3×1,T5×2,T6×1 | 3 | 1 | 100.0 | 85.7 | 12·19.7·13·0·1.1 |
| 49 | **D** | 45.6 | `visual-fire-alarm-seizure-safety` | sensory-environment | 7 | 1 | 4 | T2×1,T3×3,T4×2,T6×1 | 3 | 1 | 100.0 | 42.9 | 12·16.3·13·0·4.3 |
| 50 | **D** † | 45.4 | `reach-range-and-accessible-controls` | controls-and-hardware | 11 | 0 | 1 | T3×1,T5×5,T6×5 | 6 | 3 | 81.8 | 81.8 | 16·0.7·17·9·2.7 |
...
- **Instance-weighted, not source-weighted.** The 756 instances are 653 unique sources, so corpus tier/language totals run ~16% above unique-source counts. Per-slice figures are unaffected.
