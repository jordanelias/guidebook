...
- **969 source-instances** are linked across **80 of 80 slices**; **0 slices carry zero linked evidence**.
- **Grade distribution:** A=11 · B=30 · C=25 · D=11 · E=3 · F=0  (A≥80, B≥65, C≥50, D≥35, E>0, F=empty).
- **Tier profile is code-and-clinical heavy, synthesis-light.** Of linked instances: T1=98, T2=109, T3=366, T4=82, T5=170, T6=144. Only **109 Tier-2 (systematic-review / evidence-based-standard) instances** exist across the whole corpus — the synthesis tier that best anchors best-practice claims is the thinnest.
- **Anchoring strength, banded.** Under the weighted-strength model (§8) every tier can anchor a best-practice claim, weighted by tier: **500/969 (52%)** of instances anchor at ● full strength (T1/Co-1/T2/Co-2/T3-clinical, adjudicated), 252 at ◐ partial (T4/T5 standards practice), 207 at ○ weak (T3-grey/T6/grey floor). **10 DISPUTED instances anchor at no band** (§4). By slice: **69 full · 11 partial · 0 weak-only** (of 80 evidenced). Every evidenced slice anchors at ● full or ◐ partial strength — none rests on a weak-only base.
- **Anglophone concentration is the dominant quality risk.** **721/969 (74%) of linked sources are English-language**; only 248 are non-English. By jurisdiction, 366 instances are native-Anglophone (US/UK/AU/CA/NZ/IE), 206 supranational (INT/EU/ISO), 313 other, 84 unrecorded.
...
**Slice = slug.** The 80 ACTIVE slugs are the unit of audit. Evidence is attributed through `source_slug_links`; each linked `evidence_sources` row is one *source-instance* (a source shared by two slices counts once in each). The 969 instances collapse to **760 unique sources** (reuse factor 1.27×; 140 sources span >1 slice, one — `REF-00323` — spans 7). Instance-weighting is deliberate — it measures per-slice coverage — but shared sources are re-counted, so corpus tier/language totals read ~28% above unique-source counts. (65 of the 825 rows in `evidence_sources` are linked to no active slug.)
...
**Strength-band split of instances:** **500/969 (52%)** anchor at ● full (T1/Co-1/T2/Co-2/T3-clinical), 252 (26%) at ◐ partial (T4/T5 standards), and 207 (21%) at ○ weak (T3-grey/T6/grey floor); a further 10 DISPUTED instances anchor at no band (§4). No evidenced slice rests on a ○ weak-only base — every slice anchors at ● full or ◐ partial strength (see the band breakdown in §4).

### (3) Jurisdictions sourced
Distinct jurisdiction strings across the corpus: **53**, none mis-filed as language codes in the `jurisdiction` column. Top: INT (193), US (153), UK (101), DE (50), AU (47), CA (39), JP (30), NL (27), NO (27), SE (20).
...
- **Jurisdiction axis (all 969 instances):** native-Anglophone (US/UK/AU/CA/NZ/IE) **366** · supranational/English-medium (INT/EU/ISO) **206** · English-official + other non-Anglophone **313** · **no jurisdiction recorded 84**. (These four sum to 969 = all instances.)
...
| 55 | **C** | 55.7 | `ndv-aut-built-environment-quantified-thresholds` | population-general | 6 | ● | 4 | 1 | 1 | 0 | T2×1,T3×4,T4×1 | 3 | 1 | 100.0 | 20.0 | 12·24.7·13·0·6.0 |
| 56 | **C** | 55.5 | `detectable-gradient-protocol-sensory-zones` | wayfinding-and-signage | 6 | ● | 4 | 2 | 0 | 0 | T2×1,T3×3,T4×2 | 3 | 1 | 100.0 | 40.0 | 12·26.0·13·0·4.5 |
...
| 65 | **C** | 52.3 | `intellectual-disability-built-environment-design` | population-general | 5 | ● | 2 | 3 | 0 | 0 | T3×2,T4×3 | 3 | 1 | 100.0 | 40.0 | 12·22.8·13·0·4.5 |
| 66 | **C** | 51.0 | `luminance-contrast-lrv-evidence-base` | wayfinding-and-signage | 7 | ● | 3 | 2 | 2 | 0 | T3×4,T5×2,T6×1 | 5 | 1 | 100.0 | 85.7 | 12·20.9·17·0·1.1 |
| 67 | **D** | 49.8 | `ofs-built-environment` | health-and-symptom-management | 7 | ● | 4 | 2 | 1 | 0 | T1×3,T3×1,T5×2,T6×1 | 3 | 1 | 100.0 | 85.7 | 12·23.7·13·0·1.1 |
| 68 | **D** | 49.0 | `bariatric-turning-radius-built-environment` | seating-and-rest | 8 | ● | 2 | 5 | 1 | 0 | T3×3,T4×2,T5×3 | 4 | 1 | 100.0 | 100.0 | 16·20.0·13·0·0.0 |
| 69 | **D** | 48.0 | `cross-population-conflict-resolutions` | frameworks-and-methodology | 6 | ● | 2 | 4 | 0 | 0 | T3×2,T4×3,T5×1 | 2 | 1 | 100.0 | 33.3 | 12·22.0·9·0·5.0 |
| 70 | **D** | 47.6 | `ot-cpg-built-environment` | population-general | 6 | ● | 3 | 1 | 0 | 2 | T2×5,T5×1 | 4 | 1 | 100.0 | 83.3 | 12·21.3·13·0·1.3 |
...
- **Instance-weighted, not source-weighted.** The 969 instances are 760 unique sources, so corpus tier/language totals run ~28% above unique-source counts. Per-slice figures are unaffected.
