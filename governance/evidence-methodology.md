...
- **Population scale** is where source-ranking does its substantive work. The evidence hierarchy adjudicates the best-practice value and range here: Tier 1 / Co-1 / Tier 2 / Co-2 evidence anchors the claim at full strength; Tier 3 supports; Tier 4–6 anchor only at weak (○) weighted strength, rendered as flagged "best practice as currently known" (convergence-not-evidence retained as the weak-band honesty rule; amended 2026-07-21, Option A — `decisions/DR-2026-07-21-evidence-architecture-option-a-execution.md`; §3 here and `governance/tier-system.md` §8).
...
| `single_axis` (Tier 4–6 only) | §8.1 Universal Mode construction | "Code requires [value] per [standard]." or "[N] jurisdictions' standards converge on [value] — best practice as currently known, at weak (○) code-derived strength only: convergence is not evidence; no anchoring (T1/Co-1/T2/Co-2) basis exists" (mandatory flag + caveat per G1b and amended invariant I3, 2026-07-21 Option A; never unflagged, never above the register map's weak-band row) |
