...
|---|---|---|---|
| `stated`, T1+Co-1, converge | "Best practice: X [●]. Clinical and lived-experience evidence converge." | "Evidence-based best practice X exceeds the code floor Y; convergent clinical + lived-experience basis." | "Research and disabled people's own experience both support X." |
...
| New-doctrine items | G1 (re-graining + `regulatory_stratum_only` + scale-tagging), G2 (NOT_ASSESSED), G3 (Co-1 grain by source type), G4 (asymmetry principle, declarative), G5 (advocacy-brief use-pattern), G6 (grain from type × tier), register map + invariants I1–I5, vocabulary normalization |
