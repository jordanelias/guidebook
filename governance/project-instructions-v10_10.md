...
**V10.10 · Revised 2026-05-13**
Supersedes V10.9. Architecture: `architecture/project-architecture-guidebook-v2.3.md`. Preferences: `userPreferences-v6.1.md`.
...
- `reasoning-doc-citations` — invoked per standing rule #10 sub-rules 2/3 during Phase E.1. File to be authored.
...
10. **Evidence verification gate for synthesis.** Per DR-2026-05-13. No BPC synthesis claim may cite a source with `metadata_quality = AUTHOR-TITLE-ONLY` or `verification_status = NULL`. Required minimum: `metadata_quality = COMPLETE` AND `verification_status ∈ {VERIFIED, UNVERIFIED-1}`. Sources with `verification_status ∈ {UNVERIFIED-CLOSED, CLOSED-DELETED}` excluded.
