...
**B – Terminology:** flag deprecated terms ("wheelchair-bound", "suffers from", "special needs") · acronym first-use · person-first vs. identity-first inconsistency (flag; do not auto-correct) → `references/terminology.md`
