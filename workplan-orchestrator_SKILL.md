...
List the `sessions/` directory:
```
GET https://api.github.com/repos/jordanelias/guidebook/contents/sessions
```
Sort the returned array by `name` descending. GET the first result (most recent file, e.g. `sessions/session_2026-03-18-1530.md`).
...
- **Directory empty or does not exist:** "No prior session. Starting fresh."
