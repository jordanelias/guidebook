...
t_topics.textContent=T.topics;t_src.textContent=T.sources;t_sext.textContent=T.extractions_source;
t_ext.textContent=T.extractions_synthesis;t_walk.textContent=T.walks;sv.textContent=T.schema_version;oi.textContent=T.orphan_links;
