...
jurisdiction_coverage:
  ...
  ISO: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "ISO 23599:2019 TWSIs — international standard for tactile walking surface indicators."}
  ...
  JP: {status: THIN, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "JIS T 9251 tactile tiles — Japan originated TWSIs (Seiichi Miyake, 1965)."}
