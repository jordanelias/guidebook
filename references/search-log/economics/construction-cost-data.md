...
query: "construction cost accessible design premium percentage retrofit new build"
...
jurisdiction_summary: >
  Construction cost data varies by jurisdiction and market. Key divergence: AU NCC 2022 Livable Housing RIS estimated <1% cost premium for new build. UK DCLG estimated 0.5-1.6%. No code mandates cost analysis. Cross-reference Part 11.
```
