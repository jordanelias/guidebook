# Search Log — visual-fire-alarm-seizure-safety

```yaml
slug: visual-fire-alarm-seizure-safety
query: "visual fire alarm strobe seizure photosensitive epilepsy flash frequency deaf notification"
...
jurisdiction_coverage:
  ...
  UK: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "BS 5839-1 fire detection/alarm. BS 8300 references visual alerting. EN 54-23 visual alarm devices — flash rate ≤2 Hz."}
  AU: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "AS 1670 fire detection. NCC references visual alerting for DEAF."}
  CA: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "CAN/ULC-S524 for visual notification. NBC references."}
  DE: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "DIN VDE 0833-2 fire alarm systems. DIN 18040 Two-Senses principle."}
  ...
  ISO: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "EN 54-23:2010 Visual alarm devices — specifies categories (W, C, O), coverage area, flash characteristics. ISO 7240 series fire detection and alarm. ISO 21542 references visual alerting."}
  EU: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "EN 54-23 visual alarm. EN 17210 recommends multi-sensory alerting."}
...
jurisdiction_summary: >
  US ADA + NFPA 72 most prescriptive (≤2 Hz flash rate). EN 54-23 European standard
