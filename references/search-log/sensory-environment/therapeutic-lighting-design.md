# Search Log — therapeutic-lighting-design

```yaml
slug: therapeutic-lighting-design
query: "therapeutic lighting dementia care Alzheimer circadian elderly care home lighting design"
last_searched: 2026-04-23 09:30
early_close_triggered: false

languages:
  EN: {status: SEARCHED, results: 8, db: [PubMed, web], co1_pass: not-run, native_standards_pass: complete}
  DE: {status: SEARCHED, results: 2, db: [web, DIN], co1_pass: not-run, native_standards_pass: complete, note: "DIN/TS 67600 covers care homes explicitly"}
...
jurisdiction_coverage:
  US: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "No code requirement. WELL v2 Feature L03. FGI Guidelines for Design and Construction of Hospitals (healthcare-specific). Alzheimer's Association design recommendations."}
  UK: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "No code requirement. BREEAM Hea 01 references daylighting. Dementia Design Centre guidance (Stirling). King's Fund Healing Environment."}
  AU: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No NCC requirement. Dementia-specific design guides from HammondCare."}
  DE: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "DIN/TS 67600:2022 explicitly covers 'homes for the elderly and nursing homes'. Recommends ≥250 MEDI daytime for care settings with extended guidelines for older adults' reduced crystalline lens transmittance."}
  ISO: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "CIE S 026. ISO/CIE TR 21783:2022. No ISO 21542 therapeutic lighting requirement."}
  EU: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No EN 17210 therapeutic lighting requirement."}
...
jurisdiction_summary: >
  ...
  explicitly covers care homes with melanopic recommendations adjusted for older adults.
  Evidence is primarily clinical/research (Tier 3) rather than standards-based.
  Cross-reference circadian-lighting-melanopic-edi for metric details.
```
