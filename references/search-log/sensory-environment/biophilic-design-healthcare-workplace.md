...
jurisdiction_coverage:
  US: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "No code. WELL Biophilia concept. LEED v4 biophilic credits."}
  UK: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "No code. BREEAM Hea 02 references views of nature."}
...
jurisdiction_summary: >
  NO building code mandates biophilic design. Voluntary: WELL, LEED, BREEAM. Evidence is Tier 3 (Ulrich 1984 view of nature recovery; Kellert 2005 framework). Guidebook Appendix B (BIO-01 to BIO-05).
