...
jurisdiction_coverage:
  ...
  UK: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "PAS 6463:2022 — references sensory processing in built environment design."}
...
jurisdiction_summary: >
  NO building code addresses sensory processing models. UK PAS 6463 is the closest reference. Evidence is clinical/OT (Dunn's Sensory Processing Framework). NDV/AUT population-specific.
