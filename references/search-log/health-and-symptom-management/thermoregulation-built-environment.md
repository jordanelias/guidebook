...
query: "thermoregulation thermal comfort disability MS multiple sclerosis temperature sensitivity built environment"
last_searched: 2026-04-23 10:45
early_close_triggered: false

languages:
  EN: {status: SEARCHED, results: 10, db: [PubMed, web, ASHRAE, WELL], co1_pass: not-run, native_standards_pass: complete}
...
jurisdiction_coverage:
  US: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "ASHRAE Standard 55-2023: thermal comfort conditions for human occupancy. WELL Thermal Comfort features. No ADA thermal requirement. FGI Guidelines reference thermal zones in healthcare."}
  UK: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "CIBSE Guide A: environmental design. BS EN 16798-1 adopted. Care Quality Commission standards for care homes include thermal comfort. No BS 8300 thermal requirement."}
  AU: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "NCC Section J energy efficiency includes thermal comfort. AS/NZS ISO 7730 adopted."}
  CA: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: false}
  DE: {status: THIN, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "DIN EN 16798-1 adopted. ASR A3.5 workplace temperature requirements (mandatory). DIN 4108 thermal protection."}
  NO: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "TEK17 thermal provisions. NS-EN 16798-1 adopted."}
  SE: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: false}
  ISO: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "ISO 7730:2005 moderate thermal environments. ISO 17772-1:2017 indoor environmental input parameters. EN 16798-1:2019 European adoption."}
  EU: {status: SEARCHED, co1_attempted: false, tier5_attempted: true, tier6_attempted: true, note: "EN 16798-1:2019 energy performance of buildings — indoor environmental input parameters. Replaces EN 15251. Four comfort categories (I-IV). EN 17210 does not address thermal comfort."}
  ...
  SG: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: false, note: "SS 554:2009 thermal comfort. Tropical climate-specific."}
...
jurisdiction_summary: >
  Thermal comfort is governed by ASHRAE 55 (US), EN 16798-1 (EU/UK), ISO 7730 (INT) — but NONE
  address disability-specific thermoregulation needs. MS heat sensitivity, OFS temperature
  intolerance, PAIN cold sensitivity — all require individual thermal zoning beyond what any
  standard prescribes. Key gap: no code provides for individual thermal control as an accessibility
  provision. Cross-reference F-07 (thermal zoning) and F-08 (thermal transition) items.
  WELL Thermal Comfort features are closest to addressing individual needs (voluntary).
```
