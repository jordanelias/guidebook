...
| Axis | Target | Completed (pass 1) |
|---|---|---|
| Language | 14 | EN only |
| Jurisdictions | 48 | US, UK, CA, AU, NZ, KR partial (EN-language sources) — remainder NOT-RUN |

**Accepted blockers (pass 1):** non-EN strata (ZH/JA/KO/ES/PT/DE/FR/…) NOT RUN — deferred to pass 2; full source verification (DOI resolution, page-level quant extraction) pending — all sources at `UNVERIFIED-1`; quantified specifications therefore deferred to synthesis after verification.

## Sources Confirmed (this slug)
...
Surfaced by the broad query but not this slug's scope; captured and re-homed rather than discarded:

| REF-ID | Source | Design/environmental content | Re-homed to |
|---|---|---|---|
...
- *Multiple Sclerosis* 2015 (NP9-NP11) — published *erratum* (table correction), not substantive data. Not logged.
