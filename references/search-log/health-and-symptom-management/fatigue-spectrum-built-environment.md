# Search Log — fatigue-spectrum-built-environment

```yaml
slug: fatigue-spectrum-built-environment
query: "ME CFS POTS MCAS fatigue orthostatic intolerance built environment design thermal sensitivity fatigue accessibility"
last_searched: 2026-04-23 09:30
early_close_triggered: false

languages:
  EN: {status: SEARCHED, results: 4, db: [PubMed, web], co1_pass: not-run, native_standards_pass: complete}
...
jurisdiction_coverage:
  US: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No ADA or code provisions specific to fatigue spectrum (ME/CFS, POTS, MCAS) built environment. WELL thermal comfort features indirectly relevant."}
  UK: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No BS 8300 or Part M provisions specific to fatigue spectrum (ME/CFS, POTS, MCAS)."}
  AU: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No NCC provisions specific to fatigue spectrum (ME/CFS, POTS, MCAS)."}
  ...
  ISO: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "ISO 21542 does not address fatigue spectrum (ME/CFS, POTS, MCAS) specifically."}
  EU: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "EN 17210 does not address fatigue spectrum (ME/CFS, POTS, MCAS) specifically."}
...
jurisdiction_summary: >
  NO building code anywhere addresses fatigue spectrum (ME/CFS, POTS, MCAS) built environment specifically.
  OFS provisions are derived from OT clinical evidence (Tier 1-3) and co-design,
  not from statutory codes. Built environment implications (thermal control, rest seating,
  vibration isolation, adjustable workstations) are proxied through general accessibility
  provisions and WELL/ASHRAE thermal comfort standards.
  THIN BASE — primary evidence is clinical, not regulatory.
```
