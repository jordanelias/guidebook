# Search Log — chronic-pain-built-environment

```yaml
slug: chronic-pain-built-environment
query: "chronic pain fibromyalgia built environment design thermal sensitivity fatigue accessibility"
...
jurisdiction_coverage:
  US: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No ADA or code provisions specific to chronic pain built environment. WELL thermal comfort features indirectly relevant."}
  UK: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No BS 8300 or Part M provisions specific to chronic pain."}
  AU: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "No NCC provisions specific to chronic pain."}
  ...
  ISO: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "ISO 21542 does not address chronic pain specifically."}
  EU: {status: NO-DATA, co1_attempted: false, tier5_attempted: false, tier6_attempted: true, note: "EN 17210 does not address chronic pain specifically."}
...
jurisdiction_summary: >
  NO building code anywhere addresses chronic pain built environment specifically.
  PAIN provisions are derived from OT clinical evidence (Tier 1-3) and co-design,
