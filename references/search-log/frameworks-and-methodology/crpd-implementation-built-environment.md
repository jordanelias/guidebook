...
query: "CRPD Convention Rights Persons Disabilities built environment implementation Article 9 19"
...
jurisdiction_summary: >
  CRPD is ratified by 191 states. Implementation varies by jurisdiction. General Comment No. 2 (2014) on Article 9 (Accessibility) is foundational. No building code directly implements CRPD — national accessibility codes are the implementation mechanism. Cross-reference jurisdiction-matrix-accessibility-standards BPC.
```
