...
query: "housing accessibility disability Global South developing countries lived experience"
...
jurisdiction_summary: >
  Co-1 evidence from Global South is emerging. Key: CBM (INT), Leonard Cheshire (INT), WHO GATE programme. Limited building code data — most P4/P5 jurisdictions have THIN or NO-DATA accessibility codes. Cross-reference co1-housing-research-global-south BPC.
```
