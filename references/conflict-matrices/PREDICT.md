...
|---|---|---|
| NDV/AUT, DEM: fixed layout, no reconfiguration | MOB: flexible, reconfigurable for equipment access | Tension |
...
- references/bpc/mobility-built-environment.md (topic TBD)
