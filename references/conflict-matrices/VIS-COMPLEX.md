...
**Parameter:** Signage density, pattern complexity
...
|---|---|---|
| DEM, IntD: high redundancy, pictograms, colour coding | NDV/SENS: minimal visual clutter, muted palette | Direct |

### Primary evidence slugs
- references/bpc/cognitive-wayfinding-design.md (topic TBD)
- references/bpc/dementia-built-environment.md (topic TBD)
- references/bpc/neurodivergent-built-environment.md (topic TBD)
- references/bpc/intellectual-disability-built-environment-design.md (topic TBD)
