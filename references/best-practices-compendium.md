...
**Conflict resolution:** Where space constraints prevent 1800 mm, prioritise 1700 mm (RHFAC/CSA B651-23) over 1524 mm ADA minimum. Document as design compromise; flag for DAR assessment at Tier 2.
...
| 1700 mm recommended for power WC and scooter | EN (CA, UK) | CA/RHFAC, UK/BS8300 | Tier 5 |
| 1800 mm for large power WC / healthcare settings | EN (US) | US/VA, US/PVA | Tier 5/Co-1 |
| Ramp gradient 1:20 ideal; 1:12 code minimum | EN, DE, FR, NL, NO, ES, PT, IT | US, UK, CA, DE, FR, NL, NO, ES, PT, IT, CH | Tier 5–6 |
| Door clear opening: 900 mm best practice; 850 mm minimum | EN, DE, NL | CA/CSA, UK/BS8300, DE/DIN18040 | Tier 5–6 |
| SV BFS 2024:12 in force July 2025; transition to June 2026 | SV | SE | Tier 6 |
| SG BCA Code 2025 (effective Nov 2025): new anthropometric data for power WC added | EN | SG | Tier 6 |
| JA MLIT 2025 upgrade: toilet turning circle 180 cm for large power WC in ≥2000m² buildings | JA | JP | Tier 6 |
| DPI Japan 2024: first residential WC design handbook in Japan | JA | JP | Co-1/Tier 5 |
| NEN 9120:2025 (NL) now free to download; aligns with EN 17210:2021 | NL | NL, EU | Tier 5–6 |
| KR 2024 revision: shift from "route access" to "daily life access" | KO | KR | Tier 6 |
| BR NBR 9050:2020: M.R. (800×1200 mm) reference module; 1500 mm 360° circle | PT | BR | Tier 6 |
...
| IT DM 236/89 three-tier framework vs. binary access/no-access approach | IT: graduated accessibility/visitability/adaptability | Most other jurisdictions: binary | Design philosophy divergence; IT three-tier arguably more inclusive |
| DK SBi-230 three quality levels (A/B/C) | DK: B-level explicitly better practice for WC | Other jurisdictions: single minimum | DK has most explicit beyond-code pathway for WC |
| KR: shift to "daily life access" (2024) | KR 2024 | All prior codes | KR reform is most advanced framing shift in this review cycle |

### NO-DATA / THIN
| Jurisdiction | Language | Reason | Co-1 attempted? | Tier 5 attempted? |
|---|---|---|---|---|
| ES | ES | THIN — 2 sources only; CERMI and CTE/SUA retrieved but no OT-specific research found | Yes | Yes |
| KR Co-1 | KO | 한국장애인단체총연합회 not directly retrieved | No | No |
| BR Co-1 | PT | FENASP/ABRADEF not directly retrieved | No | No |
| PT Co-1 | PT | INR Tier 5 guide confirmed but not Co-1 | No | No |
| IT Co-1 | IT | FISH/ANFFAS not directly retrieved; ENS focused on sensory not motor | No | No |

### Citation mining
| Source | Direction | New sources added |
|---|---|---|
| Steinfeld et al. 2010 (IDeA Center) | Backward | Ringaert et al. 2001 (CA); Bails 1983 (AU) |
| IDeA Center DR#21 | Forward | D'Souza & Bharathy 2018 |
| Summer Foundation/Winkler 2024 | Forward | Morgan et al. 2024 (innovation scan) |
...
**Key evidence:**
  ...
  - Standard PMV/PPD tools unreliable for cognitively impaired older adults — subjective feedback cannot be elicited reliably (van Hoof et al. 2010, Tier 3)
  - Japan heat shock: 6,073 bathtub drowning deaths (MHLW 2023) — root cause is 5–15°C differential between unheated bathrooms and heated living areas; inter-room differential ≤5–7°C recommended (Nakayama 1981 via Japan CAA)
  - MS populations: 60–80% heat-sensitive; ambient temperature target ≤19–21°C with personalised HVAC control
  - OFS/MCAS/POTS populations: cool ambient environment (≤19–21°C) is primary built-environment requirement; zero built-environment standard addresses this
**Range:** Older adult care: 24.9°C neutral; 18.3–26.3°C comfort zone · MS/OFS: ≤19–21°C preferred · Inter-room differential: ≤5–7°C
**Jurisdictions confirmed:** Temperature targets absent from all building codes and standards across all 14 searched languages. H-04 (HVAC/Thermal) in all jurisdictions addresses acoustic NC levels, not temperature ranges for disability populations. Confirmed universal gap.
**Early-close:** No  **Thin/No-data:** JA (standards-based only, no peer-reviewed OT evidence), ZH (no indexed evidence)
...
**Design implications:**
  ...
  - Reduce cognitive map demands — no orientation-dependent layout
  - Short articulated corridors — avoid long featureless corridors
  - Visual access between spaces — occupants see destination before committing to route
...
**Load ratings:**
  ...
  - WHO Assistive Products Specification: 110 kg (242 lbs) in three directions — horizontal, vertical up, vertical down (WHO APS-15:2022)
  - Standard fold-down bars (guidebook): ≥200 kg safe working load recommended (exceeds ADA minimum)
  - Bariatric facilities: dedicated bariatric grab bars ≥300 kg rated (separate BAR item)
**Positioning:**
  - Height: 33–36 inches (840–915 mm) AFF — top of gripping surface (ADA)
  - Centrepoint to toilet CL: 400 mm / 15¾ in. (Fair Housing Act Design Manual)
  - Full-length blocking required to allow bilateral positioning on either side
**Structural requirements:**
  - Structural wall backing / noggins required at all fold-down bar positions
  - Blocking must span full length behind toilet (FHA Chapter 6)
  - Advance planning required: positioning must be resolved at structural/DD stage
**Jurisdictions confirmed:** US (ADA S604; FHA Design Manual) · UK (BS 8300:2018 — specific clauses PROVISIONAL) · Norway (NS 11001-2:2018 cited at §1522)
**Early-close:** No  **Thin/No-data:** DE, FI, ZH, JA, NL, ES, PT, KO, IT — no fold-down bar–specific specifications retrieved
...
**Key facts by jurisdiction:**
  ...
  - EN 17210:2021: EAA optional for EU member states; Ireland and others did not adopt built environment provisions — patchwork adoption; revised harmonised standards due September 2025
  - Australia NCC 2022: mandatory Class 1a+2; Livable Housing Design requirements; most states effective 2023–24
  - Brazil NBR 9050:2020+Errata: mandatory for common areas; individual units NOT mandated — confirmed policy gap
  - Canada CSA B651/B652:2023: voluntary federal; updated anthropometrics; luminance contrast guidance
  - Germany DIN 18040-1/2:2023 drafts: revision impasse (570+380 objections); new editions expected summer/autumn 2025
  - India MoHUA 2021 + RPwD Amendment 2023: mandatory all public buildings
  - Japan Barrier-Free Act 2006/2020: scale-based (≥2,000 m²); 2020 revision added soft measures
  - Norway TEK17/NS 11001-1:2018: mandatory (TEK17); step-free ≤1:15; 1800 mm width
  - Singapore BCA Code 2025: supersedes 2019; anthropometric data section added; elder-friendly enhanced
  - Sweden BBR July 2025: new regulations in force; EN 81-70 for almost every lift
  - Switzerland SIA 500/BehiG: mandatory (BehiG); 5%/20% cost proportionality rule
  - UK BS 8300-1/2:2018: best practice only (not statutory); Changing Places mandatory since 2021
  - USA ANSI A117.1-2017: 1702 mm turning for powered chairs; voluntary but widely adopted
**Not yet searched:** Belgium · Israel · Netherlands · New Zealand · Portugal · South Korea · Spain · UAE
**Early-close:** No  **Thin/No-data:** Jurisdictions listed above not yet searched
**Key sources:** ISO21542:2021 · EN17210:2021 · NCC2022 · NBR9050:2020 · CSAB651:2023 · DIN18040-drafts2023 · MoHUA2021 · BFA2020 · TEK17 · BCACOA2025 · BBR2025 · SIA500 · BS8300:2018 · ANSIA117-1:2017
**Divergent findings:**
  - Turning radius: ISO 1524 mm vs. ANSI A117.1-2017 1702 mm (powered chairs) vs. CSA B651:23 2100 mm (U-turn)
...
**Construction cost premium by building type (new build):**
  ...
  - Switzerland: findings consistent with German and Belgian evidence (Swiss Federal Office)
**Retrofit multiplier vs. design-stage cost (direction unambiguous across jurisdictions):**
  - Lift/elevator shaft omission: 20–40× (decision-stage: Brief — not retrofittable)
  - Toilet visibility from living space: Not retrofittable (structural — Schematic)
  - Grab bar blocking in walls: 4–8× (Construction — ~$50 materials at build)
  - Zero-threshold shower (floor recess): 5–12× (Technical Design)
  - Accessible WC turning circle: 6–15× (Schematic)
  - Level entry / no-step threshold: 8–15× (Brief — zero NC premium)
  - Corridor width ≥1200 mm: 4–10× (Schematic — 0–0.3% NC premium)
  - Acoustic zoning (plan layout): 3–8× (Schematic — zero NC premium)
  - Loop floor plan (dementia): 8–20× (Brief — zero NC premium)
  - Changing Places facility: 15–30× (Brief — 0.8–1.5% NC premium)
  - Post-occupancy retrofit (summary): 10–40× brief-stage equivalent
**Cost curve by decision stage:**
  - Brief/pre-design: 0–4% of project cost (many provisions: 0%)
  - Schematic design: 0–8%
  - Technical design: 1–15%
...
**CHD — Children (age-staged):**
  ...
  - Sources: WHO Child Growth Standards; CDC/NCHS NHANES 2015–2018 (McDowell et al. 2021)
  - Key item: child-height handrail secondary rail required (500–600 mm); standard 865–965 mm rail unreachable for CHD/INF and CHD/PRE
  - Five primary building typologies: paediatric healthcare, primary/secondary school, childcare, indoor recreational facility, children's library
  - Zero dedicated children's accessibility standards identified in any jurisdiction
**LPA — Short stature/dwarfism:**
  - Most common condition: achondroplasia — adult standing height 122–134 cm (female 122 cm median, male 130 cm median) (Hoover-Fong et al. 2021, CLARITY study, n=1,374, Tier 3)
  - 5th percentile female: ~110 cm — this is the LPA design baseline for reach and height specifications
  - Arm span ~110–122 cm; max comfortable forward reach ~700–850 mm
  - Entirely absent from all international standards including ADA, BS 8300, ISO 21542, DIN 18040
  - Critical conflicts: standard accessible WC (designed for wheelchair user) is inaccessible to ambulant LPA user — grab bars at wrong height, raised seats compound difficulty
  - Reception counters: LPA users may be invisible below standard counter height — complete communication barrier
  - Controls, ATMs, service points systematically above comfortable reach
  - Sources: Hoover-Fong2021-CLARITY · Tofts2017 · Merker2018 · LPA-UK-RGA · AUCD-Language2024
**EXH — Extreme height (≥200 cm or acromegaly/gigantism):**
  - All standard door heights (2000–2100 mm) create hazard — minimum 2400 mm clear height required
  - Standard accessible WC grab bars at 840–915 mm are too low for seated-height clearance
  - No international standard addresses EXH provisions — entirely first-principles derivation
  - Primary failure points: door clearance, ceiling height, seated-counter eye level, reach zones inverted
**BAR — Large body size (not a disability; design quality provision):**
  - Large body size is NOT classified as a disability under ADA, Equality Act 2010, CRPD, or any reviewed jurisdiction
  - Key specifications: door ≥950–1000 mm clear; corridor ≥1500–1800 mm in BAR areas; turning circle ≥1800 mm (new build: ≥1900 mm, per Steinfeld 2006); seating ≥250–300 kg rated; WC 1800×2200 mm; structural floor review for 300 kg point loading (SE sign-off required); grab bar noggins in all bathroom walls
  - Dignity principle: no segregated bariatric-only areas — integrated provision required
  - Seating: ≥10% armrest-free in public buildings; ≥300 kg rated clinical; ≥250 kg rated public
  - Healthcare: 15–20% higher air exchange rate recommended; overhead lift track structural provision
  - Residential adaptable standards (Lifetime Homes, CSA B652, NS 11001-2) do not address BAR — gap confirmed across all jurisdictions
**Jurisdictions confirmed:** No jurisdiction has dedicated standards for CHD, LPA, EXH, or BAR built environments. BAR provisions in healthcare settings: US FGI Guidelines, VA BFDS 2025, NHS HBN 00-03 are the strongest available sources.
...
**Key specifications (F-04 item):**
  ...
  - Fresh air supply: ≥10 L/s per person general; ≥15 L/s per person where OFS/MCAS or immunocompromised users are primary
  - VOC: all finishes, adhesives, sealants, flooring, ceiling, furniture in OFS spaces: TVOC ≤0.5 mg/m³ at 28 days post-installation (EN ISO 16000-9)
  - CO₂ monitoring: alert at 800 ppm (WELL v2)
  - No recirculated air without HEPA for OFS/MCAS spaces
  - Thermal stability: ambient variation ≤1°C/hr; ≤2°C across primary route; max 3°C at entry vestibule; target 21°C on primary routes
  - No fragrance diffusers (electronic, passive, or HVAC-integrated) in OFS-occupied environments
...
**Uhthoff's phenomenon and MS thermal conflict:** MS heat sensitivity affects 60–80% of people with MS (MSIF Atlas 2023). Core temperature rise ≥0.5°C temporarily worsens neurological symptoms. Built-environment implication: ambient temperature ≤18°C as maximum for NEU/MS spaces. Conflicts directly with fibromyalgia PAIN warmth requirement (≥20°C) and older adult thermal comfort requirement (24.9°C). Resolution: ambient ≤18°C (MS floor); individual supplemental heating available at each seat/workstation.
...
**Conflict table:**
  ...
  |---|---|---|
  | NEU/MS (Uhthoff) | Ambient ≤18°C; avoid core temp rise ≥0.5°C | 60–80% of MS patients heat-sensitive; MSIF Atlas 2023; Tier 3 |
  | PAIN/fibromyalgia | Warmth ≥20°C; cold environments increase pain | Staud (2011); Geisser et al. 2021 (hyperacusis + temperature); Tier 3 |
  | OFS/MCAS/POTS | Cool environment ≤19–21°C; heat triggers symptoms | CDC ME/CFS guidelines; Newcastle POTS 2018; Tier 4 |
  | DEM/older adults | 24.9°C neutral; comfort zone 18.3–26.3°C | Baquero et al. 2023, n=1,065; Tier 3 |
...
**TC-01 full specification (MS/NEU/PAIN/OFS primary occupied spaces):**
...
**Three core visitability requirements (Concrete Change/Eleanor Smith 1987):**
  ...
  2. Minimum 815 mm (32 inches) clear passage on all ground-floor doors; 915 mm (36 inches) hallways
  3. At least one half-bath (toilet + handwash basin) on the main floor accessible to a wheelchair user
**Cost at construction:** Approximately $100–600 additional in new residential construction — below 0.5% of typical house cost
**Key design specifications from early research synthesis:**
  - Ramp gradients: ADA 1:12 (8.33%); UK 1:12 ≤2m, 1:15 ≤5m, 1:20 ≤10m; AU 1:14 max; DIN 18040 prefers 1:20
  - Minimum ramp width: 915 mm (ADA); 1000 mm (UK/AU); 1200 mm (DIN 18040)
  - Thresholds trending toward zero globally: ADA 13 mm max; DIN 18040 0 mm preferred, 20 mm max; BS 8300 15 mm max; AS 1428.1 5 mm without treatment
  - Entry bench: 430–485 mm seat height; 500–600 mm depth; ≥1112 N (250 lbf) structural strength; adjacent grab bar at 840–915 mm
  - Laundry: front-loading washers on 200–380 mm pedestals bring drum to accessible height; controls front-mounted ≤1220 mm; ≤22.2 N force; top-loaders not ADA-compliant from seated position
  - Home office work surfaces: ADA 710–865 mm; sit-stand desks 640–1300 mm range; no crossbars obstructing knee clearance
  - Wall blocking for future grab bars: 19 mm plywood or min 2×10 lumber between studs at ~915 mm AFF; must withstand 1112 N at any point (Fair Housing Act); document with photographs before drywall
  - Reinforced flooring for future ceiling hoists: standard residential joists insufficient; structural reinforcement required at design stage
**Visitability policy adoption:** Atlanta, Arizona, Texas, Illinois, and other US jurisdictions; Concrete Change estimates 10,000+ visitability homes built globally
**Jurisdictions confirmed:** US (Fair Housing Act 7 features; Concrete Change standards); UK (Lifetime Homes; Part M4(1) mandatory; M4(2) optional); AU (NCC 2022 Livable Housing mandatory); Canada (CAN/ASC B652); Norway (TEK17)
...
**Priority hierarchy (Part IIB §B.2):**
  ...
  2. Tier 1 OT clinical evidence governs where safety provisions are equivalent
  3. Most constrained user's provision governs where OT evidence is equal
  4. Range specifications preferred over point specifications
  5. Zoning separates irreconcilable conflicts
  6. Document as Tier X gap if unresolvable
**Nine resolved conflicts:**
  1. **Visual contrast (VIS vs NDV):** ≥30 LRV on primary accessible route (safety-critical; Zone 1); 20–30 LRV secondary circulation (Zone 2); ≤20 LRV sensory retreat (Zone 3). NDV comfort met by zoning, not by reducing safety contrast.
  2. **Hearing loop vs NDV quiet space:** Loop extends into quiet zone but audio signal sources (PA, background music) are independently controlled. Loop amplifies direct speech without requiring broadcast audio. Separate loop zone on IEC 60118-4 standards with independent audio input.
  3. **Grab bar diameter (UPL vs general):** 32–45 mm (circular preferred; oval permitted for equivalent grip perimeter; avoid knurled). BAR context: 45–50 mm where ≥250 kg static load rating required.
  4. **Temperature (NEU Uhthoff's vs PAIN warmth):** Ambient ≤18°C (MS/NEU floor — heat-induced neurological worsening is safety-critical Tier 1); individual supplemental heating at each seat/workstation (radiant panel, heated throw, personal fan). Ambient priority for MS; warmth delivered individually.
  5. **Tactile floor indicators (VIS vs PAIN vibration):** Full ISO 23599:2019 on primary accessible route (safety-critical); high-contrast flush edging strips on secondary routes (PAIN/NDV comfort served; noted as Tier 3 compromise for VIS). Unresolved evidence gap: no product currently meets both ISO 23599 profile and vibration attenuation.
  6. **Acoustic differentiation (VIS navigation vs DEM sensory calm):** 200–300 mm hard floor strip at junctions (acoustic cue for VIS); NRC ≥0.70 panels within 2 m on parallel surfaces (prevents echo for DEM).
  7. **Automatic vs manual doors (NDV/MH vs MOB):** Automatic with: motion sensor ≥3 m (visual warning before activation); auditory chime; glazed leaf; ≥3 seconds opening travel; high-contrast floor activation zone. Provides MOB force-free access while restoring predictability for NDV/MH.
  8. **Nature views / planting (VIS vs DEM/MH):** Interior planting ≥600 mm from circulation edge; species with clear contrast against wall; planting containers with LRV ≥30 contrast base band. Sightlines to nature from seating unrestricted.
  9. **Floor pattern (DEM plain vs VIS contrast):** Plain floor (C-06) on all primary routes — DEM fall prevention Tier 1 (pattern-associated falls +15%, DSDC 2024). VIS orientation via wall contrast, signage contrast, and architectural landmarks rather than floor pattern.
**Key unsupported spec values (flagged from item-review):**
  - A-04: 20 m restorative interval distance — ART concept supported; 20 m distance not derived from evidence [UNSUPPORTED]
...
**Stronger in non-English literature:**
  ...
  |---|---|---|
  | Toilet visibility D-03 | German (Marquardt 2011, TU Dresden) | 47% incontinence reduction in 32 dementia care facilities — single strongest empirical finding for any spatial design provision |
  | Heat shock thermal provision | Japanese (AIJ epidemiological studies) | ~17,000 cardiovascular deaths/year from bathroom temperature differential >10°C; largest epidemiological dataset for any provision in the guidebook |
  | Dementia village normalised environment D-09 | Dutch (BuroKade/Vivium De Hogeweyk POE) | 94% wayfinding success vs 34% conventional; lower staffing ratio with higher quality-of-life |
  | Bathroom fall threshold risk I-04 | Japanese (Journal of Environmental Engineering, AIJ) | Threshold ≥15 mm statistically significant fall risk increase |
  | UD cost premium by building type | Belgian/Dutch (Ielegems & Vanrie full dataset) | Residential 0.94%, educational 1.67%, office 2.31%, healthcare 3.92%; cost premium decreases to near-zero after 3 accessible projects |
  | Ramp gradient E-03 | Swedish (Boverket/SINTEF Scandinavian Journal OT) | 1:20 is maximum functional gradient for self-propelling manual wheelchair users; largest OT propulsion sample |
  | Loop garden with seating D-11 | Danish (Nationalt Videnscenter for Demens) | Loop path gardens with seating every 20 m produce measurably lower agitation than non-loop configurations |
**Cross-linguistic consensus (≥5 language bodies):**
  - LRV contrast ≥30 at critical junctions: UK, German, French, Swedish, Norwegian, Japanese
  - Loop floor plan for dementia (D-01): German, Danish, Dutch, French, English
  - Zero-threshold wet room (I-04): German, Japanese, Swedish, Norwegian, British
  - Grab bar structural blocking (I-03): German, Japanese, British, North American, Australian
  - Hearing loop at counters/assembly (A-10/A-11): British, German, French, Swedish, Norwegian
  - Rest seating ≤20–50 m (E-10): British, Japanese, Swedish, Norwegian
**No non-English evidence found:**
  - DeafBlind provisions (DBL): clinical OT research primarily English-language
  - ASPECTSS autism design (A-16): Mostafa's model English-language; limited non-English parallel
  - Auracast/assistive technology (A-12): documented in English-language technical standards only
**Additional non-English findings:**
  - German: DIN 18040-2 ≤10 mm threshold variant at shower/balcony doors where zero-threshold drainage-constrained; 1200 mm (not 1100 mm) upper reach zone for self-propelling wheelchair users
  - German: TERRAGON/DStGB (2017) — 130/140 DIN 18040-2 criteria add zero cost at design stage; €21.50/m² for full compliance
  - German: KfW/Prognos — average €19,100/dwelling retrofit; 700,000+ dwellings (largest real-world retrofit dataset)
  - German: "Sonntagsnachmittagssyndrom" — heightened dementia agitation during reduced natural light (Der Nervenarzt); corroborates B-01 circadian lighting
  - Norwegian SINTEF: reach zone 400–1300 mm forward, 400–1200 mm lateral for powered wheelchair users (extends English-language 400–1100 mm upper limit)
  ...
  - French: Village Landais 31% psychotropic medication reduction (PROVISIONAL — internal evaluation, unpublished in English)
...
| Language | Native alias | Map | Warning |
|---|---|---|---|
| EN | signing space / visual communication space | ✓ CLEAN | — |
| SV | teckenutrymme / visuellt kommunikationsutrymme | ✓ CLEAN | Swedish standards silent on signing space |
| NO | tegnrom / kommunikasjonsavstand | ⚠ PARTIAL | No Norwegian standard; concept emerging via advocacy |
| DA | tegnsprogrum / kommunikationsafstand | ✓ CLEAN | Danish standards silent on signing space |
| FI | viittomistila / visuaalinen kommunikointitila | ✓ CLEAN | Finnish decree silent on signing space |
| FR | espace de signe / espace proxémique pour la LSF | ✓ CLEAN | French ERP standards silent on signing space |
| DE | Gebärdenraum / Kommunikationszone | ✓ CLEAN | DIN 18040 series silent on signing space |
| ZH | 手语交流空间 | ⚠ PARTIAL | No Chinese built-environment signing space standard or ZH Deaf org guidance |
| JA | 手話空間 / 手話コミュニケーションスペース | ⚠ PARTIAL | JA standards and JFD silent; nearest source is Deaf school design (MEXT) |
| NL | gebarenruimte | ✓ CLEAN | NEN 9120 silent on signing space |
| ES | espacio signante / espacio de comunicación visual | ✓ CLEAN | CTE SUA silent on signing space |
| PT | espaço signante / espaço de comunicação visual em LIBRAS | ✓ CLEAN | NBR 9050 silent on signing space |
| KO | 수어 공간 | ⚠ PARTIAL | 편의증진법 silent; field entirely nascent in KO |
| IT | spazio segnante / LIS spazio | ✓ CLEAN | DM 236/89 silent on signing space |

### Best-practice synthesis

**Most inclusive provision:** All primary corridors and circulation routes to be a minimum 2440 mm (8 ft) wide, sufficient for two signers walking in conversation side by side with peripheral scan space; secondary corridors not less than 1830 mm (6 ft). Public exterior pathways to be a minimum 3050 mm (10 ft) wide where signing groups are anticipated. [DeafSpace Design Guidelines, Gallaudet University 2010; DeafScape, Vaughn 2018]

**Most targeted provision:** Sightlines for signed conversation to be unobstructed across a minimum 3 m depth with no mid-field obstacles at shoulder height or below; standing signing conversation space to provide 900 mm–3050 mm (3–10 ft) between interlocutors depending on group size; glazed corners and intersections to replace opaque corners at all circulation junctions. Lighting to be diffuse, matte-reflected, shadow-free, ≥300 lux in communication zones; backlighting to be eliminated; wall colour to provide medium-contrast neutral tones (muted greens, blues) against which skin tone is legible for lip-reading and facial expression. [DeafSpace Design Guidelines 2010; RIT InfoGuides DeafSpace]

**Conflict resolution:** Where fire life-safety requirements (strobes, visual alarms) conflict with glare-free lighting, diffuse strobe placement takes precedence; sign language communication quality is secondary to life-safety alerting but both can be achieved through diffuser technology.

**Highest-ambition actionable specification (guidebook prose register):**
Primary internal corridors serving Deaf users are to achieve a clear width of not less than 2440 mm. Signing conversation distance of 900 mm to 3050 mm is to be accommodated between interlocutors at all gathering nodes. Corridor junctions are to be glazed to provide visual advance warning of approaching persons. Lighting in communication zones is to be diffuse and uniform, achieving not less than 300 lux at face height, with no point sources generating glare or backlighting. Wall and surface finishes are to be matte, with colour selected to contrast clearly with skin tones. Furniture is to be movable and without fixed armrests to allow formation of communication circles. Ramps are to be preferred over stairs on all primary signed-conversation circulation routes.
...
| Glazed/transparent corridor junctions to provide visual advance warning | EN (Gallaudet built examples, NEA report) | Co-1 |
| Diffuse, shadow-free lighting ≥300 lux at face height; no backlighting | EN (DSDG); SV (Stockholm accessibility handbook) | Co-1 / Tier 2 |
| Matte wall surfaces; neutral mid-tone colours (muted blue-green) against skin | EN (DSDG) | Co-1 |
| Movable seating without armrests; semicircle/U-shape arrangement | EN (DSDG, Gallaudet POE) | Co-1 |
| Ramps preferred over stairs on primary signing circulation routes | EN (DSDG, DeafScape) | Co-1 |
| No built-environment standard in any jurisdiction specifies signing space dimensions | EN, SV, NO, DA, FI, FR, DE, ZH, JA, NL, ES, PT, KO, IT | Tier 6 absence |
| DeafSpace principles generally cross-cultural (confirmed 6+ countries) but spatial grammar dimensions may vary by signed language | EN (Cloete & Rout 2025) | Tier 3 |

### Divergent findings
| Topic | Position A | Position B | Cause |
|---|---|---|---|
| Corridor width | ≥2440 mm (DSDG / ASL-derived) | Narrower provisions may suffice for BSL/DGS/LIS (no measurement data) | Empirical — ASL has larger signing envelope than most other SLs; no cross-language spatial data |
| DeafSpace as UD vs. particularist design | DeafSpace principles beneficial to all users (universal value) | DeafSpace creates particularist spaces for Deaf community | Theoretical divergence: Edwards & Harold (2014) vs. Gallaudet position |

### NO-DATA / THIN
| Language | Reason | Predicted by concept boundary warning? |
|---|---|---|
| ZH | No Chinese standard or Deaf org publication on built-environment signing space | YES |
| JA | JFD and MEXT materials on Deaf school design do not specify signing space dimensions | YES |
| KO | 편의증진법 and 한국농아인협회 do not address spatial signing requirements | YES |
| DE | DGB and DIN 18040 series entirely silent on signing space | YES |
| NO | Norges Døveforbund does not publish built-environment design guidance | YES |
| SV, DA, FI, NL, ES, PT, IT | National deaf organisations and national standards silent on signing space dimensions | YES (predicted by absence of any jurisdiction addressing DEAF spatial requirements beyond hearing loops) |

### Citation mining
| Source | Direction | New sources added |
|---|---|---|
| Edwards & Harold (2014) | Backward | Hamraie (2012 UD materialist practice); Imrie (2012 universalism); Alexander pattern language |
| Edwards & Harold (2014) | Forward | Cloete & Rout (2025); Coolen thesis (NL); Snoddon (2023) bilingual environments |
| DSDG Gallaudet (2010) | Backward | Bauman & Murray (2014) Deaf Gain; Day & Midbjer (2007) |
...
| Language | Native alias | Map | Warning |
|---|---|---|---|
| EN | DeafBlind / tactile infrastructure / intervenor | ✓ CLEAN | — |
...
| FR | sourdaveugle / guide-interprète | ✓ CLEAN | — |
| DE | taubblind / Taubblindendolmetscher | ✓ CLEAN | — |
| ZH | 盲聋 / 触觉沟通 | ⚠ PARTIAL | Community very small; no standard built-environment guidance |
| JA | 盲ろう者 / 触読手話 / 接近手話 | ⚠ PARTIAL | 触読手話 (tactile signing) and 接近手話 (close-range signing for low vision) require interpreter zones at 0.5–1.0m; no equivalent EN concept |
| NL | doofblind / tactiele communicatie | ✓ CLEAN | — |
| ES | sordociego / guía-intérprete | ✓ CLEAN | — |
| PT | surdocego / surdo-cegueira | ✓ CLEAN | ABNT NBR 16537:2024 explicitly addresses surdo-cegueira — most specific standard found |
| KO | 시청각장애인 | ⚠ PARTIAL | Field nascent; no standard built-environment guidance |
| IT | sordocieco / mediatore della comunicazione | ✓ CLEAN | — |

### Best-practice synthesis

**Most inclusive provision:** Tactile floor wayfinding (TWSI/ISO 23599:2019; ABNT NBR 16537:2024) throughout all primary circulation routes, with continuity guaranteed for DBL users who rely on cane and tactile cues simultaneously. Tactile building orientation maps at all primary building entrances at 900–1200mm AFF. Intervenor/guide-interpreter clear floor zone of ≥1500mm adjacency at all service counters and communication nodes. Vibrotactile alert systems (vibrating pagers, floor transducers) throughout all occupied spaces as complement to visual strobes — no built-environment standard in any jurisdiction mandates this, but DbI best practice guidelines and DeafBlind information sources confirm the design requirement.

**Most targeted provision:** For Protactile users: contact space (shoulder-to-lap zone) requires seating arranged face-to-face at ≤600mm distance, with armless movable chairs and clear floor space of ≥1500mm per communication pair. For 接近手話 (JA) / close-range signing for DBL users with residual vision: interpreter positioning zone within 500–1000mm of the DBL user; dedicated lighting on interpreter from head to knee with no shadow on background surface (NBR 9050 PT requirement for LIBRAS interpreter positioning applies analogously). Consistent spatial layout throughout — unfamiliar spatial rearrangements are high-risk for DBL users who construct cognitive maps from repeated tactile experience.

**Conflict resolution:** Where vibrotactile floor panels (for DBL alerting) conflict with TWSI tactile paving (for VIS/DBL wayfinding), tactile paving takes precedence as the primary navigation aid; vibrotactile alerting is provided as wearable pager system.

**Critical gap (all 14 languages):** No jurisdiction in any language specifies intervenor/guide-interpreter clear floor space dimensions at service counters. No jurisdiction specifies Protactile or tactile signing contact space requirements in built-environment standards. These are the most significant unmet design specification gaps for DBL users globally. GAP-NEW-01 through GAP-NEW-04 correctly identify these. [THIN BASE — < 3 sources per finding; all claims are Co-1/Tier 2 derivation, not Tier 1 evidence]
...
| No jurisdiction specifies Protactile/tactile signing contact space in built-environment standards | EN, and all others by absence | Tier 6 absence |
| Vibrotactile alerting (pager/bed shaker) confirmed as best practice for DBL sleeping accommodation | EN (DbI guidelines, DeafBlind-Info AU) | Tier 2 |
| Consistent spatial layout is a core DBL safety requirement — unfamiliar changes are high-risk | EN (DbI guidelines) | Tier 2 |
| Nordic statutory ledsagarservice (escort right) implies spatial clearance for escort + DBL pair at ≥1500mm | SV, NO, DA, FI | Tier 5 |
| PT: ABNT NBR 16537:2024 — only jurisdiction explicitly extending tactile paving guidance to surdo-cegueira | PT | Tier 4 |
| JA: 接近手話 requires interpreter within 500–1000mm — spatial design implication for counter/desk zones | JA | Co-1 [THIN BASE] |
| Protactile (US/EN): contact space (shoulder to lap) is the linguistic space; face-to-face seating ≤600mm required | EN (Clark, Nuccio, Wikipedia) | Co-1 |

### Divergent findings
| Topic | Position A | Position B | Cause |
|---|---|---|---|
| DBL as distinct disability vs VIS+DEAF combined | Nordic definition: DBL is a distinct disability requiring distinct design response | Many standards treat DBL as VIS+DEAF combined — no distinct provision | Boundary mismatch: regulatory (most jurisdictions) vs evidence (Nordic Welfare Centre, DbI) |

### NO-DATA / THIN
| Language | Reason | Predicted by boundary warning? |
|---|---|---|
| ZH | Community very small; no standard or org guidance | YES |
| KO | No DBL-specific built-environment guidance | YES |
| FR, DE, IT | DBL org (APSA/GUT/ENS) publications do not address spatial/built-environment specs | YES |
| NL | NEN 9120 does not distinguish DBL from VIS+DEAF | YES |

### Citation mining
| Source | Direction | New sources added |
|---|---|---|
| Clark, Touch the Future (2023) | Backward | Nuccio/granda Protactile origin; Edwards & Brentari (2020) Feeling Phonology |
...
| Language | Native alias | Map | Warning |
|---|---|---|---|
| SV | *Kognitiv orientering / demensvänlig orientering / orienteringsanvisningar / bildpiktogram* | ✓ CLEAN | — |
| NO | *Kognitiv orientering / demensvennlig orientering / orienteringsskilt / piktogrammer* | ✓ CLEAN | — |
| DA | *Kognitiv orientering / demensvenlighed orientering / orienteringsskiltning / piktogrammer* | ✓ CLEAN | — |
| FI | *Kognitiivinen orientoituminen / dementiaystävällinen orientoituminen / kuvasignalisaatio* | ✓ CLEAN | — |
| FR | *Orientation cognitive / repères visuels / balisage pictogramme / cheminement intuitif* | ✓ CLEAN | — |
| DE | *Kognitive Orientierung / demenzgerechte Orientierung / Leitzeichensystem / KDA* | ✓ CLEAN | KDA and Deutsche Alzheimer Gesellschaft are primary sources — retrieve before academic databases. |
| ZH | *认知导航 / 失智症友善空间指引 / 图文标识* | ✓ CLEAN | *认知无障碍* conflates IntD and NEU in ZH policy — distinguish. |
| JA | *認知的案内 / 認知症対応ウェイファインディング / ピクトグラム / 家具レイアウトの一貫性* | ✓ CLEAN | Group home (*グループホーム*) and MHLW facility standards — search directly. |
| NL | *Cognitieve oriëntatie / dementievriendelijke oriëntatie / pictogramborden / herkenningspunten* | ✓ CLEAN | — |
| ES | *Orientación cognitiva / señalización pictográfica / referencias visuales* | ✓ CLEAN | — |
| PT | *Orientação cognitiva / sinalização pictográfica / referências visuais* | ✓ CLEAN | — |
| KO | *인지적 길 찾기 / 치매 친화적 공간 안내 / 그림 표지판 / 가구 일관성* | ✓ CLEAN | — |
| IT | *Orientamento cognitivo / progettazione per la demenza / segnaletica pittografica* | ✓ CLEAN | — |

### Best-practice synthesis
**Most inclusive provision:** Continuous loop circulation with no dead ends, toilet visible from primary seating without navigation, and distinctive 3D object landmarks at every route junction. Removes orientation barriers simultaneously for DEM, NEU, NDV, and VIS populations.

**Most targeted provision (DEM):** Small-group residential scale (≤9 residents per cluster); no repetitive corridor elements; 3D objects (not colour alone) as primary wayfinding cues at decision points; consistent furniture layout across identical room types.
...
- 3D object landmark at every junction (culturally familiar, high-contrast, positionally consistent)
- Toilet visible from primary occupied space without navigation
- Consistent furniture arrangement within room types; no mirror-image pairs
- Residential cluster ≤9 persons (DEM); transition alcoves at zone boundaries (NDV/AUT)
...
| 3D object landmarks at decision points > colour-coded walls for DEM orientation | EN, DE, NL, JA | UK, DE, NL, JP, AU | Tier 3 (Marquardt 2011; van Buuren 2022) |
| Small-group residential scale (≤9) supports DEM wayfinding and autonomy | EN, DE, NL, NO, FR, JA | UK, DE, NL, NO, FR, JP, SG | Tier 5/Co-1 (KDA; DSDC; Helsedirektoratet; SG AIC-CLC; JP group home standards) |
| Consistent furniture layout critical for DEM tactile memory navigation | EN, DE, NL, FR, SG | UK, DE, NL, SG | Tier 3 + Co-1 (DSDC; Alzheimer Nederland) |
| NDV/AUT: spatial sequencing, escape spaces, transition zones, compartmentalisation | EN, DE, IT, NL | UK, US, IE, DE, IT, NL | Tier 3 (Tola et al. 2021; Black et al. 2022; ASPECTSS 2.0 Mostafa 2021) |
| One-directional or sequenced circulation preferred for AUT | EN | US, IE, AU | Tier 3 (Mostafa 2023; Black et al. 2022) |

### Divergent findings
| Topic | Lang/Jurisdiction A | Lang/Jurisdiction B | Cause |
|---|---|---|---|
| Dementia unit size | SG AIC-CLC (≤6–8, HDB high-density) | DE KDA (≤9, suburban) | Built environment constraint |
| Colour as wayfinding cue | UK/DE (objects primary; colour insufficient alone) | KR/SG (colour-coded wings still used) | Evidence lag; objects > colour in controlled studies; colour still used as secondary aid |
| Outdoor loop routes | AU/NZ (secure garden loop = normative best practice) | ZH/KO (outdoor access less common; safety primary) | Cultural care model differences |

### NO-DATA / THIN
| Jurisdiction | Language | Reason | Co-1 attempted? | Tier 5 attempted? |
|---|---|---|---|---|
| IT | IT | No IT-specific DEM wayfinding design guidelines | Yes | Partial |
| BE | NL/FR | Dementieplan retrieved; no building-design guidelines identified | Yes | Partial |
| CH | DE | No distinct CH standard; KDA proxy applied | Yes | Yes |
| PT | PT | No PT-specific DEM built environment guidelines | Yes | Partial |
| ES | ES | CEAFA referenced; no ES built-environment guidelines | Yes | Partial |
| NZ | EN | Dementia Australia applied cross-jurisdictionally | Yes | No |

### Citation mining
| Source | Direction | New sources added |
|---|---|---|
| Marquardt (2011) HERD | Forward | van Buuren & Mohammadi (2022, 2025); Wiener & Pazzaglia (2021); Shabha et al. (2022); Marquardt et al. (2014); Siegelaar et al. (2025) |
| Tola et al. (2021) | Forward | Black et al. (2022); Mostafa ASPECTSS 2.0 (2021) |
...
| FR | *Dimensions ascenseur / largeur libre de couloir / aires de repos / espace de retournement* | ✓ CLEAN | — |
| DE | *Aufzugmaße / Flurbreite / Ruhebänke / Bewegungsfläche / automatische Türen / DIN 18040* | ✓ CLEAN | — |
| ZH | *电梯尺寸 / 走廊净宽 / 休息座椅 / 轮椅回转空间 / 自动门* | ✓ CLEAN | — |
| JA | *エレベーター寸法 / 廊下有効幅員 / 休憩ベンチ / 車いす転回スペース / 自動ドア* | ✓ CLEAN | — |
| NL | *Liftafmetingen / gangbreedte / rustplaatsen / draaicirkel / automatische deuren / NEN 9120* | ✓ CLEAN | — |
| ES | *Dimensiones ascensor / anchura libre de pasillo / zonas de descanso / puertas automáticas* | ✓ CLEAN | — |
| PT | *Dimensões elevador / largura livre de corredor / áreas de descanso / portas automáticas* | ✓ CLEAN | — |
| KO | *엘리베이터 치수 / 복도 유효 폭 / 휴식 공간 / 자동문 / 편의시설 설치 기준* | ✓ CLEAN | — |
| IT | *Dimensioni ascensore / larghezza netta corridoio / aree di sosta / porte automatiche* | ✓ CLEAN | — |

### Best-practice synthesis

**Lift car dimensions:**
- Minimum compliant (EN 81-70 Type 2): 1100mm wide × 1400mm deep, door on short end. This is the international baseline (UK, SE, FI, NO, DE, FR, AU, SG, CA, US proxy).
- Best practice: 1100mm × 1800mm (stretcher-capable, large power wheelchair); BS 8300 recommends 1100mm × 2000mm for new buildings.
- Power wheelchair users require 1400mm × 1600mm minimum for independent use (IDeA Center Steinfeld et al. 2010 — from MOB BPC).
- Landing: 1500mm × 1500mm clear turning space at landing (BS 8300 / Boverket BFS 2024:12 / Finnish F1).
- Door clear width: ≥900mm (EN 81-70 Type 2; DIN 18040-1; GB 50763; ADA min 915mm).
...
- OT clinical evidence (energy conservation, OFS/ME/CFS literature): uninterrupted walking distances >25–30m constitute an exertion threshold for OFS/POTS populations and many ambulant MOB users.
- Best practice: rest seating at ≤25–30m intervals on primary circulation routes; reclining or tilt option for OFS populations (no standard; expert consensus only — THIN-BASE).
- Guidebook position (from GAP-B4-01 resolution): 25–30m range; median 27.5m.
...
| ≥900mm clear door width for lifts | EN, DE, SV, NL | UK, DE, SE, NL, AU, US | Tier 6 (EN 81-70; DIN 18040-1; ADA) |
| ≥1525mm corridor width for two wheelchair users to pass | EN | US, UK, AU | Tier 6 (ADA; Part M; AS 1428.1) |
| 1800mm corridor preferred on primary residential/care routes | EN, DE, NL | UK, DE, NL | Tier 6/5 (BS 8300; DIN 18040-1; care home guidance) |
| Automatic sliding doors on primary accessible routes = best practice | EN, DE, SV, NO, FR | UK, DE, SE, NO, FR, AU, US | Tier 6/5 (all surveyed standards recommend; BS 8300 §7; DIN 18040) |
| Rest seating interval: no building code specifies a maximum in any jurisdiction | ALL | ALL | NO-DATA (confirmed absence — derived from OT clinical literature) |
...
| Jurisdiction | Language | Reason | Co-1 attempted? | Tier 5 attempted? |
|---|---|---|---|---|
| ALL | ALL | Rest seating interval: no building code exists in any jurisdiction for maximum seating interval; OFS/ME evidence derives entirely from clinical literature | Yes (OT orgs) | N/A — no standard to retrieve |
| KR | KO | 편의증진법 lift dimensions not retrieved directly | Partial | Partial |
| CN | ZH | GB 50763-2012 lift provisions not retrieved directly | Partial | Partial |
| BR | PT | NBR 9050 lift provisions not retrieved directly | Partial | Partial |
| JP | JA | MLIT barrier-free law lift provisions not retrieved directly | Partial | Partial |

### Citation mining
| Source | Direction | New sources added |
|---|---|---|
| EN 81-70:2021+A1:2022 (KONE/iKONIC commentary) | Forward | LEIA Approved Document M guidance (UK); BS 6440:2011 platform lift dimensions |
...
| IT | tempo di riverberazione | ✓ CLEAN | UNI 11532-2:2020 explicitly addresses students with hearing deficit (categoria A3.1/A4) |
| JA | 残響時間 | ⚠ PARTIAL | Disability-specific provisions in Barrier-Free Law framework, not acoustic standard |
| ZH | 混響時間 | ⚠ PARTIAL | GB 50118-2010 does not differentiate by disability population |
| SV | efterklangstid | ⚠ THIN | SS 25268 covers schools; disability differentiation not confirmed |
| KO | 잔향시간 | ⚠ NO-DATA | No dedicated search completed |

### Best-practice synthesis

**Population differentiation is the defining issue** in room acoustic performance specifications for disability populations. All jurisdictions agree on general population classroom RT60 targets (0.4–0.6 s depending on room volume). The critical divergence emerges when disability-specific populations are considered:

**For DEAF / hearing device users (hearing aids, cochlear implants):**
Best-practice provision: RT60 ≤ 0.3 s in classrooms ≤ 283 m³. This requirement is now peer-reviewed (Iglehart, 2020, AJA) and formally encoded in ANSI/ASA S12.60-2010/Part 1 Footnote e. It applies to children with hearing aids or cochlear implants. The standard general-population requirement (0.6 s) is demonstrably insufficient for hearing device users; speech perception scores are significantly better at 0.3 s than 0.6 s for this population. Background noise target: ≤ 30–35 dB(A) (more stringent than the standard ≤ 35 dB(A)).

**For NDV/AUT (autism spectrum, sensory hypersensitivity):**
Best-practice provision: No internationally agreed quantified RT60 target specific to autistic users. Bettarello et al. (2021, *Applied Sciences*) and Caniato et al. (2024) confirm that existing standards (ANSI/ASA S12.60, BB93, UNI 11532-2) are calibrated to neurotypical populations and are insufficient for NDV/AUT. Autistic users are significantly more affected by modest background noise increases (52→55 dB(A)) and by sudden noise events than neurotypical users. Evidence supports: lower background noise targets (≤ 35 dB(A); aspiration: ≤ 30 dB(A)), broadband absorption to suppress flutter echo and reflective peaks, no sound masking systems (A-13 doctrine), and sensory gradient zoning (F-01). Sound masking is contraindicated for NDV/AUT.

**For DEM (dementia):**
Best-practice provision: Acoustic calm as primary therapeutic intervention. BrainXchange (Canada, Tier 2 Co-1) documents background noise management as clinically significant for dementia care. Devos et al. (2019, PMC) confirm RT60 measurement and acoustic intervention as standard practice in Belgian nursing homes, with measurable outcomes. Lyngby-Taarbæk case study (Part IX-06) documents 40% reduction in agitation events following acoustic ceiling installation. Targets consistent with NDV: NC-25 (≤ 35 dB(A)), RT60 ≤ 0.5 s in occupied common areas.

**For NEU/PCS:**
Best-practice provision: Flicker-free, low background noise, NC-25 or better. No specific RT60 target for PCS confirmed beyond general accessibility guidance. The PCS population is absent from all room acoustic standards reviewed in any language.

**For OFS/PAIN:**
No room acoustic standard in any jurisdiction addresses these populations acoustically. THIN-BASE disclosure applies.
...
| Background noise ≤ 35 dB(A) in classrooms | EN DE IT DA NO FR AU | 10+ jurisdictions | Tier 5–6 |
| NDV/AUT: existing standards insufficient; lower noise targets needed | EN IT | US UK IT | Tier 1 (Bettarello 2021; Caniato 2024) |
| DEM: acoustic intervention reduces agitation | EN | UK (Lyngby-Taarbæk) BE (Devos 2019) | Tier 2 (case study/POE) |
| NRC ≥ 0.85 ceiling panels as primary acoustic treatment | EN (consistent across BB93, ANSI, DIN 18041) | US UK DE | Tier 5–6 |
| STI ≥ 0.60 general speech intelligibility target | EN DE IT NO | US UK DE IT NO | Tier 5–6 |
...
| Topic | Divergence | Diagnosis |
|---|---|---|
| RT60 targets for hearing-impaired | US/IT explicitly specify 0.3 s; DE (DIN 18041) specifies lower RT for inclusion but without disability-specific quantified targets; UK (BB93) notes needs without giving RT60 for HI | Regulatory context difference: ANSI/ASA is more explicit than DIN for disability-specific values |
| DEM acoustic provisions | EN (extensive guidance from BrainXchange, DSDC, Dementia Centre); DE/FR/IT focus on technical acoustic standards without disability-specific DEM framing | Concept boundary: DEM acoustic design is an English-language-dominated evidence domain |
| NDV acoustic standards | UNI 11532-2 (IT) includes explicit categoria A3.1/A4 for users with hearing deficits or attention/concentration disorders (which encompasses NDV) — making IT the most explicit non-EN jurisdiction for NDV acoustic provisions | Genuine jurisdictional advance: IT UNI 11532-2:2020 goes beyond BB93 or DIN 18041 in explicitly naming neurodivergent-equivalent populations |

### New sources for bibliography

1. **Bettarello, F., Caniato, M., Scavuzzo, G., & Gasparella, A. (2021).** Indoor Acoustic Requirements for Autism-Friendly Spaces. *Applied Sciences*, 11(9), 3942. DOI: 10.3390/app11093942 ✅ CONFIRMED. [Already in guidebook — citation verified as correct]

2. **Iglehart, F. (2020).** Speech Perception in Classroom Acoustics by Children With Hearing Loss and Wearing Hearing Aids. *American Journal of Audiology*, 29(1), 44–59. PMC 7229780. [NEW — strongest Tier 1 evidence for DEAF RT60 ≤ 0.3 s specification]

3. **Murgia, S., Webster, J., Cantor Cutiva, L.C., & Bottalico, P. (2022).** Systematic Review of Literature on Speech Intelligibility and Classroom Acoustics in Elementary Schools. *Language, Speech, and Hearing Services in Schools*, 53(4), 1028–1041. [NEW — Tier 3 systematic review, classroom acoustics + speech intelligibility]

4. **Devos, P., Lesoinne, R., Brouns, E., et al. (2019).** Designing Supportive Soundscapes for Nursing Home Residents with Dementia. *International Journal of Environmental Research and Public Health*, 16(24), 4904. PMC 6950055. [NEW — Tier 1/2 DEM acoustic intervention, Belgium]

5. **CEREMA / Délégation ministérielle à l'accessibilité (DMA). (2019).** Améliorer la qualité acoustique aux accueils des Établissements recevant du public. DMA/CEREMA. [NEW — FR Tier 2 source, acoustic accessibility for hearing-impaired users in ERP]

6. **Caniato, M., Bettarello, F., Marzi, A., & Gasparella, A. (2024).** Autistic Students' Sensitivity to Classroom Noise: Implications for Acoustic Design. *Building and Environment* (ScienceDirect). DOI: 10.1016/j.buildenv.2025.113... [NEW — most recent Bettarello/Caniato study, 2024/2025 — confirms findings of Bettarello 2021; adds incremental noise exposure data]
...
## mobility-built-environment — Tier 5 & Tier 3 Targeted Retrieval (2026-03-25)
