...
**Nine resolved conflicts:**
  ...
  4. **Temperature (NEU Uhthoff's vs PAIN warmth):** Ambient ≤22°C (MS/NEU floor — heat-induced neurological worsening is safety-critical Tier 1); individual supplemental heating at each seat/workstation (radiant panel, heated throw, personal fan). Ambient priority for MS; warmth delivered individually.
