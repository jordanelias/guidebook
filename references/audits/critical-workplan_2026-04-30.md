...
| 2 | **Tier 2 visibility audit reveals widespread prose failure.** W3 finds many specifications without vivid Mode S handoff. Correction is large. | Medium | High | Run W3 audit early in Phase B. If failure rate >30%, scope dedicated correction phase rather than retrofitting per-spec. |
