# Connections — health-and-symptom-management
...
The guidebook's evidence hierarchy does not weight "never tested in a built environment" differently from "t…
...
**Opus-reviewed:** false
**Source BPC slug(s):** — (pre-migration)
**Target item(s):** Part 1 framework
...
**Action required:** Add salutogenic Sense of Coherence as supplementary theoretical lens in Part 1. Three SoC components map to three-tier hierarchy.
...
**Connection type:** CROSS-POPULATION
**Connection:** K-05 thermal comfort assessment must incorporate population-specific thresholds from citation mining: MS Uhthoff at 0.5C core temp increase (Christogianni 2018, MST-10); DEM/older adult neutral 24.9C (Baquero 2023, TCO-01); FMS cold pain threshold 10.9-26.3C (Berwick 2021 SR, MST-09). Assessment protocol should enable per-population thermal profiling.
**ISW action:** K-05: add quantified population thresholds. Link to MST and TCO BPCs.
