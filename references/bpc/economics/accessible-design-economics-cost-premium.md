...
**Key evidence-strong findings (beyond cost data):**
  ...
  - Normalised dementia environment: Village Landais Alzheimer (Dax, France, 2020). Per audit_2026-04-30 R12 Path A + D-0125, the previously-cited specific "31% medication reduction" figure was removed (not located in any verified INSERM publication). Replacement directional finding: Amieva et al. INSERM 2024 — caregiver psychotropic consumption (antidepressants, anxiolytics) decreased from 6 months post-admission and sustained at 12 months (Medscape FR coverage of 3-year research presentation). Tier 4 with PRELIMINARY-FINDINGS flag pending peer-review verification of the Amieva findings; specific resident-medication percentage figures are not retained.
