...
|---|---|---|---|
| JA | 敷居 / ドアハンドル | ⚠ PARTIAL | 敷居 is traditional fusuma rail; search バリアフリー + 出入口 |
| ZH | 门槛 / 门把手 | ⚠ PARTIAL | 无障碍 standard term; search 无障碍出入口 |
| KR | 문턱 / 문손잡이 | ⚠ PARTIAL | 장애인편의 + 출입구 preferred |
| All others | — | ✓ CLEAN | — |
