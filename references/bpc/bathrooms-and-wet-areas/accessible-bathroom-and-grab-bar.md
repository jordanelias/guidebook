...
**Conflict resolution:** Grab bar height range 650–900mm — wide range is not uncertainty; it reflects jurisdictional anthropometric calibration (KR 650mm seated transfer; UK/AU 900mm standing support). At Population Mode, 700mm median. At Person Mode, OT determines via transfer biomechanics assessment. Seat-relative formulation (280mm above seat surface) is the Person-Mode standard. Turning circle: 1500mm is Universal Mode (code); 1800mm is Population Mode (where powered WC anticipated). WC seat height: 450mm median (400–500mm range per jurisdiction). Dual-transfer vs constrained: 2200×2200 preferred; 1650×2200 (BE) / 1600×1700 (PT) minimum with choice of side.
...
No novel spatial specifications. Dressing bench height = popliteal height (Person Mode OT assessment only). Clear floor space beside bed = ≥760mm × 1200mm alongside long edge.
