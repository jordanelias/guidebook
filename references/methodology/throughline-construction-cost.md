...
<!-- Pillar 3 of the four-pillar economic case -->

**Pillar ranking:** 3 of 4
**Key finding:** Accessibility integrated at design stage adds 0.5-2% to construction cost across six independent jurisdictions; 138 of 148 DIN 18040-2 criteria produce zero additional cost (TERRAGON/DStGB 2017).
**Companion files:** See `economics-methodology-core.md` for framework definitions.

---

## Source map — Q1/Q2: Per-technique and per-system first cost
...
## Source map — Q3: Per-building first-cost premium (highest hallucination risk)
...
## Verified citations — construction-cost pillar
...
**v2.0 — 2026-05-03** — Partitioned from monolithic v1.9. Content sourced from §4.1-§4.3, §10, §16.1. TERRAGON commercial-interest note added per audit recommendation.
