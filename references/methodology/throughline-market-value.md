...
<!-- Pillar 4 of the four-pillar economic case -->

**Pillar ranking:** 4 of 4 (weakest in direct evidence; strongest in original analytical framework)
**Key finding:** No peer-reviewed hedonic regression isolates an accessibility premium in any jurisdiction. The §15 perceptual-value crossover framework addresses this gap through re-framing: accessibility specifications produce features that residential markets already price under non-accessibility labels. Throughline 1 (square-footage inheritance from Sirmans 2006) elevates ~8 dimensionally-driven items to Tier 1-2 evidence.
**Companion files:** See `economics-methodology-core.md` for framework definitions.

---

## Throughline 1A — the dual-read thesis
...
## Source map — V1: Hedonic price premium at sale
...
## Source map — V2: Days-on-market / velocity
...
## Source map — V3: Buyer pool expansion (the strongest vendor argument)
...
## Perceptual-Value Crossover: The Built-Artefact Argument (§15)
...
| E-08 Corridor width ≥1200mm and above | A | **1 — indirect** | **Tier 2 by transferable inference** | Each 300mm × corridor length adds floor area, but corridor space is circulation not usable living area — marginal hedonic value lower than equivalent living space adds floor area at Sirmans canonical $/m² coefficient |
| E-11 Automatic / sliding residential doors | C, D | 4 | Tier 5 | Luxury-residential trend; no isolation |
| E-12 1500×1500 entry landing | A | **1 — indirect** | **Tier 2 by transferable inference** | Adds ~1–2m² foyer/landing area — hedonic value as entry sequence, not as equivalent living space at Sirmans canonical $/m² coefficient |
...
| D-05 Enclosed low-stimulation space (residential = home office) | A | **1 — direct** | **Tier 1–2 (strong case: enclosed room with functional premium) + Tier 5 functional premium** | Adds enclosed conditioned floor area; post-2020 home-office premium widely-attested in NAR / Zillow surveys |
...
| Accessible kitchen clearances (1500mm aisle, etc.) | A | **1 — indirect** | **Tier 2 by transferable inference** | Adds ~0.5–1.0m² kitchen floor area — functional but marginal hedonic value differs from equivalent living space kitchen floor area at Sirmans $/m² |
| Accessible bedroom (ground-floor where house has none) | A | **1 + 3 — direct** | **Tier 1 (strong case: adds bedroom count + floor area, both canonical Sirmans regressors)** | Adds bedroom count + floor area, both canonical Sirmans regressors |
...
## Price-tier segmentation evidence (§15.10)
...
The 2025 Cost vs. Value Universal Design Bath Remodel data provides direct residential-market evidence for an accessibility-feature bundle. The data must be read honestly.

**Absolute comparison (lead with this):** The UD bath costs $42,183 and recovers $25,732 at sale (61% ROI) — a net loss of $16,451 to the homeowner. The midrange bath costs $26,138 and recovers $20,910 (80% ROI) — a net loss of $5,228. The UD bath loses 3.15× more at sale than the midrange alternative. On pure resale-recovery, the midrange bath is the stronger financial choice.

**What the data does support:** The UD bath bundle is the only accessibility-specific entry in the 38-year Cost vs. Value series. Its 61% ROI, while lower than midrange, is higher than the upscale bath (41.7% on $81,612). The +12 pp YoY gain (2024→2025) is the largest among all bath categories, suggesting market valuation is improving. The non-financial value (aging-in-place, safety, fall prevention, longevity of independent living) is not captured in the ROI figure — and per Core Doctrine, the rights-based case is the foundation; the economic case removes the cost objection but does not create the entitlement.

**For developer-pitch construction:** Do not lead with 61% ROI — a developer will correctly note it underperforms midrange on resale. Lead with the +12 pp YoY trend, the bundle composition (the features residential buyers are increasingly demanding), and the non-financial value proposition.

Comparing against the Midrange Bath Remodel as the typical-build alternative:
...
The UK regulatory framework is unusual: M4(2) is *optional* (Building Regulations Approved Document M Volume 4) and is set per local authority. **London Plan requires 90% of new homes to meet M4(2)**. Outside London, the position has changed materially: **in December 2025, the UK government announced a national minimum of 40% of new homes must be M4(2)** as part of NPPF reform (Centre for Ageing Better, December 2025). Prior to this, less than 25% of new homes were required to meet M4(2) outside London (Habinteg Insight Report 2019, surveying all 322 English local plans). The 40% national minimum represents a significant regulatory shift from voluntary local-authority-set requirements to a mandatory national floor.
...
**Per-spec accessibility cost.** **Société Logique 2015 CMHC study** (already in §16 Verified Citation Register) — *Study of the Cost of Including Accessibility Features in Newly-Constructed Modest Houses*, published by Canada Mortgage and Housing Corporation. **CMHC Research Bulletin (May 2016) reports aggregate per-dwelling cost premiums of 6% (bungalow/townhouse) to 12% (semi-detached) across five Canadian cities (Vancouver, Winnipeg, Toronto, Montréal, Halifax) for 60 accessibility features.** 75% of individual features cost less than CAD $500; 57% cost $0-$100. The "few hundred to few thousand dollars per unit" paraphrase circulating in secondary sources (e.g. Community Housing Transformation Centre 2025) refers to per-feature costs, not per-dwelling totals. Floor area increases: 0% (bungalow/apartment) to 7% (semi-detached). This is **Tier 4 government-commissioned analysis** with construction-sector validation via RSMeans 2015. The 6-12% range is scope-comparable to the German bau.de 5-10% figure (both comprehensive provisions), not to the UK £1,400 M4(2) figure (basic visitability).
...
- **Canada: CMHC/Société Logique 6-12% per dwelling for 60-feature comprehensive accessibility (2015/2016); CMHC Housing Design Catalogue Class B cost estimates**
...
## Verified citations — market-value pillar
...
**v2.0 — 2026-05-03** — Partitioned from monolithic v1.9. Content sourced from §5.1-§5.3, §15 (complete), §16.4, §16.5, and dual-read thesis (previously orphaned at top of monolith).
