...
**v1.7 — 2026-05-03 — Audit corrections (economics-audit-research-2026-05-03.md).** CMHC/Société Logique cost figure corrected: primary source (CMHC Research Bulletin May 2016) reports 6-12% per-dwelling cost premium for 60-feature accessibility, not "few hundred to few thousand dollars per unit" (secondary-source paraphrase of per-feature costs). Developer pitch line updated. Throughline 1 items re-tiered: E-08, E-12, G-08, accessible kitchen reclassified from "Tier 1 by inheritance" to "Tier 2 by transferable inference" (corridor/landing/closet/kitchen aisle space has lower marginal hedonic value than equivalent living space per Sirmans 2006 methodology). D-05 and accessible bedroom retained at Tier 1-2 (strong cases: enclosed room and bedroom-count addition respectively). §15.11.2 CvV ROI reframed: absolute comparison added as lead paragraph (UD bath loses $16,451 vs midrange $5,228 — 3.15× more lost at sale); pitch guidance updated to lead with YoY trend and non-financial value, not absolute ROI.
