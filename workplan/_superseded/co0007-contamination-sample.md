...
| s12 | visual-impairment-built-environment | ✓ | **ALIGNED** | ISO 23599 (Tier 4 evidence-based standard). LRV ≥30 correctly flagged as Universal Mode (code-compliance baseline), not as best practice. Low-vision-majority insight is a Co-1/epistemic point. |
