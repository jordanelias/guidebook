...
| **R8** | **VOID as an adjudication.** *"there is no 'axis' route as per that term being misleading."* "Axis route" was **my coinage**: the axes layer is ratified (`DR-2026-07-22-work-from-axes`, ADOPTED) and exists to keep *design demand* irreducible — not to say which populations an item serves. `item_population_links` is the route; there is no rival authority. **The 89-of-93 measurement stands; the question "which route wins" does not** | **CLOSED** |
