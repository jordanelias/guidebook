...
**Date:** 2026-03-26
**Approved:** 2026-03-27
**Status:** APPROVED — author approved all recommendations with modifications to DEC-11 and DEC-12.
...
| ID | Decision | Status |
|---|---|---|
| D2-01–D2-09 | Part 4 decisions | APPROVED |
| D2-10–D2-16 | Part 5 decisions | APPROVED |
| D2-17–D2-21 | Part 6 decisions | APPROVED |
| D2-22 | C-03 + C-06 merger | APPROVED |
| D2-23 | B-03 + B-04 merger | APPROVED |
| D2-24 | A-17 → G-02 absorption | APPROVED |
| D2-30 | Create I-04 Ceiling Hoist | APPROVED |
| D2-31 | Create H-05 Nurse Call | APPROVED |
| DEC-06 | BIO stays Appendix B; TC split; Appendix C retired | APPROVED |
| DEC-11 | Worked examples — MODIFIED (see below) | APPROVED AS MODIFIED |
| DEC-12 | F-02 Fragrance-Free — MODIFIED (see below) | APPROVED AS MODIFIED |
| D2-37 | Defer reclining rest to Phase 2C | APPROVED |
| D2-39 | K-01 expansion | APPROVED |
| D2-40 | ●/○ notation guide | APPROVED |

---

## DEC-11 MODIFIED — Worked Examples

**Decision: 18 worked examples total.**

### Residential (4 examples — varying compound disability profile)

| # | Disability profile | Primary items exercised |
|---|---|---|
| R-1 | MOB + DEM | G-03/04, D-03, C-04, B-01 |
| R-2 | NDV + OFS | A-16, D-05, F-01, F-06, B-03 |
| R-3 | MOB + NEU | E-01–E-05, I-01–I-04, G-03 |
| R-4 | Full co-occurrence (MOB+DEM+NDV+PAIN/OFS) | All categories; conflict register required |

### Non-Residential (14 examples — 2 per typology × 7 typologies)

| Typology | Example A | Example B |
|---|---|---|
| Hospital/Healthcare | Acute ward (MOB+DEM) | Outpatient clinic (NDV+DEAF) |
| Office/Co-working | Open plan (NDV+OFS) | Private/focus (MH+PAIN) |
| Education — Primary | Classroom (NDV+MOB) | Corridor/assembly (NEU+DEAF) |
| Education — Secondary/Tertiary | Lecture hall (MOB+VIS) | Studio/lab (NDV+OFS) |
| Retail | Large format (DEM+MOB) | Small/specialist (NDV+MH) |
| Hospitality | Hotel room (MOB+DEM) | Restaurant/bar (NDV+VIS+DEAF) |
| Assembly/Cultural | Performance venue (VIS+DEAF) | Gallery/museum (DEM+NDV) |

**Total: 18 examples.** Supersedes original plan of 5.

**Phase 3 assignment:** Session 12 (Part 4 §4.4 or dedicated §4.5 Worked Examples). Each example: ~150–200 lines. Estimated total: ~3,000 lines in Part 4 or a dedicated appendix. **Structural decision:** worked examples belong in Part 4 §4.5 (after Stage-by-Stage) or Appendix F (standalone reference). Route to P1-D3 for placement decision — add as DEC-21.

---

## DEC-12 MODIFIED — F-02 Fragrance-Free

**Decision: RELOCATE to Appendix D (Management and Operational Guidance).**

F-02 is institutional policy, not architectural specification. The physical intervention (building design) cannot enforce fragrance-free compliance — only procurement and HR policy can. Retaining in Part 7 misrepresents the responsible party and the design stage.

**Action:**
- Delete F-02 from Category F item library.
- Add brief note in Part 7 §7.0 introduction: "Environmental management policies (fragrance-free environments, cleaning product protocols) are addressed in Appendix D."
- Add Appendix D entry: "Fragrance-Free Environment Policy — Populations: NDV, PAIN, MH, OFS/MCAS. Safety-critical for anaphylactic-grade OFS/MCAS reactions. Cross-ref: F-04 (air quality), F-01 (sensory gradient)."
- Retain in all matrix cells as: "See Appendix D — Fragrance-Free Policy."

**Category F post-revision (6 items):** F-01 · F-03 · F-04 (expanded, absorbs TC-04) · F-05 · F-06 (from TC-01) · F-07 (from TC-05). F-02 removed.

**Net item count correction:** Part 7 total = **84** (was 85 after D2-22/23/24/30/31; −1 for F-02 relocation).
...
| B-03 (No Fluorescent) + B-04 (Flicker-Free LED) | B-03 eliminates fluorescent; B-04 specifies IEEE 1789 compliance for replacement LED. Sequential spec — B-04 is meaningless without B-03. | **MERGE → B-03** (rename: "Safe Lighting Source — No Fluorescent, Flicker-Free LED") | All 5 worked examples and all 7 NR matrices list "B-03/04" as a unit. Never specified independently. |
...
| F-02 (Fragrance-Free) + F-04 (Air Quality) | Related environmental controls. | **RELOCATED — F-02 → Appendix D** | F-02 is institutional policy, not architectural specification. |
...
**Net item count change from mergers:** −2 (C-06 absorbed; B-04 absorbed) −1 (F-02 relocated to Appendix D) +2 (I-04 created; H-05 created) +2 (F-06 from TC-01; F-07 from TC-05)
...
| GAP-STRUCT-02 | BIO/TC in Vol 2 body | BIO stays Appendix B (reformatted). TC split per DEC-06. |
...
See DEC-11 MODIFIED above. 18 examples. Placement decision added as DEC-21 (P1-D3).
...
| D2-24 | **A-17 → G-02** | G-02 Variety of Seating Types (Three Heights; Upholstered; Rubber/Felt Feet) | A-17 is categorised as Acoustics but its primary function is seating material specification. PAIN allodynia/fibromyalgia benefit is the stronger clinical rationale — belongs with furniture, not acoustics. |
...
A-10/A-11 · G-01/G-07 · D-05/A-16 · F-04/F-06 · C-04/C-05 · A-01/A-04 — all kept separate for reasons documented in Pattern 1 above.
...
| **I-05** "Ceiling Hoist" | **CREATE as I-04** (new Part 7 item) | NOT-RETROFITTABLE. ×20–40 retrofit multiplier. Second-highest cost multiplier after grab bar blocking. Populations: MOB, DEM (late-stage), NEU. Design stage: CD-CRITICAL. |
| **I-06** "Kitchen Power" | **ABSORB into I-02** (Kitchen One-Handed) | I-02 already covers cooktop/oven/microwave positions. I-06 adds socket height detail (400–1100 mm AFF). |
...
#### E — DEC-06: BIO and TC Disposition

**BIO-01–BIO-05: REMAIN IN APPENDIX B.** Reformat to Part 7 template for visual consistency; fix all stale references; retain appendix location.

**TC items: SPLIT by function.**

| TC item | Disposition | Rationale |
|---|---|---|
| **TC-01** Ambient Temperature Management | **→ F-06 Thermal Zoning** | Thermal equivalent of F-01 (sensory gradient by modality). |
| **TC-02** High-Performance Thermal Envelope | **→ Part 9 Mechanical Engineering** | Building physics specification. Engineering enabler, not design zoning decision. |
| **TC-03** Thermal Mass | **→ Part 9 Mechanical Engineering — combine with TC-02** | Passive thermal engineering strategy. Combined Part 9 item: "Thermal Envelope and Mass." Appendix C retired (empty). |
| **TC-04** Ventilation and Air Change Rate | **→ ABSORB into F-04** | 80% content overlap with F-04. TC-04 adds ventilation rate (10 L/s), CO₂ monitoring (800 ppm), recirculation prohibition for OFS. |
| **TC-05** Heated Bathroom Floor | **→ F-07 Thermal Transition — Heat Shock Prevention** | Zone transition spec analogous to F-03. ~17,000 deaths/year dataset (Japanese MOH). |

**Category F post-revision (6 items):** F-01 · F-03 · F-04 (expanded) · F-05 · F-06 (from TC-01) · F-07 (from TC-05). F-02 relocated to Appendix D.

#### F — DEC-12 MODIFIED: F-02 (Fragrance-Free)

See DEC-12 MODIFIED above. Relocated to Appendix D. Not a Part 7 item.

#### G — Category J (BAR)

**Decision: DELETE Category J.** J-01–J-05 redirect to Supp Vol Part 4.

#### H — Duplicate E-06/E-07/E-08/E-09

**Decision: DELETE duplicate block (lines 3651–3755).** First instance (3508–3597) is canonical.

#### I — A-10b (Hydrotherapy RT60)

**Decision: KEEP as variant.** RT60 ≤1.0 s at 500 Hz for pool environments.

#### J — New items and expansions from cross-analysis

| ID | Source | Decision |
|---|---|---|
| D2-30 | Phantom I-05 → I-04 | **CREATE** Ceiling Hoist Tracking |
| D2-31 | Phantom H-05 | **CREATE** Emergency Pull Cord / Nurse Call |
| D2-37 | CON-0004 | **DEFER** reclining rest position to Phase 2C |
| D2-38 | CON-0002 + CON-0019 | **KEEP existing items; add PAIN/OFS to A-16 population list + rest configuration option.** |
| D2-39 | GAP-NEW-09 | **EXPAND K-01** to all DBL positions. Rename: "K-01 Intervenor and Interpreter Adjacency (All DBL Positions)." Add 1200×1500 mm clear floor zone. |
...
Add "Notation Guide" to §5.0 and §7.0 introductions.
...
|---|---|---|---|
| A | Acoustics | 15 | −2 (A-17 → G-02; B-04 merged) |
| B | Lighting | 10 | −1 (B-04 → B-03) |
| C | Colour / Surface | 5 | −1 (C-06 → C-03) |
| D | Spatial / Wayfinding | 11 | — |
| E | Entry / Circulation | 11 | Duplicates removed |
| F | Sensory Zoning | **6** | −1 (F-02 → Appendix D); +2 (F-06, F-07); F-04 absorbs TC-04 |
| G | Furniture / Fixtures | 7 | +A-17 spec absorbed into G-02 |
...
| — | Appendix D (Policy) | +1 | F-02 Fragrance-Free Policy added |
| — | ~~Appendix C~~ | ~~0~~ | **RETIRED.** TC → Part 9 + F-category |
| — | Part 9 (TC-02+TC-03) | 1 | Relocated to mechanical engineering |
| **Total Part 7** | | **84** | Was ~90; −3 merged, −1 relocated (F-02), −5 J deleted, +2 created, +2 TC absorbed into F |
...
|---|---|---|---|
| DEC-21 | Worked examples placement: Part 4 §4.5 or Appendix F? | P1-D3 | PENDING — Session 3 |
...
|---|---|---|---|
| CO-0003 | Expand Category F (add F-06, F-07; absorb TC-04 into F-04; relocate F-02 to Appendix D); relocate TC-02+TC-03 combined to Part 9; retire Appendix C; reformat Appendix B | DEC-06 + DEC-12 revised | Phase 3 S16 |
...
| Metric | Value |
|---|---|
| Decisions resolved | 75 (D1: 34 + D2: 40 + DEC-21 added) |
| Content removed | ~184 lines |
| Items merged/absorbed | 3 mergers (C-06→C-03; B-04→B-03; A-17→G-02) + 1 absorption (TC-04→F-04) |
| Items relocated | F-02 → Appendix D |
| Items created/relocated | 2 new (I-04 Ceiling Hoist; H-05 Nurse Call) + 2 relocated into F (TC-01→F-06; TC-05→F-07) + 1 relocated to Part 9 (TC-02+TC-03) |
| Categories deleted | 1 (J BAR) |
| Category F | 5 → 6 items (F-02 out; F-06, F-07 in) |
| Worked examples | 5 → 18 (4 residential by disability profile; 14 NR by typology × 2) |
| Appendix changes | B: BIO stays, reformatted. C: RETIRED. D: +F-02 policy entry. |
| Change Orders | 4 (CO-0002–CO-0005; CO-0003 scope includes F-02 relocation) |
| Pending: P1-D3 | Parts 8–13 + Appendices (DEC-08 through DEC-21) |

*End of P1-D2 Decision Register — APPROVED 2026-03-27*
