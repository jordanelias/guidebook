...
**Evidence base note [CON-0193]:** The Tier 1 specification ranges in Part 4 are supported by 5 systematic reviews identified through citation mining (2026-05-04): reverberation and hearing impairment (Murgia 2023, Cueille 2022, ASI-08); wheelchair environmental barriers (Rouvier 2022); multisensory environments and autism (Leonardi 2025); fibromyalgia thermal sensitivity (Berwick 2021); and indoor thermal comfort in ageing (TCO-07). Where systematic review evidence exists, the corresponding specification carries the highest evidence confidence within the Tier 1 framework. Where only standards convergence or expert consensus supports a specification, this is disclosed in the Part 4 item's `grade_confidence` annotation.

**Category structure validation [CON-0032]:** A 2025 scoping review (64 studies; 7 interior design principles for older adult health) independently identified category structures closely aligned with the guidebook's Part 4 item taxonomy [○ MODERATE confidence — category convergence inferred from described findings; review not yet citation-verified]. This provides external validation that the guidebook's item category organisation reflects the state of the evidence base, not an arbitrary editorial choice. The review additionally identifies "relaxation design" as a distinct category that this guidebook distributes across A-16 (Sensory Room), F-01 (Sensory Gradient), BIO-05 (Restorative Circulation), and D-11 (Safe Garden) rather than as a standalone category; this distributed approach is intentional — relaxation design principles apply at zone and route level, not only in designated retreat spaces.
...
**The three-tier hierarchy as a co-occurrence resolution mechanism [CO03-07]:** When an occupant has co-occurring disabilities, the three tiers interact differently than for single-population users. At Universal Mode, all provisions that serve any population without harming others are applied — the population-agnostic floor. At Tier 1, the population mix in the building determines which specification ranges apply and where conflicts arise; Part 5 (Building-Level Co-Occurrence Resolution) governs. At Tier 2, the individual's specific compound functional profile — not any population median — determines every specification. Co-occurring conditions rarely produce additive disability; they produce compound functional effects that Mode S OT assessment resolves through co-design. The three tiers are thus not just levels of design specificity; they are also escalating levels of co-occurrence resolution granularity: Universal Mode addresses all populations simultaneously; Tier 1 addresses population clusters and their conflicts; Tier 2 addresses the individual compound profile. This principle governs the co-occurrence framework in Part 3 (§3.2–§3.8) and the conflict resolution methodology in Part 5. ○ [Tier 3 — methodology derived from ICF intersection theory and competence-press compound strain model; no primary RCT on co-occurring disability design outcomes]
