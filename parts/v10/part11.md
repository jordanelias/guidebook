...
Lived-experience research reinforces these quantitative findings. In a survey of 1,178 Australians with mobility impairments, 74% reported living in housing that did not adequately meet their accessibility needs (Wiesel 2020, Melbourne Disability Institute). Goodwin et al. (2022, Australian Journal of Social Issues, doi: 10.1002/ajs4.214) found that accessible features were perceived to lead to social inclusion, increased functioning and independence, and increased quality of life — outcomes that represent real economic value in reduced care needs, increased employment participation, and reduced health service utilisation, even where formal economic evaluation has not yet been conducted.
...
**Social Return on Investment (SROI):** Measures the social, environmental, and economic value created by an intervention per unit of investment. Applied to UK DFG-funded home adaptations by Foundations UK; applied to the CAPABLE programme (US) showing ~$20,000 in Medicare savings per participant over two years at a programme cost of $2,825–$3,000 (Szanton et al. 2018, JAGS, doi: 10.1111/jgs.15143). The LSE/Habinteg study (2023) models a 4.3–5.6:1 benefit-cost ratio for wheelchair-accessible homes (M4(3) standard) over 10 years.
...
**Part 12 case study cross-reference [CON-0225]:** The economic evidence in §11.3 is operationalised in Part 12 case studies — each case study documents the design decisions that produced the measured economic outcomes. The DAR provisions in §11.7 are the mechanism by which construction-stage decisions achieve the returns documented in §11.3: missed DAR provisions at design stage have documented 10-40× cost multipliers that eliminate the economic benefit. Part 12 should be read alongside Part 11 as the implementation evidence for the economic case.

**Cross-jurisdictional health outcomes convergence:** The strongest evidence for the economic case comes from health-outcomes research, where multiple independent studies across jurisdictions converge on consistent benefit-cost ratios. A Cochrane systematic review of 6 RCTs (Clemson et al. 2023; N=3,298) found a 21% falls risk reduction from home modifications. The Keall RCT chain in New Zealand (2015 Lancet, 2017 Injury Prevention, 2021 Lancet Public Health) demonstrated 26–31% fall injury reductions and a 9:1 BCR at NZD $500 per household. The CAPABLE programme in the United States (Szanton et al. 2018) independently produced a ~10:1 combined Medicare/Medicaid BCR at $1,300–$3,000 per participant. The convergence of two independent research programmes in different countries, different healthcare systems, and different cost structures — both producing 9–10:1 BCRs at low per-person cost — is the single most persuasive economic finding in the accessible design evidence base.

Additional cross-jurisdictional evidence: Tsuchiya-Ito et al. (2024, JAMDA) found 28% lower long-term care facility admission rates for Japanese older adults receiving insurance-covered housing adaptations (maximum ¥200,000); Hollinghurst et al. (2022, Age and Ageing) used linked administrative data for 657,536 Welsh older adults to demonstrate reduced emergency fall admissions following Care & Repair Cymru home adaptations; and Chandola & Rouxel (2022, Lancet Regional Health – Europe) provided the first empirical evidence of a curb-cut effect in residential housing — external housing modifications reduced social isolation by 6% and the need to move by 4% even among non-impaired adults (n=10,459, 11.3-year follow-up). This last finding is significant because it demonstrates that accessible design benefits extend beyond the disabled population to all residents.

**Methodological note on targeting:** These benefit-cost ratios apply to targeted programmes — interventions directed at people with identified fall risk, functional limitation, or existing disability. The OTIS RCT (Cockayne et al. 2021, UK, NIHR Health Technology Assessment) found no evidence that untargeted OT-delivered home assessment reduced falls in the general population aged 65+. A separate meta-analysis (Lektip et al. 2023, PeerJ) found only 7% falls reduction when pooling targeted and untargeted studies. The distinction matters for design professionals: incorporating accessible features at the design stage (this guidebook's scope) is not the same intervention as retrospective home hazard assessment of existing buildings. Design-stage accessibility is inherently targeted — it serves the full lifecycle population of the building, including future residents who will develop mobility limitations.
...
**Lee/Sanford 2018 specification note [CON-0230]:** Citation mining (2026-05-04) confirmed Lee, Sanford, Calkins et al. (2018, HERD 11(2):32-44, DOI:10.1177/1937586717730338) as the most robust grab bar evidence: n=130+ residents, 11 facilities, bilateral fold-down bars at 356mm from toilet centreline, 813mm AFF significantly outperform ADA configuration. DAR blocking positions must accommodate this bilateral fold-down specification — blocking at both sides of toilet, shower, and bathtub at 356mm from CL. Blocking zones: 600mm wide × 1200mm tall centred at 813mm AFF, both sides of each fixture.
