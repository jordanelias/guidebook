...
<!-- v10.0 scaffold — CO-0004: was Part 6. PENDING:
     ...
     - Section numbering: §7.x (was §7.x in source — confirm no collision) -->
...
| E-08 | Corridor clear width ≥1500 mm (≥1800 mm HLT/TRP) | SD | Floor plan | MOB primary circulation requirement |
...
| Imaging / treatment rooms | MOB | G-03 (transfer grab bars) |
...
- Restaurant accessibility: ≥20% of dining tables with ≥1500 mm turning circle at both ends (not only one end); no fixed bench seating only — fixed benches exclude MOB users entirely if no removable alternative provided; menu in large print (≥14 pt, B-09 equivalent visual standard)
- Pool: A-10b (RT60 ≤1.0 s at 500 Hz for hydrotherapy environments); pool hoist provision; accessible changing (G-03 blocking)
...
- **Real-time accessible departure information [GAP-NEW-13]:** VIS, DEAF, DBL — real-time departure information must be provided in multiple formats simultaneously at all platforms and primary waiting areas: (a) **visual caption displays**: minimum 600 mm character height at 10 m viewing distance; high-contrast (LRV ≥60 vs background); arrival/departure, platform, delay, and disruption information (not route summary only). (b) **tactile departure boards** at principal information points: refreshable tactile display, Braille supplement, or audio handset (H-05 BLE as supplementary). (c) **PA system**: all PA announcements simultaneously captioned on visual displays with ≤3 second lag. ○ [Tier 4 — EU Regulation 1300/2014 (PRM TSI) §4.2.19 auditory information + §4.2.20 visual information; UK PRM TSI; AU Disability Standards for Accessible Public Transport 2002 §23.2; no standard mandates tactile boards; tactile boards are guidebook best practice recommendation ahead of field; THIN single-jurisdiction basis for tactile format] — DBL provisions: tactile building map (K-02) at all interchange entrances; intervenor assistance protocol at all staffed assistance points
