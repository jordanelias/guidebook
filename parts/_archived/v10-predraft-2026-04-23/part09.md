...
<!-- v10.0 scaffold — CO-0004: was Part 9. Section numbering renumbered §9.x/§9.x → §9.x.
     ...
     - §9.10 OT threshold (D3-03 — new section, draft required)
     - §9.X DeafBlind Specialist Consultant (GAP-SCOPE-02 — Protactile spatial reqs, new section)
     - All internal §9.x/§9.x references → §9.x
...
- **Thermal profiling [CON-0224/0228]:** For populations with condition-specific thermoregulation (MS, FMS, DEM, OFS, SCI), the OT assessment must include quantified thermal thresholds: MS Uhthoff onset at 0.5°C core temp increase (Christogianni 2018); FMS cold pain threshold (Berwick 2021 SR: CPT 10.9-26.3°C vs controls 5.9-13.5°C); DEM/older adult neutral 24.9°C (Baquero 2023). These thresholds inform F-07 thermal zoning and K-05 thermal comfort assessment. Quantified population thresholds [CON-0184]: MS/NEU — Uhthoff onset ≤0.5°C core temp increase (Christogianni 2018, MST-10); design target ambient ≤22°C. DEM/older adult — neutral sensation temperature 24.9°C (Baquero 2023, TCO-01, n=1,065); design target ambient ≥24°C. FMS/PAIN — cold pain hypersensitivity confirmed in 14/17 QST studies (Berwick 2021 SR, MST-09); CPT range 10.9–26.3°C; warm ambient preferred but overridden by MS harm-asymmetry in shared spaces. SCI tetraplegia (≥C8) — impaired thermoregulation; passive cooling insufficient at ambient >32°C/humidity >70% (tropical contexts); mechanical cooling is medically necessary. OT report must document individual thermal profile against these thresholds as specification input.
- **Grab bar assessment [CON-0228]:** Grab bar positioning (G-03) must include Mode S assessment: 280mm above individual seat surface height, bilateral, fold-down configuration per Lee/Sanford 2018 (ULB-12) unless clinical assessment indicates alternative. Blocking positions to be specified at DAR stage — NOT-RETROFITTABLE.
