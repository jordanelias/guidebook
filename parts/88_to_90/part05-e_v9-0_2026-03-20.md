...
### E-14 Entrance Rest Seating (Within 5 m of Accessible Entrance Threshold)

**Applicable Groups:** OFS/POTS, OFS/CFS, PAIN/FMS, MOB/AMB, DEM, ALL

**Description:** New item — migrated from v10 draft (session 2026-05-05). Rest seating at accessible entrances removes the standing demand during threshold tasks: operating intercoms, keypads, automatic door delays, and footwear removal. For OFS and PAIN populations, entrance seating prevents the forced choice between abandoning entrance tasks and triggering post-exertional malaise, orthostatic episodes, or pain escalation. Distinct from E-10 (Circulation Route Rest Seating): E-10 governs seating intervals on routes; E-14 governs entrance-zone provision regardless of route length.

**Specifications:**

Seating with bilateral fixed arms, seat height 440–480 mm AFF, within 5 m of accessible entrance threshold

Alcove ≥1200 mm wide, recessed ≥200 mm from the main accessible route, under weather protection (E-05)

Back support ≥450 mm high; seat depth 400–450 mm; bilateral fixed arms extending ≥200 mm forward of seat front edge; arm height 180–220 mm above compressed seat surface

Recline capability: tilt-in-space or backrest recline ≥110° from vertical recommended; mandatory where OFS or PAIN populations are primary occupants

Seat surface: firm (≤50 mm compression), non-slip when wet; metal and stone seat surfaces not acceptable in cold climates or shade-exposed locations

Clear floor space ≥900 mm × 1200 mm in front of seating, outside the main accessible route, for mobility device parking

Alcove orientation: seating faces entrance door where practicable — enables observation of approach without head rotation (DEM orientation)

Where F-08 entry vestibule is specified: locate seating within or immediately after the thermal buffer zone

**Retrofit cost note:** Retrofit penalty: LOW. Entrance rest seating is a furniture provision and alcove layout decision. Recessed alcove may require minor wall modification in retrofit. See Part 12 §12.4.

**Key citations:** RCOT. (2019). *Housing Adaptations Without Delay*. RCOT. British Standards Institution. (2018). *BS 8300:2018*. BSI. ISO 21542:2021. [EXPERT CONSENSUS for entrance-specific placement — clinical seating parameters from OT home modification evidence (Co-2/Tier 1); spatial application is expert consensus.]

**Cross-reference:** E-05 (Weather Protection — canopy coverage of seating); E-10 (Circulation Route Rest Seating — complementary, non-overlapping scope); F-08 (Thermal Transition — vestibule seating coordination); E-08 (Corridor Clear Width — alcove must not reduce path width)

**Evidence basis (OT):** Compensatory FOR; EHP Framework (alter strategy). Entrance rest seating alters the physical environment at the point of maximum entrance-zone demand to enable threshold tasks without sustained standing; for OFS/POTS users the seated option prevents orthostatic triggers; for PAIN/FMS users it eliminates the standing load that compounds pain during the multi-task entrance transition.
