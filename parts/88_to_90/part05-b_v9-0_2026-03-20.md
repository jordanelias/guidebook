...
### B-12 Daylight Quality (Melanopic EDI ≥250 lux-equivalent at Eye Level in Daytime Spaces)

**Applicable Groups:** DEM, NEU/PCS, MH, ALL (circadian health)

**Description:** New item added in v10.0 per item-code audit (session 2026-05-05). B-12 specifies daylight *quality* in melanopic equivalent daylight illuminance (melanopic EDI) terms, complementing B-09 (daylight *quantity* — clerestory, light wells, rooflights) and B-01 (electric circadian lighting). The distinction: B-09 ensures daylight reaches occupied spaces; B-12 ensures the daylight that arrives is spectrally sufficient to entrain circadian rhythm and support alertness. Melanopic EDI is the performance metric endorsed by the CIE S 026/E:2018 standard and Brown et al. 2022 expert consensus.

**Specifications:**

Melanopic EDI target: ≥250 lux-equivalent at the vertical plane at seated eye level (1200 mm AFF) during daytime hours (07:00–17:00) in all primary occupied spaces with daylight access

Measurement plane: vertical, facing the primary window wall, at the occupant's typical seated position — not horizontal workplane illuminance

Where daylight factor alone cannot achieve melanopic EDI ≥250: supplement with electric circadian lighting (B-01) to reach the combined target

Glazing specification: where replacement or new glazing is specified, select high visible light transmittance (VLT ≥60%) glass; avoid tinted or heavily coated glazing that attenuates the 480 nm melanopic peak

Bathroom daylight: where bathrooms have external windows, maximise daylight penetration; coordinate with G-04 wet room ventilation (≥15 ACH extract) to prevent condensation reducing effective daylight

DEM environments: melanopic EDI is particularly critical — Kolberg 2022 (CML-07) showed nursing homes for DEM residents typically fail melanopic EDI thresholds due to small windows, deep plan, and low-transmittance glazing

**Retrofit cost note:** Retrofit penalty: MODERATE. Glazing replacement for higher VLT is a capital improvement. Adding clerestory or light wells is HIGH cost. In most cases, achieving melanopic EDI ≥250 in retrofit will require supplementary electric circadian lighting (B-01) rather than envelope modification. See Part 12 §12.4.

**Key citations:** Brown, T.M. et al. (2022). Recommendations for daytime, evening, and nighttime indoor light exposure. *Preprints*, 2022010342. CIE. (2018). *CIE S 026/E:2018 — CIE system for metrology of optical radiation for ipRGC-influenced responses to light*. CIE. IES. (2023). *RP-46-23 — Recommended practice for circadian-effective lighting*. IES. Kolberg, E. et al. (2022). Light exposure in nursing homes — CML-07. Grant, P. et al. (2022). Circadian lighting upgrade and fall reduction — CML-08.

**BPC note:** [BPC NOT OPUS-SYNTHESISED — circadian-melanopic-lighting BPC: evidence gathered via citation mining (CML-07, CML-08, CML-09). Reduced-confidence warning applies.]

**Tier note:** No jurisdiction mandates melanopic EDI performance criteria. WELL v2 references circadian light but not as mandatory. IES RP-46-23 is an industry recommended practice, not a code requirement. Evidence tier: 3–4.

**Cross-reference:** B-01 (Circadian Lighting — electric complement to daylight melanopic EDI); B-09 (Maximisation of Natural Light — daylight quantity; B-12 specifies daylight quality); G-04 (Wet Room — bathroom daylight and condensation management)

**Evidence basis (OT):** EHP Framework (alter strategy); PEOP Model. Daylight quality specification alters the luminous environment to provide the spectral content (melanopic-weighted, 480 nm peak) required for circadian entrainment; for DEM populations, circadian disruption is a documented contributor to sundowning, sleep fragmentation, and agitation — melanopic EDI ≥250 implements the EHP 'alter' strategy by modifying the light environment to support the biological rhythm that underpins occupational participation across the full day.
