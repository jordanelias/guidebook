...
**Specification authority [GAP-SCOPE-01]:** Part 4 is the single source of truth for all performance targets (RT60, NC, NRC, PTV, LRV, lux, melanopic EDI, dimensional specifications). The values in this Part's tables are cross-references to Part 4, not independent specifications. Where any discrepancy exists between a value in Part 8 and Part 4, Part 4 governs. Part 8's role is coordination: mapping Part 4 items to engineering disciplines, design stages, commissioning tests, and drawing deliverables. Engineers should reference Part 4 for the specification and Part 8 for the workflow.
