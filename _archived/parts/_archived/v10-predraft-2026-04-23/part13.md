...
<!-- v10.0 scaffold — combines v9.0 part14 (appendices) + part13 (bibliography + glossary).
     ...
     - Appendix B (BIO-01–BIO-05): reformat to Part 4 template per CO-0003/Session 16
     - Appendix D: confirm E-12 reference code defined (D2-44) -->
...
> **Cross-population convergence note [GAP-CON-04 / CON-0012]:** BIO-series outdoor and biophilic provisions serve NDV, DEM, and NDV/MH populations through three distinct but convergent mechanisms — (1) **NDV/AUT:** sensory self-regulation and restorative attention recovery (ART; Kaplan & Kaplan 1989); (2) **DEM:** spatial orientation through natural landmarks, circadian entrainment via natural light, and safe freedom of movement in secured outdoor gardens (DSDC EADDAT 2022); (3) **NDV/MH (PTSD/trauma):** access to restorative natural settings as a component of trauma-informed design (Dignified Design 2024 — 22 elements for permanent supportive housing). These three mechanisms produce the same spatial requirement — accessible, low-stimulation biophilic outdoor zones — through independent evidence bases. Specify as a convergent multi-population provision, not as siloed per-population provisions. Every residential and supported-living building serving any of these three populations should provide a secured, accessible outdoor biophilic zone (D-11 + BIO-01 + BIO-02) as a Universal Mode provision. ○ [Tier 3 convergence — individual mechanisms have separate evidence bases; no cross-population POE study of combined provision]

### BIO-01 — Views of Nature from Primary Occupied Spaces (≥75%)

**Applicable Groups:** ALL (especially MH, DEM, PAIN, OFS, NDV/AUT) ≥75% of regularly occupied spaces have a direct, unobstructed view of nature from seated or normal-use position. Windowsill height ≤750 mm AFF for seated and reclined views. Low-iron glazing where view quality is critical. **Specifications:** - ≥75% of regularly occupied spaces: direct nature view confirmed - Windowsill height: ≤750 mm AFF - Glazing: low-iron glass where nature view is primary (improved colour rendering) - Urban sites: planted courtyard, green wall, or planting element in sightline as minimum **Retrofit cost note:** Retrofit penalty: LOW — PLANNING. Nature views from primary occupied spaces are a building orientation and window placement decision costing nothing at design stage. Retrofit requires new structural openings in a building with inadequate window provision --- or is impossible. Orientation is irreversible post-construction. See Part 11I §8.4. **Key citations:** Ulrich, R.S. (1984). View through a window may influence recovery from surgery. *Science*, 224(4647). Kaplan, R., \& Kaplan, S. (1989). *The experience of nature*. Cambridge University Press. Kirch, M., \& Marquardt, G. (2023). *HERD*, 16(1). *Cross-reference: B-09 (Natural Light); BIO-02 (Interior Planting); D-11 (Safe Garden)* **Evidence basis (OT):** ART (Attention Restoration Theory); SRT (Stress Recovery Theory) — Views of nature from primary occupied spaces are the primary evidence-based restorative intervention in the built environment per ART (Kaplan \& Kaplan 1989) and SRT (Ulrich 1984); the ≥75% provision ensures that the restorative stimulus is accessible during the majority of occupied hours, reducing directed attention depletion for all user groups.
