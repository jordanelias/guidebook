...
### G-08 Accessible Storage (Height Band 750–1050 mm, Bracing-Surface Layout)

**Applicable Groups:** PAIN/FMS, MOB, UPL, OFS/CFS, IntD

**Description:** New item added in v10.0 per item-code audit (session 2026-05-05). G-08 specifies storage placement within the ergonomic reach zone (750–1050 mm AFF — between hip and shoulder) that avoids bending or overhead reaching, and a layout configuration (U-shape or L-shape with shelf edges at waist height) that provides incidental bracing surfaces for balance support. The specification addresses two populations simultaneously: PAIN/FMS (joint loading from bending/reaching triggers pain flares) and MOB/NEU (balance support during standing storage access).

**Specifications:**

Primary storage zone: all frequently accessed storage (daily-use items in residential; personal storage in workplace/educational) placed within 750–1050 mm AFF

No overhead storage above 1200 mm AFF in PAIN/OFS-designated spaces — overhead reaching triggers shoulder and cervical pain in FMS and upper limb fatigue in OFS/CFS

No below-knee storage requiring bending below 500 mm AFF in PAIN-designated spaces — spinal flexion triggers lumbar pain flares in FMS

Layout: U-shape or L-shape shelf arrangement preferred in residential bedrooms and kitchens — shelf edges at 850–950 mm AFF provide incidental bracing surfaces for MOB and NEU users during standing access

Shelf depth: ≤400 mm for wall-mounted open shelving — deeper shelves require reaching beyond the shoulder plane

Pull-out drawers or sliding shelves for any storage deeper than 400 mm to eliminate reach into recessed spaces

Storage furniture: no free-standing units without wall fixing in MOB/NEU environments — anti-tip brackets required

**Retrofit cost note:** Retrofit penalty: LOW. Storage height adjustment is a furniture and shelving decision. U-shape layout may require joinery modification in kitchens. Anti-tip brackets are low-cost hardware additions. See Part 12 §12.4.

**Key citations:** RCOT. (2024). *Clinical guidance on energy conservation and joint protection in fibromyalgia*. RCOT. Berwick, R.J. et al. (2021). Systematic review of temperature influence on fibromyalgia pain. *Pain Medicine*. British Standards Institution. (2018). *BS 8300:2018*. BSI. [EXPERT CONSENSUS for bracing-surface layout — no standard mandates incidental support from storage furniture; concept derives from MOB OT practice.]

**BPC note:** [Specifications derived from connection synthesis (CON-0005, CON-0038, CON-0129). Reduced-confidence warning applies for bracing-surface specification.]

**Tier note:** BS 8300:2018 specifies accessible kitchen storage heights but not the bracing-surface layout concept. No jurisdiction mandates the 750–1050 mm zone as an accessibility standard. Evidence tier: 4–5 for bracing layout; tier 3 for height band.

**Cross-reference:** G-05 (Adjustable-Height Work Surfaces — complementary reach zone specification); I-02 (Kitchen One-Handed Operation — storage must support one-handed access); F-05 (Seated-Task Design — storage access must be achievable seated where applicable)

**Evidence basis (OT):** Compensatory FOR; joint protection principles. Storage height specification implements compensatory joint protection: the 750–1050 mm zone eliminates the spinal flexion and shoulder abduction that trigger pain in FMS and fatigue in OFS/CFS; the bracing-surface layout provides environmental compensation for impaired standing balance by embedding grab-free balance support into the furniture arrangement — an application of the OT 'compensatory' model where the physical environment performs the stabilisation function that the user's neuromuscular system cannot reliably provide.

### G-09 Upholstered Seating Throughout Occupied Spaces
...
**Individual dimming control (absorbed from former B-06):**

Dimming range: 100% to 10 lux minimum; dimmer: trailing-edge electronic compatible with flicker-free LED (B-04); control: accessible switch 800–1200 mm AFF, lever or rocker (UPL compatible); per-space individual control — not zone-level
