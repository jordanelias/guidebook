...
**Platform lift fallback (absorbed from former E-02):**

Where full passenger lift (1400×1100 mm car) cannot be achieved due to structural constraints: platform lift serving all accessible floors; minimum platform 900×1400 mm; enclosed shaft; automatic doors at each landing; travel speed ≥0.15 m/s; rated for wheelchair + attendant (250 kg minimum). Platform lift does not substitute for passenger lift in new-build — fallback for retrofit and listed buildings only.
...
### E-10 Rest Seating Provision (Routes ≤20 m Interval + Entrance ≤5 m)
...
**Entrance rest seating (absorbed from former E-14):**

Seating with bilateral fixed arms, seat height 440–480 mm AFF, within 5 m of accessible entrance threshold; alcove ≥1200 mm wide, recessed ≥200 mm from accessible route, under weather protection (E-05); back support ≥450 mm high; recline ≥110° recommended, mandatory where OFS/PAIN primary; clear floor space ≥900 × 1200 mm in front; where F-08 vestibule specified, locate seating within or after thermal buffer zone
