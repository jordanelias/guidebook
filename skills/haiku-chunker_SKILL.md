...
## Modes
**A – Section Map:** extract all headings → `references/section-map_{DOC-ID}.md` (one file per document; include version label in DOC-ID; reuse across sessions; regenerate only on version change)
...
**D – Item Code Extraction:** extract all Vol II codes (A-01, B-10 pattern) → `item-codes-raw_{DOC-ID}.md`
