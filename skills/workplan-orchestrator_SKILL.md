...
1. GET `https://api.github.com/repos/jordanelias/guidebook/contents/sessions` to list all session files.
...
| **Item Specification** | item-consolidation-analyzer → item-specification-writer → [framing-checker · evidence-auditor] → prose-style-checker → volii-validator → vol2-item-formatter |
...
| **Economics Research** | research-log-manager CHECK → economics-researcher → research-log-manager LOG → citation-verifier |
| **Literature Review** | research-log-manager CHECK → literature-review-planner → research-log-manager LOG |
...
| `literature-review-planner` | Sonnet 4.6 + web | Systematic review protocol; PRISMA; CHECK before / LOG after |
| `economics-researcher` | Sonnet 4.6 + web | Economics evidence; funding programmes; CHECK before / LOG after |
| `jurisdiction-tracker` | Sonnet 4.6 + web | Standards currency by jurisdiction |
| `neufert-image-analyzer` | Sonnet 4.6 | Spatial analysis of Neufert Architects' Data figures |
