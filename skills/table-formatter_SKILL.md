...
```
| Item | Title | MOB | VIS | VIS/DEAF | DEM | NDV | OFS | NEU | PAIN | DBL | MOB/UPL | Stage |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| A-01 | Acoustic performance | ● | — | ● | ● | ● | ● | ● | ● | ● | — | SD |
```

Population column order (canonical, never reorder):
`MOB | VIS | VIS/DEAF | DEM | NDV | OFS | NEU | PAIN | DBL | MOB/UPL`
...
| BAR column in matrix | `BAR` column header in matrix table | Flag as doctrine violation — BAR is not a main-taxonomy code. Recommend removal. Do not auto-remove without user confirmation. |
