...
### Thesis-first, always
State the central claim at the outset, plainly and without hedging the conclusion. Don't work up to it.
...
> ✓ "Adaptable housing is inherently good because it supports people's pursuit of well-being. This is not to say that moving may not lead to positive outcomes."
> ✗ "While there are certainly cases where moving can be beneficial, and while well-being is difficult to define, it could perhaps be argued that adaptable housing…"

### Closing a section with synthesis, not summary
Section conclusions re-synthesise the argument rather than recapping it. They often generalise upward — drawing out the broader implication — rather than restating what was just said.

> ✓ "A person's claim to well-being rarely—if ever—derives solely from their own personhood. Being with others is a fundamental part of being well."
...
Paragraphs do not trail off. The final sentence either closes the argument unit ("From here we can see how…") or sets up the next paragraph with a forward-pointing claim.

### No padding sentences
No sentence exists purely to fill space. Every sentence either introduces a claim, develops it, provides evidence, or concludes it. "It is interesting to note that…" and similar throat-clearing constructions do not appear.
