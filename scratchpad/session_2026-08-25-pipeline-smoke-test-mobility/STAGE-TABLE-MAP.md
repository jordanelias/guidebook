...
| `convergence_assessment` | 0 | Whether independent evidence axes agree. Doctrine requires counting **independent values**, never documents. |
...
**Crossing maps:** `access_need_icf` 43 · `access_need_axis_map` 21 · `item_axis_links` 158 ·
