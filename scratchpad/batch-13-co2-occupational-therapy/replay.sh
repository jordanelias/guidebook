...
db log-search --slug $SLUG --language EN --jurisdiction GB \
...
db log-search --slug $SLUG --language EN --jurisdiction US \
...
db add-source --ref-id REF-00997 \
 ...
 --slug $SLUG --local-ref-id 16

db log-search --slug $SLUG --language EN --jurisdiction AU \
...
db add-extraction --ref-id REF-00997 --slug $SLUG --parameter-id 3 \
...
db add-population-match --ref-id REF-00997 --target-population MOB \
...
db observe-term --ref-id REF-00997 --surface-form 'step ramp' --language EN --locator 'Ramp gradient' \
...
db observe-term --ref-id REF-00997 --surface-form 'long ramp' --language EN --locator 'Ramp gradient' \
...
db observe-term --ref-id REF-00997 --surface-form 'prescriber' --language EN --locator 'Australian Standards; Ramp gradient' \
...
db resolve-candidate --candidate-id 72 --disposition OUT-OF-SCOPE \
...
db retire-specification --specification-id 5 \
